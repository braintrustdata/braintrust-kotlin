...
class ExperimentSummarizeResponseTest {
    ...
    fun createExperimentSummarizeResponse() {
        ...
        assertThat(experimentSummarizeResponse.comparisonExperimentName()).isEqualTo("string")
        assertThat(experimentSummarizeResponse.metrics())
            .isEqualTo(ExperimentSummarizeResponse.Metrics.builder().build())
        assertThat(experimentSummarizeResponse.scores())
            .isEqualTo(ExperimentSummarizeResponse.Scores.builder().build())
    }
}
