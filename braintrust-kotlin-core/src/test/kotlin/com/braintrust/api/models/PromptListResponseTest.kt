...
class PromptListResponseTest {
    ...
    fun createPromptListResponse() {
        ...
        assertThat(promptListResponse.description()).isEqualTo("string")
        assertThat(promptListResponse.metadata())
            .isEqualTo(PromptListResponse.Metadata.builder().build())
        ...
        assertThat(promptListResponse.tags()).containsExactly("string")
    }
}
