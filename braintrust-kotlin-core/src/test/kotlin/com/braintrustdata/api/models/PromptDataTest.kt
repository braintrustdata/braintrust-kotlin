...
class PromptDataTest {
    ...
    fun createPromptData() {
      ...
      assertThat(promptData.options()).isEqualTo(PromptOptions.builder()
          .model("model")
          .params(PromptOptions.Params.OpenAIModelParams.builder()
              .frequencyPenalty(0.0)
              .functionCall(PromptOptions.Params.OpenAIModelParams.FunctionCall.UnionMember0.AUTO)
      ...
      assertThat(promptData.prompt()).isEqualTo(PromptData.Prompt.ofCompletion(PromptData.Prompt.Completion.builder()
          ...
          .type(PromptData.Prompt.Completion.Type.COMPLETION)
          .build()))
      assertThat(promptData.toolFunctions()).containsExactly(PromptData.ToolFunction.ofFunction(PromptData.ToolFunction.Function.builder()
          .id("id")
          .type(PromptData.ToolFunction.Function.Type.FUNCTION)
          .build()))
    }
