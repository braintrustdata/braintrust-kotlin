...
class FunctionTest {
    ...
    fun createFunction() {
      val function = Function.builder()
          ...
          ._xactId("_xact_id")
          .functionData(Function.FunctionData.Prompt.builder()
          ...
          .functionSchema(Function.FunctionSchema.builder()
              .parameters(JsonValue.from(mapOf<String, Any>()))
              .returns(JsonValue.from(mapOf<String, Any>()))
              .build())
          .functionType(Function.FunctionType.LLM)
          .metadata(Function.Metadata.builder()
              .putAdditionalProperty("foo", JsonValue.from("bar"))
              .build())
          .origin(Function.Origin.builder()
      ...
      assertThat(function.functionData()).isEqualTo(Function.FunctionData.ofPrompt(Function.FunctionData.Prompt.builder()
          .type(Function.FunctionData.Prompt.Type.PROMPT)
          .build()))
      ...
      assertThat(function.functionSchema()).isEqualTo(Function.FunctionSchema.builder()
          .parameters(JsonValue.from(mapOf<String, Any>()))
          .returns(JsonValue.from(mapOf<String, Any>()))
          .build())
      assertThat(function.functionType()).isEqualTo(Function.FunctionType.LLM)
      assertThat(function.metadata()).isEqualTo(Function.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .build())
      assertThat(function.origin()).isEqualTo(Function.Origin.builder()
          .objectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .objectType(Function.Origin.ObjectType.ORGANIZATION)
          .internal_(true)
          .build())
      assertThat(function.promptData()).isEqualTo(PromptData.builder()
          .options(PromptOptions.builder()
              .model("model")
              .params(PromptOptions.Params.OpenAIModelParams.builder()
                  .frequencyPenalty(0.0)
