...
class InsertDatasetEventTest {
    ...
    fun createInsertDatasetEvent() {
      val insertDatasetEvent = InsertDatasetEvent.builder()
          .id("id")
          ._isMerge(true)
      ...
      assertThat(insertDatasetEvent.created()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(insertDatasetEvent.metadata()).isEqualTo(InsertDatasetEvent.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .build())
