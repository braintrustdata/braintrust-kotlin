...
class ProjectLogInsertParamsTest {
    ...
    fun getBody() {
      ...
      assertThat(body.events()).isEqualTo(listOf(ProjectLogInsertParams.Event.ofInsertProjectLogsEventReplace(InsertProjectLogsEventReplace.builder()
          .id("id")
          ._isMerge(true)
          ._objectDelete(true)
          ._parentId("_parent_id")
    ...
    fun getBodyWithoutOptionalFields() {
      val params = ProjectLogInsertParams.builder()
          .projectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .events(listOf(ProjectLogInsertParams.Event.ofInsertProjectLogsEventReplace(InsertProjectLogsEventReplace.builder().build())))
          .build()
      val body = params.getBody()
      assertThat(body).isNotNull
      assertThat(body.events()).isEqualTo(listOf(ProjectLogInsertParams.Event.ofInsertProjectLogsEventReplace(InsertProjectLogsEventReplace.builder().build())))
    }
