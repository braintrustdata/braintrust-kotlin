...
class PatchGroupTest {
    ...
    fun createPatchGroup() {
        ...
        assertThat(patchGroup.addMemberGroups())
            .containsExactly("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(patchGroup.addMemberUsers())
            .containsExactly("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(patchGroup.description()).isEqualTo("description")
        assertThat(patchGroup.name()).isEqualTo("name")
        assertThat(patchGroup.removeMemberGroups())
            .containsExactly("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(patchGroup.removeMemberUsers())
            .containsExactly("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    }
}
