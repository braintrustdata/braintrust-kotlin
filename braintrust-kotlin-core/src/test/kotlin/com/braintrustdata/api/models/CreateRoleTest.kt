...
class CreateRoleTest {
    ...
    fun createCreateRole() {
        ...
        assertThat(createRole.description()).isEqualTo("description")
        assertThat(createRole.memberPermissions())
            .containsExactly(
                CreateRole.MemberPermission.builder()
                    .permission(CreateRole.MemberPermission.Permission.CREATE)
        ...
        assertThat(createRole.memberRoles()).containsExactly("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(createRole.orgName()).isEqualTo("org_name")
    }
}
