...
class OrgSecretListParamsTest {
    ...
    @Test
    fun getQueryParams() {
      val params = OrgSecretListParams.builder()
          .endingBefore("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .ids(OrgSecretListParams.Ids.ofString("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"))
          .limit(123L)
          .orgName("org_name")
      ...
      expected.put("ids", listOf(OrgSecretListParams.Ids.ofString("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e").toString()))
      expected.put("limit", listOf("123"))
      expected.put("org_name", listOf("org_name"))
      expected.put("org_secret_name", listOf("org_secret_name"))
      expected.put("org_secret_type", listOf(OrgSecretListParams.OrgSecretType.ofString("string").toString()))
