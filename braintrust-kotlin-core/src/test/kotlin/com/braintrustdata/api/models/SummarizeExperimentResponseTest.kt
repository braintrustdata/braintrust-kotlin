...
class SummarizeExperimentResponseTest {
    ...
    fun createSummarizeExperimentResponse() {
      val summarizeExperimentResponse = SummarizeExperimentResponse.builder()
          ...
          .metrics(SummarizeExperimentResponse.Metrics.builder()
      ...
      assertThat(summarizeExperimentResponse.metrics()).isEqualTo(SummarizeExperimentResponse.Metrics.builder()
          .putAdditionalProperty("foo", JsonValue.from(mapOf(
            "improvements" to 0,
            "metric" to 0,
            "name" to "name",
          ...
          .build())
      assertThat(summarizeExperimentResponse.scores()).isEqualTo(SummarizeExperimentResponse.Scores.builder()
          .putAdditionalProperty("foo", JsonValue.from(mapOf(
            "improvements" to 0,
            "name" to "name",
            "regressions" to 0,
