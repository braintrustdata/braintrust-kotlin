...
class ProjectScoreTest {
    ...
    fun createProjectScore() {
      ...
      assertThat(projectScore.categories()).isEqualTo(ProjectScore.Categories.ofCategorical(listOf(ProjectScoreCategory.builder()
          .name("name")
          .value(0.0)
          .build())))
      assertThat(projectScore.config()).isEqualTo(ProjectScoreConfig.builder()
          .destination(ProjectScoreConfig.Destination.EXPECTED)
          .multiSelect(true)
          .online(OnlineScoreConfig.builder()
              .samplingRate(0.0)
