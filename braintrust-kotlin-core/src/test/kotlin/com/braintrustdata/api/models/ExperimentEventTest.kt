...
import com.braintrustdata.api.models.ExperimentEvent

class ExperimentEventTest {

    @Test
    fun createExperimentEvent() {
      val experimentEvent = ExperimentEvent.builder()
          .id("id")
          ._xactId("_xact_id")
          ...
          .spanId("span_id")
          .context(ExperimentEvent.Context.builder()
          ...
          .metrics(ExperimentEvent.Metrics.builder()
          ...
          .spanAttributes(ExperimentEvent.SpanAttributes.builder()
              .name("name")
      ...
      assertThat(experimentEvent.created()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(experimentEvent.context()).isEqualTo(ExperimentEvent.Context.builder()
          .callerFilename("caller_filename")
          .callerFunctionname("caller_functionname")
          .callerLineno(123L)
          .build())
      ...
      assertThat(experimentEvent.metrics()).isEqualTo(ExperimentEvent.Metrics.builder()
          .completionTokens(123L)
          .end(42.23)
          .promptTokens(123L)
          .start(42.23)
      ...
      assertThat(experimentEvent.spanAttributes()).isEqualTo(ExperimentEvent.SpanAttributes.builder()
          .name("name")
          .type(ExperimentEvent.SpanAttributes.Type.LLM)
          .build())
