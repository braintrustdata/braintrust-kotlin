...
class ExperimentEventTest {
    ...
    fun createExperimentEvent() {
      val experimentEvent = ExperimentEvent.builder()
          ...
          .isRoot(true)
          .metadata(ExperimentEvent.Metadata.builder()
          ...
          .metrics(ExperimentEvent.Metrics.builder()
              ...
              .tokens(0L)
              .build())
          .origin(ExperimentEvent.Origin.builder()
              .id("id")
              ._xactId("_xact_id")
          ...
          .scores(ExperimentEvent.Scores.builder()
      ...
      assertThat(experimentEvent.metadata()).isEqualTo(ExperimentEvent.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .build())
      assertThat(experimentEvent.metrics()).isEqualTo(ExperimentEvent.Metrics.builder()
          ...
          .tokens(0L)
          .build())
      assertThat(experimentEvent.origin()).isEqualTo(ExperimentEvent.Origin.builder()
          .id("id")
          ._xactId("_xact_id")
          .objectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .objectType(ExperimentEvent.Origin.ObjectType.EXPERIMENT)
      ...
      assertThat(experimentEvent.scores()).isEqualTo(ExperimentEvent.Scores.builder()
          .putAdditionalProperty("foo", JsonValue.from(0))
          .build())
      assertThat(experimentEvent.spanAttributes()).isEqualTo(SpanAttributes.builder()
          .name("name")
          .type(SpanAttributes.Type.LLM)
          .build())
