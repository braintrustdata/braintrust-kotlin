...
internal class InsertExperimentEventTest {
    ...
    fun roundtrip() {
        ...
        val roundtrippedInsertExperimentEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(insertExperimentEvent),
                jacksonTypeRef<InsertExperimentEvent>(),
            )

        assertThat(roundtrippedInsertExperimentEvent).isEqualTo(insertExperimentEvent)
    }
}
