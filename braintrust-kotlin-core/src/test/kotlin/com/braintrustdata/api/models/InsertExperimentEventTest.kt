...
class InsertExperimentEventTest {
    ...
    fun createInsertExperimentEvent() {
      ...
      assertThat(insertExperimentEvent.context()).isEqualTo(InsertExperimentEvent.Context.builder()
          .callerFilename("caller_filename")
          .callerFunctionname("caller_functionname")
          .callerLineno(0L)
          .build())
      assertThat(insertExperimentEvent.created()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(insertExperimentEvent.metadata()).isEqualTo(InsertExperimentEvent.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .build())
      assertThat(insertExperimentEvent.metrics()).isEqualTo(InsertExperimentEvent.Metrics.builder()
          .callerFilename(JsonValue.from(mapOf<String, Any>()))
          .callerFunctionname(JsonValue.from(mapOf<String, Any>()))
          .callerLineno(JsonValue.from(mapOf<String, Any>()))
          .completionTokens(0L)
      ...
      assertThat(insertExperimentEvent.scores()).isEqualTo(InsertExperimentEvent.Scores.builder()
          .putAdditionalProperty("foo", JsonValue.from(0))
          .build())
      assertThat(insertExperimentEvent.spanAttributes()).isEqualTo(SpanAttributes.builder()
          .name("name")
          .type(SpanAttributes.Type.LLM)
          .build())
