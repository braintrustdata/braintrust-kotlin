...
import com.braintrustdata.api.models.ProjectScoreCreateParams.ProjectScoreCreateBody
...
class ProjectScoreCreateParamsTest {
    ...
    @Test
    fun getBody() {
      val params = ProjectScoreCreateParams.builder()
          .name("name")
          .projectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .scoreType(ProjectScoreCreateParams.ScoreType.SLIDER)
          .categories(ProjectScoreCreateParams.Categories.ofList<ProjectScoreCategory>(listOf(ProjectScoreCategory.builder()
      ...
      assertThat(body.categories()).isEqualTo(ProjectScoreCreateParams.Categories.ofList<ProjectScoreCategory>(listOf(ProjectScoreCategory.builder()
          .name("name")
          .value(42.23)
          .build())))
