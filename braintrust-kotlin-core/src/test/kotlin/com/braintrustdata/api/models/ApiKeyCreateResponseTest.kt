...
class ApiKeyCreateResponseTest {
    ...
    fun createApiKeyCreateResponse() {
        ...
        assertThat(apiKeyCreateResponse.orgId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(apiKeyCreateResponse.userId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    }
}
