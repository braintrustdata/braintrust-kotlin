...
class PatchFunctionTest {

    @Test
    fun createPatchFunction() {
        val patchFunction =
            PatchFunction.builder()
                .description("description")
                .functionData(
                    PatchFunction.FunctionData.ofPrompt(
                        PatchFunction.FunctionData.Prompt.builder()
                            .type(PatchFunction.FunctionData.Prompt.Type.PROMPT)
                            .build()
                    )
                )
                .name("name")
                ...
                .tags(listOf("string"))
                .build()
        assertThat(patchFunction).isNotNull
        assertThat(patchFunction.description()).isEqualTo("description")
        assertThat(patchFunction.functionData())
            .isEqualTo(
                PatchFunction.FunctionData.ofPrompt(
                    PatchFunction.FunctionData.Prompt.builder()
                        .type(PatchFunction.FunctionData.Prompt.Type.PROMPT)
        ...
        assertThat(patchFunction.name()).isEqualTo("name")
        assertThat(patchFunction.promptData())
            .isEqualTo(
                PromptData.builder()
                    .options(
                        PromptData.Options.builder()
        ...
        assertThat(patchFunction.tags()).containsExactly("string")
    }
}
