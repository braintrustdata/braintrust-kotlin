...
internal class FetchProjectLogsEventsResponseTest {
    ...
    fun roundtrip() {
        ...
        val roundtrippedFetchProjectLogsEventsResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(fetchProjectLogsEventsResponse),
                jacksonTypeRef<FetchProjectLogsEventsResponse>(),
            )

        assertThat(roundtrippedFetchProjectLogsEventsResponse)
            .isEqualTo(fetchProjectLogsEventsResponse)
    }
}
