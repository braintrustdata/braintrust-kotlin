...
class DatasetEventTest {
    ...
    fun createDatasetEvent() {
      ...
      assertThat(datasetEvent.isRoot()).isEqualTo(true)
      assertThat(datasetEvent.metadata()).isEqualTo(DatasetEvent.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .build())
      assertThat(datasetEvent.origin()).isEqualTo(DatasetEvent.Origin.builder()
          .id("id")
          ._xactId("_xact_id")
          .objectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .objectType(DatasetEvent.Origin.ObjectType.EXPERIMENT)
