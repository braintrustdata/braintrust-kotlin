...
class PatchOrganizationMembersOutputTest {
    ...
    fun createPatchOrganizationMembersOutput() {
      val patchOrganizationMembersOutput = PatchOrganizationMembersOutput.builder()
          .orgId("org_id")
      ...
      assertThat(patchOrganizationMembersOutput.status()).isEqualTo(PatchOrganizationMembersOutput.Status.SUCCESS)
      assertThat(patchOrganizationMembersOutput.sendEmailError()).isEqualTo("send_email_error")
    }
}
