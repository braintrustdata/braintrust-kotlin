...
class FunctionCreateParamsTest {
    ...
    @Test
    fun body() {
      val params = FunctionCreateParams.builder()
          .functionData(FunctionCreateParams.FunctionData.Prompt.builder()
              .type(FunctionCreateParams.FunctionData.Prompt.Type.PROMPT)
              .build())
          .name("x")
      ...
      assertNotNull(body)
      assertThat(body.functionData()).isEqualTo(FunctionCreateParams.FunctionData.ofPrompt(FunctionCreateParams.FunctionData.Prompt.builder()
          .type(FunctionCreateParams.FunctionData.Prompt.Type.PROMPT)
          .build()))
      ...
      assertThat(body.functionSchema()).isEqualTo(FunctionCreateParams.FunctionSchema.builder()
          .parameters(JsonValue.from(mapOf<String, Any>()))
          .returns(JsonValue.from(mapOf<String, Any>()))
          .build())
      assertThat(body.functionType()).isEqualTo(FunctionCreateParams.FunctionType.LLM)
      assertThat(body.origin()).isEqualTo(FunctionCreateParams.Origin.builder()
          .objectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .objectType(FunctionCreateParams.Origin.ObjectType.ORGANIZATION)
          .internal_(true)
          .build())
