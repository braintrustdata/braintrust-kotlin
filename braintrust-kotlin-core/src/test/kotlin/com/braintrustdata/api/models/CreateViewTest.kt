...
class CreateViewTest {
    ...
    fun createCreateView() {
        ...
        assertThat(createView.objectType()).isEqualTo(CreateView.ObjectType.ORGANIZATION)
        assertThat(createView.viewType()).isEqualTo(CreateView.ViewType.PROJECTS)
        ...
        assertThat(createView.userId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
