...
internal class FetchDatasetEventsResponseTest {
    ...
    fun roundtrip() {
        ...
        val roundtrippedFetchDatasetEventsResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(fetchDatasetEventsResponse),
                jacksonTypeRef<FetchDatasetEventsResponse>(),
            )

        assertThat(roundtrippedFetchDatasetEventsResponse).isEqualTo(fetchDatasetEventsResponse)
    }
}
