...
class CreateGroupTest {
    ...
    fun createCreateGroup() {
        ...
        assertThat(createGroup.description()).isEqualTo("description")
        assertThat(createGroup.memberGroups())
            .containsExactly("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(createGroup.memberUsers())
            .containsExactly("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(createGroup.orgName()).isEqualTo("org_name")
    }
}
