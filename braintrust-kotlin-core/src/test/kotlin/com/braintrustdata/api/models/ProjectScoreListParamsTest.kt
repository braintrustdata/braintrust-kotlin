...
class ProjectScoreListParamsTest {
    ...
    fun createProjectScoreListParams() {
      ProjectScoreListParams.builder()
          ...
          .scoreType(ProjectScoreListParams.ScoreType.ofUnionMember0(ProjectScoreListParams.ScoreType.UnionMember0.SLIDER))
    ...
    fun getQueryParams() {
      ...
      expected.put("ids", listOf(ProjectScoreListParams.Ids.ofString("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e").toString()))
      ...
      expected.put("score_type", listOf(ProjectScoreListParams.ScoreType.ofUnionMember0(ProjectScoreListParams.UnionMember0.SLIDER.toString()).toString()))
