...
import com.braintrustdata.api.models.ProjectLogsEvent

class ProjectLogsEventTest {

    @Test
    fun createProjectLogsEvent() {
      val projectLogsEvent = ProjectLogsEvent.builder()
          .id("id")
          ._xactId("_xact_id")
          ...
          .spanId("span_id")
          .context(ProjectLogsEvent.Context.builder()
          ...
          .metrics(ProjectLogsEvent.Metrics.builder()
          ...
          .spanAttributes(ProjectLogsEvent.SpanAttributes.builder()
              .name("name")
      ...
      assertThat(projectLogsEvent.created()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(projectLogsEvent.context()).isEqualTo(ProjectLogsEvent.Context.builder()
          .callerFilename("caller_filename")
          .callerFunctionname("caller_functionname")
          .callerLineno(123L)
          .build())
      ...
      assertThat(projectLogsEvent.metadata()).isEqualTo(ProjectLogsEvent.Metadata.builder().build())
      assertThat(projectLogsEvent.metrics()).isEqualTo(ProjectLogsEvent.Metrics.builder()
          .completionTokens(123L)
          .end(42.23)
          .promptTokens(123L)
          .start(42.23)
      ...
      assertThat(projectLogsEvent.spanAttributes()).isEqualTo(ProjectLogsEvent.SpanAttributes.builder()
          .name("name")
          .type(ProjectLogsEvent.SpanAttributes.Type.LLM)
          .build())
