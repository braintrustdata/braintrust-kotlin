...
class PatchViewTest {
    ...
    fun createPatchView() {
        ...
        assertThat(patchView.objectType()).isEqualTo(PatchView.ObjectType.ORGANIZATION)
        assertThat(patchView.name()).isEqualTo("name")
        ...
        assertThat(patchView.userId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        ...
        assertThat(patchView.viewType()).isEqualTo(PatchView.ViewType.PROJECTS)
    }
}
