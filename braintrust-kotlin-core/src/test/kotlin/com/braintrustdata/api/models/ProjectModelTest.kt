...
class ProjectModelTest {
    ...
    fun createProjectModel() {
        ...
        assertThat(projectModel.settings())
            .isEqualTo(ProjectModel.Settings.builder().comparisonKey("comparison_key").build())
        assertThat(projectModel.userId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    }
}
