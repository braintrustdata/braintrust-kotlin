...
class ViewOptionsTest {
    ...
    fun createViewOptions() {
      ...
      assertThat(viewOptions.columnSizing()).isEqualTo(ViewOptions.ColumnSizing.builder()
          .putAdditionalProperty("foo", JsonValue.from(0))
          .build())
      assertThat(viewOptions.columnVisibility()).isEqualTo(ViewOptions.ColumnVisibility.builder()
          .putAdditionalProperty("foo", JsonValue.from(true))
          .build())
    }
}
