...
class CreatePromptTest {

    @Test
    fun createCreatePrompt() {
        val createPrompt =
            CreatePrompt.builder()
                .name("name")
                ...
                .tags(listOf("string"))
                .build()
        assertThat(createPrompt).isNotNull
        assertThat(createPrompt.name()).isEqualTo("name")
        assertThat(createPrompt.projectId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(createPrompt.slug()).isEqualTo("slug")
        assertThat(createPrompt.description()).isEqualTo("description")
        assertThat(createPrompt.promptData())
            .isEqualTo(
                PromptData.builder()
                    .options(
                        PromptData.Options.builder()
        ...
        assertThat(createPrompt.tags()).containsExactly("string")
    }
}
