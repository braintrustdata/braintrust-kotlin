...
class FunctionServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val function = functionServiceAsync.create(FunctionCreateParams.builder()
          .functionData(FunctionCreateParams.FunctionData.Prompt.builder()
          ...
          .functionSchema(FunctionCreateParams.FunctionSchema.builder()
    ...
    suspend fun retrieve() {
      ...
      val function = functionServiceAsync.retrieve(FunctionRetrieveParams.builder()
    ...
    suspend fun update() {
      ...
      val function = functionServiceAsync.update(FunctionUpdateParams.builder()
          .functionId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .description("description")
    ...
    suspend fun list() {
      ...
      val page = functionServiceAsync.list()
    ...
    suspend fun delete() {
      ...
      val function = functionServiceAsync.delete(FunctionDeleteParams.builder()
          .functionId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
    ...
    suspend fun invoke() {
      ...
      val response = functionServiceAsync.invoke(FunctionInvokeParams.builder()
          .functionId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .input(JsonValue.from(mapOf<String, Any>()))
          .addMessage(FunctionInvokeParams.Message.System.builder()
              .role(FunctionInvokeParams.Message.System.Role.SYSTEM)
              .content("content")
              .name("name")
              .build())
          .mode(FunctionInvokeParams.Mode.AUTO)
          .parent(FunctionInvokeParams.Parent.SpanParentStruct.builder()
              .objectId("object_id")
              .objectType(FunctionInvokeParams.Parent.SpanParentStruct.ObjectType.PROJECT_LOGS)
              .propagatedEvent(FunctionInvokeParams.Parent.SpanParentStruct.PropagatedEvent.builder()
                  .putAdditionalProperty("foo", JsonValue.from("bar"))
                  .build())
              .rowIds(FunctionInvokeParams.Parent.SpanParentStruct.RowIds.builder()
                  .id("id")
    ...
    suspend fun replace() {
      ...
      val function = functionServiceAsync.replace(FunctionReplaceParams.builder()
