...
class DatasetServiceTest {
    ...
    fun callCreate() {
      ...
      val dataset = datasetService.create(DatasetCreateParams.builder()
          .name("name")
    ...
    fun callRetrieve() {
      val client = BraintrustOkHttpClient.builder()
          ...
          .build()
      val datasetService = client.dataset()
      val dataset = datasetService.retrieve(DatasetRetrieveParams.builder()
    ...
    fun callUpdate() {
      val client = BraintrustOkHttpClient.builder()
          ...
          .build()
      val datasetService = client.dataset()
      val dataset = datasetService.update(DatasetUpdateParams.builder()
          .datasetId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .description("description")
    ...
    fun callDelete() {
      val client = BraintrustOkHttpClient.builder()
          ...
          .build()
      val datasetService = client.dataset()
      val dataset = datasetService.delete(DatasetDeleteParams.builder()
          .datasetId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
      println(dataset)
      dataset.validate()
    ...
    fun callFeedback() {
      val client = BraintrustOkHttpClient.builder()
          ...
          .build()
      val datasetService = client.dataset()
      val feedbackResponseSchema = datasetService.feedback(DatasetFeedbackParams.builder()
          .datasetId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .feedback(listOf(FeedbackDatasetItem.builder()
              .id("id")
              .comment("comment")
    ...
    fun callFetch() {
      val client = BraintrustOkHttpClient.builder()
          ...
          .build()
      val datasetService = client.dataset()
      val fetchDatasetEventsResponse = datasetService.fetch(DatasetFetchParams.builder()
          .datasetId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .limit(123L)
    ...
    fun callFetchPost() {
      val client = BraintrustOkHttpClient.builder()
          ...
          .build()
      val datasetService = client.dataset()
      val fetchDatasetEventsResponse = datasetService.fetchPost(DatasetFetchPostParams.builder()
          .datasetId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .cursor("cursor")
          .filters(listOf(PathLookupFilter.builder()
              .path(listOf("string"))
    ...
    fun callInsert() {
      val client = BraintrustOkHttpClient.builder()
          ...
          .build()
      val datasetService = client.dataset()
      val insertEventsResponse = datasetService.insert(DatasetInsertParams.builder()
          .datasetId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .events(listOf(DatasetInsertParams.Event.ofInsertDatasetEventReplace(InsertDatasetEventReplace.builder()
              .id("id")
              ._isMerge(true)
              ._objectDelete(true)
    ...
    fun callSummarize() {
      val client = BraintrustOkHttpClient.builder()
          ...
          .build()
      val datasetService = client.dataset()
      val summarizeDatasetResponse = datasetService.summarize(DatasetSummarizeParams.builder()
          .datasetId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .summarizeData(true)
          .build())
