...
class LogServiceAsyncTest {
    ...
    suspend fun feedback() {
      ...
      val feedbackResponseSchema = logServiceAsync.feedback(ProjectLogFeedbackParams.builder()
    ...
    suspend fun fetch() {
      ...
      val fetchProjectLogsEventsResponse = logServiceAsync.fetch(ProjectLogFetchParams.builder()
          .projectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .limit(0L)
    ...
    suspend fun fetchPost() {
      ...
      val fetchProjectLogsEventsResponse = logServiceAsync.fetchPost(ProjectLogFetchPostParams.builder()
          .projectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .cursor("cursor")
          .limit(0L)
          .maxRootSpanId("max_root_span_id")
    ...
    suspend fun insert() {
      ...
      val insertEventsResponse = logServiceAsync.insert(ProjectLogInsertParams.builder()
          .projectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .addEvent(InsertProjectLogsEvent.builder()
              .id("id")
              ._isMerge(true)
              .addMergePath(listOf("string"))
              ._objectDelete(true)
              ._parentId("_parent_id")
              .context(InsertProjectLogsEvent.Context.builder()
              ...
              .metadata(InsertProjectLogsEvent.Metadata.builder()
                  .putAdditionalProperty("foo", JsonValue.from("bar"))
                  .build())
              .metrics(InsertProjectLogsEvent.Metrics.builder()
