...
class ProjectScoreServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val projectScore = projectScoreServiceAsync.create(ProjectScoreCreateParams.builder()
          .name("name")
    ...
    suspend fun retrieve() {
      ...
      val projectScore = projectScoreServiceAsync.retrieve(ProjectScoreRetrieveParams.builder()
    ...
    suspend fun update() {
      ...
      val projectScore = projectScoreServiceAsync.update(ProjectScoreUpdateParams.builder()
          .projectScoreId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .categoriesOfCategorical(listOf(ProjectScoreCategory.builder()
              .name("name")
              .value(0.0)
    ...
    suspend fun delete() {
      ...
      val projectScore = projectScoreServiceAsync.delete(ProjectScoreDeleteParams.builder()
          .projectScoreId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
    ...
    suspend fun replace() {
      ...
      val projectScore = projectScoreServiceAsync.replace(ProjectScoreReplaceParams.builder()
          .name("name")
          .projectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
