...
class LogServiceTest {
    ...
    fun callFeedback() {
      ...
      val feedbackResponseSchema = logService.feedback(ProjectLogFeedbackParams.builder()
          .projectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .feedback(listOf(FeedbackProjectLogsItem.builder()
              .id("id")
              .comment("comment")
    ...
    fun callFetch() {
      val client = BraintrustOkHttpClient.builder()
          ...
          .build()
      val logService = client.project().logs()
      val fetchProjectLogsEventsResponse = logService.fetch(ProjectLogFetchParams.builder()
          .projectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .limit(123L)
    ...
    fun callFetchPost() {
      val client = BraintrustOkHttpClient.builder()
          ...
          .build()
      val logService = client.project().logs()
      val fetchProjectLogsEventsResponse = logService.fetchPost(ProjectLogFetchPostParams.builder()
          .projectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .cursor("cursor")
    ...
    fun callInsert() {
      val client = BraintrustOkHttpClient.builder()
          ...
          .build()
      val logService = client.project().logs()
      val insertEventsResponse = logService.insert(ProjectLogInsertParams.builder()
          .projectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .events(listOf(ProjectLogInsertParams.Event.ofInsertProjectLogsEventReplace(InsertProjectLogsEventReplace.builder()
              .id("id")
              ._isMerge(true)
              ._objectDelete(true)
