...
class ViewServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val view = viewServiceAsync.create(ViewCreateParams.builder()
          .name("name")
    ...
    suspend fun retrieve() {
      ...
      val view = viewServiceAsync.retrieve(ViewRetrieveParams.builder()
    ...
    suspend fun update() {
      ...
      val view = viewServiceAsync.update(ViewUpdateParams.builder()
          .viewId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .objectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    suspend fun list() {
      ...
      val page = viewServiceAsync.list(ViewListParams.builder()
          .objectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    suspend fun delete() {
      ...
      val view = viewServiceAsync.delete(ViewDeleteParams.builder()
          .viewId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .objectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    suspend fun replace() {
      ...
      val view = viewServiceAsync.replace(ViewReplaceParams.builder()
          .name("name")
          .objectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
