...
class ErrorHandlingTest {
    ...
    private val BRAINTRUST_ERROR: BraintrustError = BraintrustError.builder().putAdditionalProperty("key", JsonString.of("value")).build()
    ...
    fun projectsCreate400() {
      ...
      assertThatThrownBy({ client.project().create(params) })
          .satisfies({ e -> assertBadRequest(e, ImmutableListMultimap.of("Foo", "Bar"), BRAINTRUST_ERROR) })
    }
    ...
    fun projectsCreate401() {
      ...
      assertThatThrownBy({ client.project().create(params) })
          .satisfies({ e -> assertUnauthorized(e, ImmutableListMultimap.of("Foo", "Bar"), BRAINTRUST_ERROR) })
    }
    ...
    fun projectsCreate403() {
      ...
      assertThatThrownBy({ client.project().create(params) })
          .satisfies({ e -> assertPermissionDenied(e, ImmutableListMultimap.of("Foo", "Bar"), BRAINTRUST_ERROR) })
    }
    ...
    fun projectsCreate404() {
      ...
      assertThatThrownBy({ client.project().create(params) })
          .satisfies({ e -> assertNotFound(e, ImmutableListMultimap.of("Foo", "Bar"), BRAINTRUST_ERROR) })
    }
    ...
    fun projectsCreate422() {
      ...
      assertThatThrownBy({ client.project().create(params) })
          .satisfies({ e -> assertUnprocessableEntity(e, ImmutableListMultimap.of("Foo", "Bar"), BRAINTRUST_ERROR) })
    }
    ...
    fun projectsCreate429() {
      ...
      assertThatThrownBy({ client.project().create(params) })
          .satisfies({ e -> assertRateLimit(e, ImmutableListMultimap.of("Foo", "Bar"), BRAINTRUST_ERROR) })
    }
    ...
    fun projectsCreate500() {
      ...
      assertThatThrownBy({ client.project().create(params) })
          .satisfies({ e -> assertInternalServer(e, ImmutableListMultimap.of("Foo", "Bar"), BRAINTRUST_ERROR) })
    }
    ...
    fun unexpectedStatusCode() {
      ...
      assertThatThrownBy({ client.project().create(params) }).satisfies({ e -> assertUnexpectedStatusCodeException(e, 999, ImmutableListMultimap.of("Foo", "Bar"), toJson(BRAINTRUST_ERROR)) })
    }
    ...
    fun invalidBody() {
      ...
      assertThatThrownBy({ client.project().create(params) }).satisfies({ e -> assertThat(e)
    ...
    fun invalidErrorBody() {
      ...
      assertThatThrownBy({ client.project().create(params) }).satisfies({ e -> assertBadRequest(e, ImmutableListMultimap.of(), BraintrustError.builder().build()) })
    }
    ...
    private fun assertBadRequest(throwable: Throwable, headers: ListMultimap<String, String>, error: BraintrustError) {
      assertThat(throwable)
    ...
    private fun assertUnauthorized(throwable: Throwable, headers: ListMultimap<String, String>, error: BraintrustError) {
      assertThat(throwable)
    ...
    private fun assertPermissionDenied(throwable: Throwable, headers: ListMultimap<String, String>, error: BraintrustError) {
      assertThat(throwable)
    ...
    private fun assertNotFound(throwable: Throwable, headers: ListMultimap<String, String>, error: BraintrustError) {
      assertThat(throwable)
    ...
    private fun assertUnprocessableEntity(throwable: Throwable, headers: ListMultimap<String, String>, error: BraintrustError) {
      assertThat(throwable)
    ...
    private fun assertRateLimit(throwable: Throwable, headers: ListMultimap<String, String>, error: BraintrustError) {
      assertThat(throwable)
    ...
    private fun assertInternalServer(throwable: Throwable, headers: ListMultimap<String, String>, error: BraintrustError) {
      assertThat(throwable)
