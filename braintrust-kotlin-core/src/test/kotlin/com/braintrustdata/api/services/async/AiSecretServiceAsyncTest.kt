...
internal class AiSecretServiceAsyncTest {
    ...
    suspend fun retrieve() {
        ...
        val aISecret = aiSecretServiceAsync.retrieve("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    suspend fun delete() {
        ...
        val aISecret = aiSecretServiceAsync.delete("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
