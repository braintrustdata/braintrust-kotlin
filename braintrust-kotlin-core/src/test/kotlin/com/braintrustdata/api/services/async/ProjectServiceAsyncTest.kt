...
internal class ProjectServiceAsyncTest {
    ...
    suspend fun retrieve() {
        ...
        val project = projectServiceAsync.retrieve("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    suspend fun delete() {
        ...
        val project = projectServiceAsync.delete("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
