...
class PromptServiceTest {
    ...
    fun callCreate() {
      ...
      val prompt = promptService.create(PromptCreateParams.builder()
          .name("name")
    ...
    fun callRetrieve() {
      val client = BraintrustOkHttpClient.builder()
          ...
          .build()
      val promptService = client.prompt()
      val prompt = promptService.retrieve(PromptRetrieveParams.builder()
    ...
    fun callUpdate() {
      val client = BraintrustOkHttpClient.builder()
          ...
          .build()
      val promptService = client.prompt()
      val prompt = promptService.update(PromptUpdateParams.builder()
          .promptId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .description("description")
          .name("name")
          .promptData(PromptData.builder()
    ...
    fun callDelete() {
      val client = BraintrustOkHttpClient.builder()
          ...
          .build()
      val promptService = client.prompt()
      val prompt = promptService.delete(PromptDeleteParams.builder()
          .promptId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
      println(prompt)
      prompt.validate()
    ...
    fun callReplace() {
      val client = BraintrustOkHttpClient.builder()
          ...
          .build()
      val promptService = client.prompt()
      val prompt = promptService.replace(PromptReplaceParams.builder()
          .name("name")
          .projectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .slug("slug")
          .description("description")
