...
class OrganizationServiceAsyncTest {
    ...
    suspend fun retrieve() {
      ...
      val organization = organizationServiceAsync.retrieve(OrganizationRetrieveParams.builder()
    ...
    suspend fun update() {
      ...
      val organization = organizationServiceAsync.update(OrganizationUpdateParams.builder()
          .organizationId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .apiUrl("api_url")
          .isUniversalApi(true)
          .name("name")
    ...
    suspend fun delete() {
      ...
      val organization = organizationServiceAsync.delete(OrganizationDeleteParams.builder()
          .organizationId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
