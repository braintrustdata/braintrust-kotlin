...
class RoleServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val role = roleServiceAsync.create(RoleCreateParams.builder()
          .name("x")
    ...
    suspend fun retrieve() {
      ...
      val role = roleServiceAsync.retrieve(RoleRetrieveParams.builder()
    ...
    suspend fun update() {
      ...
      val role = roleServiceAsync.update(RoleUpdateParams.builder()
          .roleId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    suspend fun delete() {
      ...
      val role = roleServiceAsync.delete(RoleDeleteParams.builder()
          .roleId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
    ...
    suspend fun replace() {
      ...
      val role = roleServiceAsync.replace(RoleReplaceParams.builder()
          .name("x")
          .description("description")
