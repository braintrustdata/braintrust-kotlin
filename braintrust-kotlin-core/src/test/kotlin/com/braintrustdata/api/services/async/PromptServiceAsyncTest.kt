...
class PromptServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val prompt = promptServiceAsync.create(PromptCreateParams.builder()
          .name("x")
    ...
    suspend fun retrieve() {
      ...
      val prompt = promptServiceAsync.retrieve(PromptRetrieveParams.builder()
    ...
    suspend fun update() {
      ...
      val prompt = promptServiceAsync.update(PromptUpdateParams.builder()
          .promptId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .description("description")
          .name("name")
          .promptData(PromptData.builder()
    ...
    suspend fun delete() {
      ...
      val prompt = promptServiceAsync.delete(PromptDeleteParams.builder()
          .promptId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
    ...
    suspend fun replace() {
      ...
      val prompt = promptServiceAsync.replace(PromptReplaceParams.builder()
          .name("x")
          .projectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .slug("x")
          .description("description")
