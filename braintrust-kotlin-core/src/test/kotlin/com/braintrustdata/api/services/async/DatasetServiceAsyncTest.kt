...
class DatasetServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val dataset = datasetServiceAsync.create(DatasetCreateParams.builder()
          .name("x")
    ...
    suspend fun retrieve() {
      ...
      val dataset = datasetServiceAsync.retrieve(DatasetRetrieveParams.builder()
    ...
    suspend fun update() {
      ...
      val dataset = datasetServiceAsync.update(DatasetUpdateParams.builder()
          .datasetId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .description("description")
    ...
    suspend fun list() {
      ...
      val page = datasetServiceAsync.list()
    ...
    suspend fun delete() {
      ...
      val dataset = datasetServiceAsync.delete(DatasetDeleteParams.builder()
          .datasetId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
    ...
    suspend fun feedback() {
      ...
      val feedbackResponseSchema = datasetServiceAsync.feedback(DatasetFeedbackParams.builder()
          .datasetId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    suspend fun fetch() {
      ...
      val fetchDatasetEventsResponse = datasetServiceAsync.fetch(DatasetFetchParams.builder()
          .datasetId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .limit(0L)
    ...
    suspend fun fetchPost() {
      ...
      val fetchDatasetEventsResponse = datasetServiceAsync.fetchPost(DatasetFetchPostParams.builder()
          .datasetId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .cursor("cursor")
          .limit(0L)
          .maxRootSpanId("max_root_span_id")
    ...
    suspend fun insert() {
      ...
      val insertEventsResponse = datasetServiceAsync.insert(DatasetInsertParams.builder()
          .datasetId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    suspend fun summarize() {
      ...
      val summarizeDatasetResponse = datasetServiceAsync.summarize(DatasetSummarizeParams.builder()
          .datasetId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .summarizeData(true)
          .build())
