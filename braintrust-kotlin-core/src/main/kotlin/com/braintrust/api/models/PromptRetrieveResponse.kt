...
@JsonDeserialize(builder = PromptRetrieveResponse.Builder::class)
@NoAutoDetect
class PromptRetrieveResponse
private constructor(
    ...
    fun validate(): PromptRetrieveResponse = apply {
        if (!validated) {
            id()
            _xactId()
            projectId()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PromptRetrieveResponse &&
            this.id == other.id &&
    ...
    override fun toString() =
        "PromptRetrieveResponse{id=$id, _xactId=$_xactId, projectId=$projectId, logId=$logId, orgId=$orgId, name=$name, slug=$slug, description=$description, created=$created, promptData=$promptData, tags=$tags, metadata=$metadata, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(promptRetrieveResponse: PromptRetrieveResponse) = apply {
            this.id = promptRetrieveResponse.id
            this._xactId = promptRetrieveResponse._xactId
            this.projectId = promptRetrieveResponse.projectId
            this.logId = promptRetrieveResponse.logId
            this.orgId = promptRetrieveResponse.orgId
            this.name = promptRetrieveResponse.name
            this.slug = promptRetrieveResponse.slug
            this.description = promptRetrieveResponse.description
            this.created = promptRetrieveResponse.created
            this.promptData = promptRetrieveResponse.promptData
            this.tags = promptRetrieveResponse.tags
            this.metadata = promptRetrieveResponse.metadata
            additionalProperties(promptRetrieveResponse.additionalProperties)
        }
        ...
        fun build(): PromptRetrieveResponse =
                ...
                private constructor(
                    ...
                    private constructor(
                        ...
                        private constructor(
                            ...
                            private val unnamedSchemaWithArrayParent4s:
                            ...
                            fun asUnnamedSchemaWithArrayParent4s():
                                List<UnnamedSchemaWithArrayParent4> =
                                unnamedSchemaWithArrayParent4s.getOrThrow(
                                    "unnamedSchemaWithArrayParent4s"
                                )
                            ...
                            override fun equals(other: Any?): Boolean {
                                ...
                                return other is Content &&
                                    ...
                                    this.unnamedSchemaWithArrayParent4s ==
                                    ...
                                    when {
                                        ...
                                        value.unnamedSchemaWithArrayParent4s != null ->
                                            generator.writeObject(
                                                value.unnamedSchemaWithArrayParent4s
                                            )
                                        value._json != null -> generator.writeObject(value._json)
                                        else -> throw IllegalStateException("Invalid Content")
                                    }
                            ...
                            @JsonDeserialize(
                                using = UnnamedSchemaWithArrayParent4.Deserializer::class
                            )
                            ...
                            private constructor(
                                ...
                                fun validate(): UnnamedSchemaWithArrayParent4 = apply {
                                    if (!validated) {
                                        if (unionMember0 == null && unionMember1 == null) {
                                            throw BraintrustInvalidDataException(
                                                "Unknown UnnamedSchemaWithArrayParent4: $_json"
                                            )
                                        }
                                        unionMember0?.validate()
                                        unionMember1?.validate()
                                ...
                                override fun toString(): String {
                                    return when {
                                        unionMember0 != null ->
                                            "UnnamedSchemaWithArrayParent4{unionMember0=$unionMember0}"
                                        unionMember1 != null ->
                                            "UnnamedSchemaWithArrayParent4{unionMember1=$unionMember1}"
                                        _json != null ->
                                ...
                                class Deserializer :
                                    ...
                                    override fun ObjectCodec.deserialize(
                                        ...
                                        tryDeserialize(node, jacksonTypeRef<UnionMember0>()) {
                                            ...
                                            ?.let {
                                                return UnnamedSchemaWithArrayParent4(
                                                    unionMember0 = it,
                                                    _json = json
                                                )
                                            }
