...
constructor(
    ...
    private constructor(
        ...
        class Builder {
            ...
            /**
             * The id of the project logs event to log feedback for. This is the row `id` returned
             * by `POST /v1/project_logs/{project_id}/insert`
             */
            @JsonProperty("id") fun id(id: String) = apply { this.id = id }

            /**
             * A dictionary of numeric values (between 0 and 1) to log. These scores will be merged
             * into the existing scores for the project logs event
             */
