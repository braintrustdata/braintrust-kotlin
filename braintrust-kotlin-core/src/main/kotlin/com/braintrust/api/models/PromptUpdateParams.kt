                ...
                private constructor(
                    ...
                    private constructor(
                        ...
                        private constructor(
                            ...
                            private val unnamedSchemaWithArrayParent1s:
                            ...
                            fun asUnnamedSchemaWithArrayParent1s():
                                List<UnnamedSchemaWithArrayParent1> =
                                unnamedSchemaWithArrayParent1s.getOrThrow(
                                    "unnamedSchemaWithArrayParent1s"
                                )
                            ...
                            override fun equals(other: Any?): Boolean {
                                ...
                                return other is Content &&
                                    ...
                                    this.unnamedSchemaWithArrayParent1s ==
                                    ...
                                    when {
                                        ...
                                        value.unnamedSchemaWithArrayParent1s != null ->
                                            generator.writeObject(
                                                value.unnamedSchemaWithArrayParent1s
                                            )
                                        value._json != null -> generator.writeObject(value._json)
                                        else -> throw IllegalStateException("Invalid Content")
                                    }
                            ...
                            private constructor(
                                ...
                                fun validate(): UnnamedSchemaWithArrayParent1 = apply {
                                    if (!validated) {
                                        if (unionMember0 == null && unionMember1 == null) {
                                            throw BraintrustInvalidDataException(
                                                "Unknown UnnamedSchemaWithArrayParent1: $_json"
                                            )
                                        }
                                        unionMember0?.validate()
                                        unionMember1?.validate()
                                ...
                                override fun toString(): String {
                                    return when {
                                        ...
                                        unionMember1 != null ->
                                            "UnnamedSchemaWithArrayParent1{unionMember1=$unionMember1}"
                                        _json != null ->
                                ...
                                class Deserializer :
                                    ...
                                    override fun ObjectCodec.deserialize(
                                        ...
                                        tryDeserialize(node, jacksonTypeRef<UnionMember0>()) {
                                            ...
                                            ?.let {
                                                return UnnamedSchemaWithArrayParent1(
                                                    unionMember0 = it,
                                                    _json = json
                                                )
                                            }
