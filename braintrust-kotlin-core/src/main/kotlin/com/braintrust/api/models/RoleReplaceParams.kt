...
constructor(
    ...
    override fun toString() =
        "RoleReplaceParams{name=$name, description=$description, memberPermissions=$memberPermissions, memberRoles=$memberRoles, orgName=$orgName, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    private constructor(
        ...
        companion object {
            ...
            val CREATE = MemberPermission(JsonField.of("create"))

            val READ = MemberPermission(JsonField.of("read"))

            val UPDATE = MemberPermission(JsonField.of("update"))

            val DELETE = MemberPermission(JsonField.of("delete"))

            val CREATE_ACLS = MemberPermission(JsonField.of("create_acls"))

            val READ_ACLS = MemberPermission(JsonField.of("read_acls"))

            val UPDATE_ACLS = MemberPermission(JsonField.of("update_acls"))

            val DELETE_ACLS = MemberPermission(JsonField.of("delete_acls"))

            fun of(value: String) = MemberPermission(JsonField.of(value))
        }
