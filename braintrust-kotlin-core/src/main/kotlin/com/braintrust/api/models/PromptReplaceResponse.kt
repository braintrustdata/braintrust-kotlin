...
@JsonDeserialize(builder = PromptReplaceResponse.Builder::class)
@NoAutoDetect
class PromptReplaceResponse
private constructor(
    ...
    fun validate(): PromptReplaceResponse = apply {
        if (!validated) {
            id()
            _xactId()
            projectId()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PromptReplaceResponse &&
            this.id == other.id &&
    ...
    override fun toString() =
        "PromptReplaceResponse{id=$id, _xactId=$_xactId, projectId=$projectId, logId=$logId, orgId=$orgId, name=$name, slug=$slug, description=$description, created=$created, promptData=$promptData, tags=$tags, metadata=$metadata, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(promptReplaceResponse: PromptReplaceResponse) = apply {
            this.id = promptReplaceResponse.id
            this._xactId = promptReplaceResponse._xactId
            this.projectId = promptReplaceResponse.projectId
            this.logId = promptReplaceResponse.logId
            this.orgId = promptReplaceResponse.orgId
            this.name = promptReplaceResponse.name
            this.slug = promptReplaceResponse.slug
            this.description = promptReplaceResponse.description
            this.created = promptReplaceResponse.created
            this.promptData = promptReplaceResponse.promptData
            this.tags = promptReplaceResponse.tags
            this.metadata = promptReplaceResponse.metadata
            additionalProperties(promptReplaceResponse.additionalProperties)
        }
        ...
        fun build(): PromptReplaceResponse =
                ...
                private constructor(
                    ...
                    private constructor(
                        ...
                        private constructor(
                            ...
                            private val unnamedSchemaWithArrayParent8s:
                                List<UnnamedSchemaWithArrayParent8>? =
                                null,
                            private val _json: JsonValue? = null,
                        ) {
                            ...
                            fun asUnnamedSchemaWithArrayParent8s():
                                List<UnnamedSchemaWithArrayParent8> =
                                unnamedSchemaWithArrayParent8s.getOrThrow(
                                    "unnamedSchemaWithArrayParent8s"
                                )
                            ...
                            fun validate(): Content = apply {
                                if (!validated) {
                                    if (string == null && unnamedSchemaWithArrayParent8s == null) {
                                        throw BraintrustInvalidDataException(
                            ...
                            override fun equals(other: Any?): Boolean {
                                ...
                                return other is Content &&
                                    ...
                                    this.unnamedSchemaWithArrayParent8s ==
                                        other.unnamedSchemaWithArrayParent8s
                            }

                            override fun hashCode(): Int {
                                return Objects.hash(string, unnamedSchemaWithArrayParent8s)
                            }
                                    ...
                                    when {
                                        ...
                                        value.unnamedSchemaWithArrayParent8s != null ->
                                            generator.writeObject(
                                                value.unnamedSchemaWithArrayParent8s
                                            )
                                        value._json != null -> generator.writeObject(value._json)
                                        else -> throw IllegalStateException("Invalid Content")
                                    }
                            ...
                            @JsonDeserialize(
                                using = UnnamedSchemaWithArrayParent8.Deserializer::class
                            )
                            ...
                            private constructor(
                                ...
                                fun validate(): UnnamedSchemaWithArrayParent8 = apply {
                                    if (!validated) {
                                        if (unionMember0 == null && unionMember1 == null) {
                                            throw BraintrustInvalidDataException(
                                                "Unknown UnnamedSchemaWithArrayParent8: $_json"
                                            )
                                        }
                                        unionMember0?.validate()
                                        unionMember1?.validate()
                                ...
                                override fun toString(): String {
                                    return when {
                                        ...
                                        unionMember1 != null ->
                                            "UnnamedSchemaWithArrayParent8{unionMember1=$unionMember1}"
                                        _json != null ->
                                            "UnnamedSchemaWithArrayParent8{_unknown=$_json}"
                                        else ->
                                ...
                                class Deserializer :
                                    ...
                                    override fun ObjectCodec.deserialize(
                                        ...
                                        tryDeserialize(node, jacksonTypeRef<UnionMember0>()) {
                                            ...
                                            ?.let {
                                                return UnnamedSchemaWithArrayParent8(
                                                    unionMember0 = it,
                                                    _json = json
                                                )
                                            }
                                        ...
                                        return UnnamedSchemaWithArrayParent8(_json = json)
                                    }
                                }
