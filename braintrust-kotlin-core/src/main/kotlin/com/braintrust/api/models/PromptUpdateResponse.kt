...
@JsonDeserialize(builder = PromptUpdateResponse.Builder::class)
@NoAutoDetect
class PromptUpdateResponse
private constructor(
    ...
    fun validate(): PromptUpdateResponse = apply {
        if (!validated) {
            id()
            _xactId()
            projectId()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PromptUpdateResponse &&
            this.id == other.id &&
    ...
    override fun toString() =
        "PromptUpdateResponse{id=$id, _xactId=$_xactId, projectId=$projectId, logId=$logId, orgId=$orgId, name=$name, slug=$slug, description=$description, created=$created, promptData=$promptData, tags=$tags, metadata=$metadata, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(promptUpdateResponse: PromptUpdateResponse) = apply {
            this.id = promptUpdateResponse.id
            this._xactId = promptUpdateResponse._xactId
            this.projectId = promptUpdateResponse.projectId
            this.logId = promptUpdateResponse.logId
            this.orgId = promptUpdateResponse.orgId
            this.name = promptUpdateResponse.name
            this.slug = promptUpdateResponse.slug
            this.description = promptUpdateResponse.description
            this.created = promptUpdateResponse.created
            this.promptData = promptUpdateResponse.promptData
            this.tags = promptUpdateResponse.tags
            this.metadata = promptUpdateResponse.metadata
            additionalProperties(promptUpdateResponse.additionalProperties)
        }
        ...
        fun build(): PromptUpdateResponse =
                ...
                private constructor(
                    ...
                    private constructor(
                        ...
                        private constructor(
                            ...
                            fun asUnnamedSchemaWithArrayParent5s():
                                List<UnnamedSchemaWithArrayParent5> =
                                unnamedSchemaWithArrayParent5s.getOrThrow(
                                    "unnamedSchemaWithArrayParent5s"
                                )
                            ...
                            override fun equals(other: Any?): Boolean {
                                ...
                                return other is Content &&
                                    ...
                                    this.unnamedSchemaWithArrayParent5s ==
                                        other.unnamedSchemaWithArrayParent5s
                            }
                                    ...
                                    when {
                                        ...
                                        value.unnamedSchemaWithArrayParent5s != null ->
                                            generator.writeObject(
                                                value.unnamedSchemaWithArrayParent5s
                                            )
                                        value._json != null -> generator.writeObject(value._json)
                                        else -> throw IllegalStateException("Invalid Content")
                                    }
                            ...
                            private constructor(
                                ...
                                fun validate(): UnnamedSchemaWithArrayParent5 = apply {
                                    if (!validated) {
                                        if (unionMember0 == null && unionMember1 == null) {
                                            throw BraintrustInvalidDataException(
                                                "Unknown UnnamedSchemaWithArrayParent5: $_json"
                                            )
                                        }
                                        unionMember0?.validate()
                                        unionMember1?.validate()
                                ...
                                override fun toString(): String {
                                    return when {
                                        ...
                                        unionMember1 != null ->
                                            "UnnamedSchemaWithArrayParent5{unionMember1=$unionMember1}"
                                        _json != null ->
                                ...
                                class Deserializer :
                                    ...
                                    override fun ObjectCodec.deserialize(
                                        ...
                                        tryDeserialize(node, jacksonTypeRef<UnionMember0>()) {
                                            ...
                                            ?.let {
                                                return UnnamedSchemaWithArrayParent5(
                                                    unionMember0 = it,
                                                    _json = json
                                                )
                                            }
