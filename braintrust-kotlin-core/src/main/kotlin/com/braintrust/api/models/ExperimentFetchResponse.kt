...
private constructor(
    ...
    override fun toString() =
        "ExperimentFetchResponse{events=$events, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        fun build(): ExperimentFetchResponse =
    ...
    private constructor(
        ...
        override fun toString() =
            "Event{id=$id, datasetRecordId=$datasetRecordId, _xactId=$_xactId, created=$created, projectId=$projectId, experimentId=$experimentId, input=$input, output=$output, expected=$expected, scores=$scores, metadata=$metadata, metrics=$metrics, context=$context, spanId=$spanId, spanParents=$spanParents, rootSpanId=$rootSpanId, spanAttributes=$spanAttributes, additionalProperties=$additionalProperties}"
