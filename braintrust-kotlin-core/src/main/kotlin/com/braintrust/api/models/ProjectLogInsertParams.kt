...
constructor(
    ...
    private constructor(
        ...
        fun insertProjectLogsEventReplace(): InsertProjectLogsEventReplace? =
            insertProjectLogsEventReplace

        fun insertProjectLogsEventMerge(): InsertProjectLogsEventMerge? =
        ...
        @NoAutoDetect
        class InsertProjectLogsEventReplace
        private constructor(
            ...
            /**
             * Pass `_object_delete=true` to mark the project logs event deleted. Deleted events
             * will not show up in subsequent fetches for this project logs
             */
            ...
            override fun toString() =
                "InsertProjectLogsEventReplace{input=$input, output=$output, expected=$expected, scores=$scores, metadata=$metadata, tags=$tags, metrics=$metrics, context=$context, spanAttributes=$spanAttributes, id=$id, _objectDelete=$_objectDelete, _isMerge=$_isMerge, _parentId=$_parentId, additionalProperties=$additionalProperties}"
            ...
            class Builder {
                ...
                internal fun from(insertProjectLogsEventReplace: InsertProjectLogsEventReplace) =
                    apply {
                 ...
                 * used to help you navigate while digging into analyses. However, we may later use
                ...
                fun build(): InsertProjectLogsEventReplace =
                    InsertProjectLogsEventReplace(
                        input,
                        output,
                        expected,
            ...
            private constructor(
                ...
                fun callerFunctionname(): String? =
                    callerFunctionname.getNullable("caller_functionname")
            ...
            private constructor(
                ...
                class Builder {
                    ...
                    /**
                     * The number of tokens in the prompt used to generate the project logs event
        ...
        private constructor(
            ...
            override fun toString() =
                "InsertProjectLogsEventMerge{input=$input, output=$output, expected=$expected, scores=$scores, metadata=$metadata, tags=$tags, metrics=$metrics, context=$context, spanAttributes=$spanAttributes, id=$id, _objectDelete=$_objectDelete, _isMerge=$_isMerge, _mergePaths=$_mergePaths, additionalProperties=$additionalProperties}"
            ...
            class Builder {
                ...
                internal fun from(insertProjectLogsEventMerge: InsertProjectLogsEventMerge) =
                    apply {
