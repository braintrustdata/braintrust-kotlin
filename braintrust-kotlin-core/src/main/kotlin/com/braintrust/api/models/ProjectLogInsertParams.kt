...
constructor(
    ...
    private constructor(
        ...
        private constructor(
            ...
            override fun toString() =
                "InsertProjectLogsEventReplace{input=$input, output=$output, expected=$expected, scores=$scores, metadata=$metadata, metrics=$metrics, context=$context, spanAttributes=$spanAttributes, id=$id, _objectDelete=$_objectDelete, _isMerge=$_isMerge, _parentId=$_parentId, additionalProperties=$additionalProperties}"
        ...
        private constructor(
            ...
            override fun toString() =
                "InsertProjectLogsEventMerge{input=$input, output=$output, expected=$expected, scores=$scores, metadata=$metadata, metrics=$metrics, context=$context, spanAttributes=$spanAttributes, id=$id, _objectDelete=$_objectDelete, _isMerge=$_isMerge, _mergePaths=$_mergePaths, additionalProperties=$additionalProperties}"
