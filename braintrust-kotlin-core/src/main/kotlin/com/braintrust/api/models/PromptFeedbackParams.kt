...
constructor(
    ...
    internal constructor(
        ...
        override fun toString() =
            "PromptFeedbackBody{feedback=$feedback, additionalProperties=$additionalProperties}"
    ...
    override fun toString() =
        "PromptFeedbackParams{promptId=$promptId, feedback=$feedback, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        fun build(): PromptFeedbackParams =
    ...
    private constructor(
        ...
        /**
         * The id of the prompt event to log feedback for. This is the row `id` returned by `POST
