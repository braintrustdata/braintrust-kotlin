    ...
    private constructor(
        ...
        private constructor(
            ...
            companion object {
                ...
                val CREATE = UnionMember0(JsonField.of("create"))

                val READ = UnionMember0(JsonField.of("read"))

                val UPDATE = UnionMember0(JsonField.of("update"))

                val DELETE = UnionMember0(JsonField.of("delete"))

                val CREATE_ACLS = UnionMember0(JsonField.of("create_acls"))

                val READ_ACLS = UnionMember0(JsonField.of("read_acls"))

                val UPDATE_ACLS = UnionMember0(JsonField.of("update_acls"))

                val DELETE_ACLS = UnionMember0(JsonField.of("delete_acls"))
