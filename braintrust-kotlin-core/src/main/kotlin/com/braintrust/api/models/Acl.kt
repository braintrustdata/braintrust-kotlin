...
private constructor(
    ...
    fun userPermissionAcl(): UserPermissionAcl? = userPermissionAcl

    fun userRoleAcl(): UserRoleAcl? = userRoleAcl

    fun groupPermissionAcl(): GroupPermissionAcl? = groupPermissionAcl

    fun groupRoleAcl(): GroupRoleAcl? = groupRoleAcl
    ...
    companion object {
        ...
        fun ofUserRoleAcl(userRoleAcl: UserRoleAcl) = Acl(userRoleAcl = userRoleAcl)

        fun ofGroupPermissionAcl(groupPermissionAcl: GroupPermissionAcl) =
            Acl(groupPermissionAcl = groupPermissionAcl)

        fun ofGroupRoleAcl(groupRoleAcl: GroupRoleAcl) = Acl(groupRoleAcl = groupRoleAcl)
    }
