...
class DatasetFeedbackParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        @JsonProperty("feedback") @ExcludeMissing private val feedback: JsonField<List<FeedbackDatasetItem>> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
            ...
            /** A list of dataset feedback items */
            fun feedback(feedback: JsonField<List<FeedbackDatasetItem>>) =
                apply {
                    this.feedback = feedback.map { it.toMutableList() }
                }

            /** A list of dataset feedback items */
            fun addFeedback(feedback: FeedbackDatasetItem) =
                apply {
    ...
    class Builder internal constructor() {
        ...
        internal fun from(datasetFeedbackParams: DatasetFeedbackParams) =
            apply {
        ...
        /** A list of dataset feedback items */
        fun feedback(feedback: List<FeedbackDatasetItem>) =
            apply {
    ...
    override fun toString() = "DatasetFeedbackParams{datasetId=$datasetId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
