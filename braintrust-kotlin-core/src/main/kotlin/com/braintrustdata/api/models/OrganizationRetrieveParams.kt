...
class OrganizationRetrieveParams constructor(private val organizationId: String, private val additionalQueryParams: Map<String, List<String>>, private val additionalHeaders: Map<String, List<String>>, ) {
