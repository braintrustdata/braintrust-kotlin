...
class ViewReplaceParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    @NoAutoDetect
    class ViewReplaceBody internal constructor(
      private val name: String?,
      private val objectId: String?,
      private val objectType: ObjectType?,
      private val viewType: ViewType?,
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        override fun toString() = "ViewReplaceBody{name=$name, objectId=$objectId, objectType=$objectType, viewType=$viewType, deletedAt=$deletedAt, options=$options, userId=$userId, viewData=$viewData, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            fun build(): ViewReplaceBody = ViewReplaceBody(
                checkNotNull(name) {
    ...
    class Builder {
        ...
        fun build(): ViewReplaceParams = ViewReplaceParams(
            checkNotNull(name) {
                "`name` is required but was not set"
            },
            checkNotNull(objectId) {
