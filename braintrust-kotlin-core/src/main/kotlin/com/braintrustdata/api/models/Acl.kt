...
class Acl private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    @ExcludeMissing
    fun __objectOrgId() = _objectOrgId
    ...
    override fun toString() = "Acl{id=$id, objectType=$objectType, objectId=$objectId, userId=$userId, groupId=$groupId, permission=$permission, restrictObjectType=$restrictObjectType, roleId=$roleId, _objectOrgId=$_objectOrgId, created=$created, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        @JsonProperty("role_id")
        @ExcludeMissing
        fun roleId(roleId: JsonField<String>) = apply {
            this.roleId = roleId
        }
