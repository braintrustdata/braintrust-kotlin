 ...
 */
class SpanIframeListPage private constructor(
    ...
    override fun toString() = "SpanIframeListPage{spanIframesService=$spanIframesService, params=$params, response=$response}"
    ...
    companion object {
        ...
        fun of(spanIframesService: SpanIframeService, params: SpanIframeListParams, response: Response) =
            SpanIframeListPage(
              spanIframesService,
              params,
              response,
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<SpanIFrame> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {
