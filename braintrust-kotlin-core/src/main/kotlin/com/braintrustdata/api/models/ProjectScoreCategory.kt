...
@NoAutoDetect
class ProjectScoreCategory @JsonCreator private constructor(
    ...
    fun validate(): ProjectScoreCategory =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(projectScoreCategory: ProjectScoreCategory) =
            apply {
