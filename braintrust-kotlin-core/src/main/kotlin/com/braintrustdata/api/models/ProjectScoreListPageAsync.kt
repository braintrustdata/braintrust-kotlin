...
class ProjectScoreListPageAsync private constructor(private val projectScoreService: ProjectScoreServiceAsync, private val params: ProjectScoreListParams, private val response: Response, ) {
    ...
    fun getNextPageParams(): ProjectScoreListParams? {
      ...
      return if (params.endingBefore() != null) {
        ProjectScoreListParams.builder().from(params).endingBefore(objects().first().id()).build();
      } else {
        ProjectScoreListParams.builder().from(params).startingAfter(objects().last().id()).build();
      }
    }
    ...
    @NoAutoDetect
    class Response constructor(private val objects: JsonField<List<ProjectScore>>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        fun _objects(): JsonField<List<ProjectScore>>? = objects
        ...
        override fun toString() = "ProjectScoreListPageAsync.Response{objects=$objects, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: ProjectScoreListPageAsync, ) : Flow<ProjectScore> {
