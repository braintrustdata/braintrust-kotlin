...
private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("objects") @ExcludeMissing objects: JsonField<List<User>> = JsonMissing.of()
     ...
     */
    fun objects(): List<User> = objects.getRequired("objects")
     ...
     */
    @JsonProperty("objects") @ExcludeMissing fun _objects(): JsonField<List<User>> = objects
    ...
    class Builder internal constructor() {
        ...
        private var objects: JsonField<MutableList<User>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(userListPageResponse: UserListPageResponse) = apply {
            objects = userListPageResponse.objects.map { it.toMutableList() }
         ...
         *
         * You should usually call [Builder.objects] with a well-typed `List<User>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun objects(objects: JsonField<List<User>>) = apply {
            this.objects = objects.map { it.toMutableList() }
        }

        /**
         * Adds a single [User] to [objects].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addObject(object_: User) = apply {
            objects =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is UserListPageResponse && objects == other.objects && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "UserListPageResponse{objects=$objects, additionalProperties=$additionalProperties}"
}
