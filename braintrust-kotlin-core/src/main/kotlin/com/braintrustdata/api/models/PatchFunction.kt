...
@JsonDeserialize(builder = PatchFunction.Builder::class)
@NoAutoDetect
class PatchFunction
private constructor(
    ...
    fun validate(): PatchFunction = apply {
        if (!validated) {
            name()
            description()
            promptData()?.validate()
    ...
    override fun toString() =
        "PatchFunction{name=$name, description=$description, promptData=$promptData, functionData=$functionData, tags=$tags, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(patchFunction: PatchFunction) = apply {
            this.name = patchFunction.name
            this.description = patchFunction.description
            this.promptData = patchFunction.promptData
            this.functionData = patchFunction.functionData
            this.tags = patchFunction.tags
            additionalProperties(patchFunction.additionalProperties)
        }
