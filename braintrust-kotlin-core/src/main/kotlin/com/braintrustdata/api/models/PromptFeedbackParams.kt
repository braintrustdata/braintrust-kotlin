...
class PromptFeedbackParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    internal fun getBody(): PromptFeedbackBody {
      return PromptFeedbackBody(feedback, additionalBodyProperties)
    }
    ...
    @JsonDeserialize(builder = PromptFeedbackBody.Builder::class)
    @NoAutoDetect
    class PromptFeedbackBody internal constructor(private val feedback: List<Feedback>?, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is PromptFeedbackBody &&
        ...
        override fun toString() = "PromptFeedbackBody{feedback=$feedback, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            internal fun from(promptFeedbackBody: PromptFeedbackBody) = apply {
                this.feedback = promptFeedbackBody.feedback
                additionalProperties(promptFeedbackBody.additionalProperties)
            }
            ...
            fun build(): PromptFeedbackBody = PromptFeedbackBody(checkNotNull(feedback) {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PromptFeedbackParams &&
    ...
    override fun toString() = "PromptFeedbackParams{promptId=$promptId, feedback=$feedback, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(promptFeedbackParams: PromptFeedbackParams) = apply {
            this.promptId = promptFeedbackParams.promptId
            this.feedback(promptFeedbackParams.feedback)
            additionalQueryParams(promptFeedbackParams.additionalQueryParams)
            additionalHeaders(promptFeedbackParams.additionalHeaders)
            additionalBodyProperties(promptFeedbackParams.additionalBodyProperties)
        }
        ...
        fun build(): PromptFeedbackParams = PromptFeedbackParams(
