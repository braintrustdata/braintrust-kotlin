 ...
 */
class ProjectTagListPage private constructor(
    ...
    companion object {
        ...
        fun of(projectTagsService: ProjectTagService, params: ProjectTagListParams, response: Response) =
            ProjectTagListPage(
              projectTagsService,
              params,
              response,
    ...
    class Response @JsonCreator constructor(
        @JsonProperty("objects") private val objects: JsonField<List<ProjectTag>> = JsonMissing.of(),
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<ProjectTag> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {
