 ...
 */
class ViewCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(viewCreateParams: ViewCreateParams) =
            apply {
    ...
    override fun toString() = "ViewCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
