...
private constructor(
    ...
    private constructor(
        ...
        ) : this(metadata, name, secret, type, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(metadata, name, secret, type, additionalProperties.toMutableMap())
        }
        ...
        override fun toString() =
            "Body{metadata=$metadata, name=$name, secret=$secret, type=$type, additionalProperties=$additionalProperties}"
    }
