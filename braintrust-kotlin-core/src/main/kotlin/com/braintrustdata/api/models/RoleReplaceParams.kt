...
class RoleReplaceParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    @NoAutoDetect
    class RoleReplaceBody internal constructor(
      private val name: String?,
      private val description: String?,
      private val memberPermissions: List<MemberPermission>?,
      private val memberRoles: List<String>?,
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is RoleReplaceBody &&
        ...
        override fun toString() = "RoleReplaceBody{name=$name, description=$description, memberPermissions=$memberPermissions, memberRoles=$memberRoles, orgName=$orgName, additionalProperties=$additionalProperties}"
    ...
    override fun toString() = "RoleReplaceParams{name=$name, description=$description, memberPermissions=$memberPermissions, memberRoles=$memberRoles, orgName=$orgName, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        fun build(): RoleReplaceParams = RoleReplaceParams(
            checkNotNull(name) {
                "`name` is required but was not set"
            },
            description,
