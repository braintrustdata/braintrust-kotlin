...
@NoAutoDetect
class ScoreSummary @JsonCreator private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(scoreSummary: ScoreSummary) =
            apply {
    ...
    override fun toString() = "ScoreSummary{improvements=$improvements, name=$name, regressions=$regressions, score=$score, diff=$diff, additionalProperties=$additionalProperties}"
}
