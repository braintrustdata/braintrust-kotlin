...
class AiSecretFindAndDeleteParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        override fun toString() = "Body{name=$name, orgName=$orgName, additionalProperties=$additionalProperties}"
    }
    ...
    /** A builder for [AiSecretFindAndDeleteParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        internal fun from(aiSecretFindAndDeleteParams: AiSecretFindAndDeleteParams) =
            apply {
                body = aiSecretFindAndDeleteParams.body.toBuilder()
                additionalHeaders = aiSecretFindAndDeleteParams.additionalHeaders.toBuilder()
                additionalQueryParams = aiSecretFindAndDeleteParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() = "AiSecretFindAndDeleteParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
