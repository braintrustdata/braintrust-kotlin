...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AiSecretFindAndDeleteParams].
         *
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [AiSecretFindAndDeleteParams].
         *
    ...
    private constructor(
        ...
        ) : this(name, orgName, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(checkRequired("name", name), orgName, additionalProperties.toMutableMap())
        }
        ...
        internal fun validity(): Int =
            (if (name.asKnown() == null) 0 else 1) + (if (orgName.asKnown() == null) 0 else 1)
