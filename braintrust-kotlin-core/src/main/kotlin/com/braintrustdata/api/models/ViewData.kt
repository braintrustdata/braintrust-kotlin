...
/** The view definition */
@NoAutoDetect
class ViewData @JsonCreator private constructor(
    @JsonProperty("search") @ExcludeMissing private val search: JsonField<ViewDataSearch> = JsonMissing.of(),
    ...
    @JsonProperty("search")
    @ExcludeMissing
    fun _search(): JsonField<ViewDataSearch> = search
    ...
    class Builder internal constructor() {
        ...
        internal fun from(viewData: ViewData) =
            apply {
        ...
        fun search(search: JsonField<ViewDataSearch>) =
            apply {
                this.search = search
            }
        ...
        fun build(): ViewData =
            ViewData(
              search, additionalProperties.toImmutable()
            )
    }
