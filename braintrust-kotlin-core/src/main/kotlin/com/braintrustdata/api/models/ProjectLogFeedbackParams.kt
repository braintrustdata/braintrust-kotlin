...
class ProjectLogFeedbackParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        @JsonProperty("feedback") @ExcludeMissing private val feedback: JsonField<List<FeedbackProjectLogsItem>> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
            ...
            /** A list of project logs feedback items */
            fun feedback(feedback: JsonField<List<FeedbackProjectLogsItem>>) =
                apply {
                    this.feedback = feedback.map { it.toMutableList() }
                }

            /** A list of project logs feedback items */
            fun addFeedback(feedback: FeedbackProjectLogsItem) =
                apply {
    ...
    class Builder internal constructor() {
        ...
        internal fun from(projectLogFeedbackParams: ProjectLogFeedbackParams) =
            apply {
        ...
        /** A list of project logs feedback items */
        fun feedback(feedback: List<FeedbackProjectLogsItem>) =
            apply {
    ...
    override fun toString() = "ProjectLogFeedbackParams{projectId=$projectId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
