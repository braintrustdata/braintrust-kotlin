...
class ProjectTagDeleteParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(projectTagDeleteParams: ProjectTagDeleteParams) =
            apply {
                projectTagId = projectTagDeleteParams.projectTagId
                additionalHeaders = projectTagDeleteParams.additionalHeaders.toBuilder()
                additionalQueryParams = projectTagDeleteParams.additionalQueryParams.toBuilder()
                additionalBodyProperties = projectTagDeleteParams.additionalBodyProperties.toMutableMap()
            }

        /** ProjectTag id */
        fun projectTagId(projectTagId: String) =
            apply {
    ...
    override fun toString() = "ProjectTagDeleteParams{projectTagId=$projectTagId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
