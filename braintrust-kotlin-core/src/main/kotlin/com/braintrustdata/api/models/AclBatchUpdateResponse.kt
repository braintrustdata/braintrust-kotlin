...
@NoAutoDetect
class AclBatchUpdateResponse @JsonCreator private constructor(
    @JsonProperty("added_acls") @ExcludeMissing private val addedAcls: JsonField<List<Acl>> = JsonMissing.of(),
    @JsonProperty("removed_acls") @ExcludeMissing private val removedAcls: JsonField<List<Acl>> = JsonMissing.of(),
    ...
    @ExcludeMissing
    fun _addedAcls(): JsonField<List<Acl>> = addedAcls
    ...
    fun validate(): AclBatchUpdateResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(aclBatchUpdateResponse: AclBatchUpdateResponse) =
            apply {
         ...
         * part of a role.
         */
        fun addedAcls(addedAcls: JsonField<List<Acl>>) =
            apply {
         ...
         * part of a role.
         */
        fun addAddedAcl(addedAcl: Acl) =
            apply {
                addedAcls = (addedAcls ?: JsonField.of(mutableListOf())).also {
         ...
         * part of a role.
         */
        fun removedAcls(removedAcls: JsonField<List<Acl>>) =
            apply {
         ...
         * part of a role.
         */
        fun addRemovedAcl(removedAcl: Acl) =
            apply {
                removedAcls = (removedAcls ?: JsonField.of(mutableListOf())).also {
    ...
    override fun toString() = "AclBatchUpdateResponse{addedAcls=$addedAcls, removedAcls=$removedAcls, additionalProperties=$additionalProperties}"
}
