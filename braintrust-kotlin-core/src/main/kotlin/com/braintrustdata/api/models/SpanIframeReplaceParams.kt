...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [SpanIframeReplaceParams].
         *
    ...
    private constructor(
        ...
        ) : this(name, projectId, url, description, postMessage, mutableMapOf())
        ...
        internal fun validity(): Int =
            (if (name.asKnown() == null) 0 else 1) +
                ...
                (if (postMessage.asKnown() == null) 0 else 1)
        ...
        private val hashCode: Int by lazy {
            Objects.hash(name, projectId, url, description, postMessage, additionalProperties)
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SpanIframeReplaceParams &&
            body == other.body &&
