...
private constructor(
    ...
    private constructor(
        ...
        @ExcludeMissing
        objects: JsonField<List<Organization>> = JsonMissing.of()
     ...
     */
    fun objects(): List<Organization> = objects.getRequired("objects")
     ...
     */
    @JsonProperty("objects") @ExcludeMissing fun _objects(): JsonField<List<Organization>> = objects
    ...
    class Builder internal constructor() {
        ...
        private var objects: JsonField<MutableList<Organization>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(organizationListPageResponse: OrganizationListPageResponse) = apply {
            objects = organizationListPageResponse.objects.map { it.toMutableList() }
         ...
         *
         * You should usually call [Builder.objects] with a well-typed `List<Organization>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun objects(objects: JsonField<List<Organization>>) = apply {
            this.objects = objects.map { it.toMutableList() }
        }

        /**
         * Adds a single [Organization] to [objects].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addObject(object_: Organization) = apply {
            objects =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is OrganizationListPageResponse && objects == other.objects && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "OrganizationListPageResponse{objects=$objects, additionalProperties=$additionalProperties}"
}
