...
@NoAutoDetect
class ProjectScoreConfig @JsonCreator private constructor(
    @JsonProperty("destination") @ExcludeMissing private val destination: JsonField<Destination> = JsonMissing.of(),
    @JsonProperty("multi_select") @ExcludeMissing private val multiSelect: JsonField<Boolean> = JsonMissing.of(),
    @JsonProperty("online") @ExcludeMissing private val online: JsonField<OnlineScoreConfig> = JsonMissing.of(),
    ...
    @JsonProperty("online")
    @ExcludeMissing
    fun _online(): JsonField<OnlineScoreConfig> = online
    ...
    fun validate(): ProjectScoreConfig =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(projectScoreConfig: ProjectScoreConfig) =
            apply {
        ...
        fun destination(destination: JsonField<Destination>) =
            apply {
        ...
        fun multiSelect(multiSelect: JsonField<Boolean>) =
            apply {
        ...
        fun online(online: JsonField<OnlineScoreConfig>) =
            apply {
                this.online = online
            }
    ...
    class Destination @JsonCreator private constructor(
        ...
        /**
         * An enum containing [Destination]'s known values, as well as an [_UNKNOWN]
         * member.
         *
    ...
    override fun toString() = "ProjectScoreConfig{destination=$destination, multiSelect=$multiSelect, online=$online, additionalProperties=$additionalProperties}"
}
