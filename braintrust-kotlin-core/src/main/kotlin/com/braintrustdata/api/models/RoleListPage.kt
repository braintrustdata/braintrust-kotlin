...
class RoleListPage private constructor(private val rolesService: RoleService, private val params: RoleListParams, private val response: Response, ) {
    ...
    class Response constructor(private val objects: JsonField<List<Role>>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        fun _objects(): JsonField<List<Role>>? = objects
        ...
        override fun toString() = "RoleListPage.Response{objects=$objects, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: RoleListPage, ) : Sequence<Role> {
