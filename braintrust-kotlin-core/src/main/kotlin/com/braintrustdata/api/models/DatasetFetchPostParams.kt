 ...
 */
class DatasetFetchPostParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        @JsonProperty("cursor") @ExcludeMissing private val cursor: JsonField<String> = JsonMissing.of(),
        @JsonProperty("limit") @ExcludeMissing private val limit: JsonField<Long> = JsonMissing.of(),
        @JsonProperty("max_root_span_id") @ExcludeMissing private val maxRootSpanId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("max_xact_id") @ExcludeMissing private val maxXactId: JsonField<String> = JsonMissing.of(),
        ...
        @ExcludeMissing
        fun _maxXactId(): JsonField<String> = maxXactId
        ...
        class Builder internal constructor() {
             ...
             * for an overview of paginating fetch queries.
             */
            fun maxRootSpanId(maxRootSpanId: String?) = maxRootSpanId(JsonField.ofNullable(maxRootSpanId))
             ...
             * for an overview of paginating fetch queries.
             */
            fun maxRootSpanId(maxRootSpanId: JsonField<String>) =
                apply {
             ...
             * for an overview of paginating fetch queries.
             */
            fun maxXactId(maxXactId: JsonField<String>) =
                apply {
        ...
        override fun toString() = "Body{cursor=$cursor, limit=$limit, maxRootSpanId=$maxRootSpanId, maxXactId=$maxXactId, version=$version, additionalProperties=$additionalProperties}"
    }
    ...
    /** A builder for [DatasetFetchPostParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        internal fun from(datasetFetchPostParams: DatasetFetchPostParams) =
            apply {
                datasetId = datasetFetchPostParams.datasetId
                body = datasetFetchPostParams.body.toBuilder()
         ...
         * for an overview of paginating fetch queries.
         */
        fun maxXactId(maxXactId: String?) =
            apply {
                body.maxXactId(maxXactId)
            }
    ...
    override fun toString() = "DatasetFetchPostParams{datasetId=$datasetId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
