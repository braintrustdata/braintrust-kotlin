...
constructor(
    ...
    fun settings(): ProjectSettings? = settings
    ...
    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(projectId, name, settings, additionalQueryParams, additionalHeaders, additionalBodyProperties) /* spotless:on */
    }
