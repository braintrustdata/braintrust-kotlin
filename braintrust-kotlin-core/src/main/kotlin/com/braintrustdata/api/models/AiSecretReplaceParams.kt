 ...
 */
class AiSecretReplaceParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(aiSecretReplaceParams: AiSecretReplaceParams) =
            apply {
    ...
    override fun toString() = "AiSecretReplaceParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
