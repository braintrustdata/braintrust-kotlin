 ...
 */
class ProjectTagReplaceParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        override fun toString() = "Body{name=$name, projectId=$projectId, color=$color, description=$description, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(projectTagReplaceParams: ProjectTagReplaceParams) =
            apply {
    ...
    override fun toString() = "ProjectTagReplaceParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
