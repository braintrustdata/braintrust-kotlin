...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(insertExperimentEventReplace: InsertExperimentEventReplace) = apply {
            ...
            this.error = insertExperimentEventReplace.error
    ...
    override fun hashCode(): Int {
        if (hashCode == 0) {
            hashCode = /* spotless:off */ Objects.hash(input, output, expected, error, scores, metadata, tags, metrics, context, spanAttributes, id, datasetRecordId, created, _objectDelete, _isMerge, _parentId, additionalProperties) /* spotless:on */
        }
        return hashCode
    }

    override fun toString() =
        "InsertExperimentEventReplace{input=$input, output=$output, expected=$expected, error=$error, scores=$scores, metadata=$metadata, tags=$tags, metrics=$metrics, context=$context, spanAttributes=$spanAttributes, id=$id, datasetRecordId=$datasetRecordId, created=$created, _objectDelete=$_objectDelete, _isMerge=$_isMerge, _parentId=$_parentId, additionalProperties=$additionalProperties}"
}
