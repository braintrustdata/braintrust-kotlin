  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    class PromptUpdateBody internal constructor(
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        override fun toString() = "PromptUpdateBody{description=$description, name=$name, promptData=$promptData, tags=$tags, additionalProperties=$additionalProperties}"
    ...
    override fun toString() = "PromptUpdateParams{promptId=$promptId, description=$description, name=$name, promptData=$promptData, tags=$tags, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
                  ...
                  private val _json: JsonValue? = null,
                    ...
                    class UnionMember1 private constructor(
                      ...
                      private val additionalProperties: Map<String, JsonValue>,
                        ...
                        class Content private constructor(private val string: String? = null, private val unnamedSchemaWithArrayParent1s: List<UnnamedSchemaWithArrayParent1>? = null, private val _json: JsonValue? = null, ) {

                            private var validated: Boolean = false

                            fun string(): String? = string
                            fun unnamedSchemaWithArrayParent1s(): List<UnnamedSchemaWithArrayParent1>? = unnamedSchemaWithArrayParent1s

                            fun isString(): Boolean = string != null
                            fun isUnnamedSchemaWithArrayParent1s(): Boolean = unnamedSchemaWithArrayParent1s != null

                            fun asString(): String = string.getOrThrow("string")
                            fun asUnnamedSchemaWithArrayParent1s(): List<UnnamedSchemaWithArrayParent1> = unnamedSchemaWithArrayParent1s.getOrThrow("unnamedSchemaWithArrayParent1s")
                            ...
                            fun <T> accept(visitor: Visitor<T>): T {
                              return when {
                                  ...
                                  unnamedSchemaWithArrayParent1s != null -> visitor.visitUnnamedSchemaWithArrayParent1s(unnamedSchemaWithArrayParent1s)
                                  else -> visitor.unknown(_json)
                              }
                            }
                            ...
                            fun validate(): Content = apply {
                                if (!validated) {
                                  if (string == null && unnamedSchemaWithArrayParent1s == null) {
                            ...
                            override fun hashCode(): Int {
                              return Objects.hash(string, unnamedSchemaWithArrayParent1s)
                            }

                            override fun toString(): String {
                              return when {
                                  string != null -> "Content{string=$string}"
                                  unnamedSchemaWithArrayParent1s != null -> "Content{unnamedSchemaWithArrayParent1s=$unnamedSchemaWithArrayParent1s}"
                            ...
                            companion object {
                                ...
                                fun ofUnnamedSchemaWithArrayParent1s(unnamedSchemaWithArrayParent1s: List<UnnamedSchemaWithArrayParent1>) = Content(unnamedSchemaWithArrayParent1s = unnamedSchemaWithArrayParent1s)
                            }
                            ...
                            interface Visitor<out T> {
                                ...
                                fun visitUnnamedSchemaWithArrayParent1s(unnamedSchemaWithArrayParent1s: List<UnnamedSchemaWithArrayParent1>): T
                            ...
                            class Deserializer : BaseDeserializer<Content>(Content::class) {
                                ...
                                override fun ObjectCodec.deserialize(node: JsonNode): Content {
                                  ...
                                  tryDeserialize(node, jacksonTypeRef<List<UnnamedSchemaWithArrayParent1>>())?.let {
                                      return Content(unnamedSchemaWithArrayParent1s = it, _json = json)
                                  }
                            ...
                            class Serializer : BaseSerializer<Content>(Content::class) {
                                ...
                                override fun serialize(value: Content, generator: JsonGenerator, provider: SerializerProvider) {
                                  when {
                                      ...
                                      value.unnamedSchemaWithArrayParent1s != null -> generator.writeObject(value.unnamedSchemaWithArrayParent1s)
                                      value._json != null -> generator.writeObject(value._json)
                                      else -> throw IllegalStateException("Invalid Content")
                                  }
                                }
                            ...
                            class UnnamedSchemaWithArrayParent1 private constructor(private val unionMember0: UnionMember0? = null, private val unionMember1: UnionMember1? = null, private val _json: JsonValue? = null, ) {
                                ...
                                fun validate(): UnnamedSchemaWithArrayParent1 = apply {
                                    if (!validated) {
                                      if (unionMember0 == null && unionMember1 == null) {
                                        throw BraintrustInvalidDataException("Unknown UnnamedSchemaWithArrayParent1: $_json")
                                      }
                                      unionMember0?.validate()
                                      unionMember1?.validate()
                                      validated = true
                                ...
                                override fun toString(): String {
                                  return when {
                                      unionMember0 != null -> "UnnamedSchemaWithArrayParent1{unionMember0=$unionMember0}"
                                      unionMember1 != null -> "UnnamedSchemaWithArrayParent1{unionMember1=$unionMember1}"
                                ...
                                companion object {
                                    ...
                                    fun ofUnionMember0(unionMember0: UnionMember0) = UnnamedSchemaWithArrayParent1(unionMember0 = unionMember0)

                                    fun ofUnionMember1(unionMember1: UnionMember1) = UnnamedSchemaWithArrayParent1(unionMember1 = unionMember1)
                                }
                                ...
                                interface Visitor<out T> {
                                    ...
                                    fun unknown(json: JsonValue?): T {
                                      throw BraintrustInvalidDataException("Unknown UnnamedSchemaWithArrayParent1: $json")
                                    }
                                }

                                class Deserializer : BaseDeserializer<UnnamedSchemaWithArrayParent1>(UnnamedSchemaWithArrayParent1::class) {

                                    override fun ObjectCodec.deserialize(node: JsonNode): UnnamedSchemaWithArrayParent1 {
                                      val json = JsonValue.fromJsonNode(node)
                                      tryDeserialize(node, jacksonTypeRef<UnionMember0>()){ it.validate() }?.let {
                                          return UnnamedSchemaWithArrayParent1(unionMember0 = it, _json = json)
                                      }
                                      tryDeserialize(node, jacksonTypeRef<UnionMember1>()){ it.validate() }?.let {
                                          return UnnamedSchemaWithArrayParent1(unionMember1 = it, _json = json)
                                      }
                                ...
                                class Serializer : BaseSerializer<UnnamedSchemaWithArrayParent1>(UnnamedSchemaWithArrayParent1::class) {

                                    override fun serialize(value: UnnamedSchemaWithArrayParent1, generator: JsonGenerator, provider: SerializerProvider) {
                                      when {
                                          value.unionMember0 != null -> generator.writeObject(value.unionMember0)
                                          value.unionMember1 != null -> generator.writeObject(value.unionMember1)
                                          value._json != null -> generator.writeObject(value._json)
