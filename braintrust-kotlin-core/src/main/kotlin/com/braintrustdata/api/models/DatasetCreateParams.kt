...
constructor(
    ...
    internal constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is DatasetCreateBody && this.name == other.name && this.projectId == other.projectId && this.description == other.description && this.metadata == other.metadata && this.additionalProperties == other.additionalProperties /* spotless:on */
        }
        ...
        override fun hashCode(): Int {
            if (hashCode == 0) {
                hashCode = /* spotless:off */ Objects.hash(name, projectId, description, metadata, additionalProperties) /* spotless:on */
            }
            return hashCode
        }
    ...
    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(name, projectId, description, metadata, additionalHeaders, additionalQueryParams, additionalBodyProperties) /* spotless:on */
    }
