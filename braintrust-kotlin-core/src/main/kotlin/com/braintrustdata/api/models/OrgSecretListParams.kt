...
class OrgSecretListParams constructor(
  ...
  private val additionalHeaders: Map<String, List<String>>,
    ...
    internal fun getQueryParams(): Map<String, List<String>> {
      ...
      this.orgSecretName?.let {
          params.put("org_secret_name", listOf(it.toString()))
      }
      this.orgSecretType?.let {
          params.put("org_secret_type", listOf(it.toString()))
      }
    ...
    class Builder {
        ...
        fun orgSecretName(orgSecretName: String) = apply {
            this.orgSecretName = orgSecretName
        }
        ...
        fun build(): OrgSecretListParams = OrgSecretListParams(
            endingBefore,
            ids,
            limit,
            orgName,
    ...
    class OrgSecretType private constructor(private val string: String? = null, private val strings: List<String>? = null, private val _json: JsonValue? = null, ) {
        ...
        class Serializer : BaseSerializer<OrgSecretType>(OrgSecretType::class) {
            ...
            override fun serialize(value: OrgSecretType, generator: JsonGenerator, provider: SerializerProvider) {
              when {
                  value.string != null -> generator.writeObject(value.string)
                  value.strings != null -> generator.writeObject(value.strings)
                  value._json != null -> generator.writeObject(value._json)
