...
@JsonDeserialize(builder = ExperimentFetchResponse.Builder::class)
@NoAutoDetect
class ExperimentFetchResponse private constructor(private val events: JsonField<List<Event>>, private val cursor: JsonField<String>, private val additionalProperties: Map<String, JsonValue>, ) {
    ...
    fun validate(): ExperimentFetchResponse = apply {
        if (!validated) {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ExperimentFetchResponse &&
    ...
    override fun toString() = "ExperimentFetchResponse{events=$events, cursor=$cursor, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(experimentFetchResponse: ExperimentFetchResponse) = apply {
            this.events = experimentFetchResponse.events
            this.cursor = experimentFetchResponse.cursor
            additionalProperties(experimentFetchResponse.additionalProperties)
        }
        ...
        fun build(): ExperimentFetchResponse = ExperimentFetchResponse(
    ...
    class Event private constructor(
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        @ExcludeMissing
        fun _experimentId() = experimentId
        ...
        override fun toString() = "Event{id=$id, datasetRecordId=$datasetRecordId, _xactId=$_xactId, created=$created, projectId=$projectId, experimentId=$experimentId, input=$input, output=$output, expected=$expected, scores=$scores, metadata=$metadata, tags=$tags, metrics=$metrics, context=$context, spanId=$spanId, spanParents=$spanParents, rootSpanId=$rootSpanId, spanAttributes=$spanAttributes, additionalProperties=$additionalProperties}"
