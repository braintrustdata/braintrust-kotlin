...
class UserListPageAsync private constructor(private val userService: UserServiceAsync, private val params: UserListParams, private val response: Response, ) {
    ...
    @NoAutoDetect
    class Response constructor(private val objects: JsonField<List<User>>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "UserListPageAsync.Response{objects=$objects, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: UserListPageAsync, ) : Flow<User> {
