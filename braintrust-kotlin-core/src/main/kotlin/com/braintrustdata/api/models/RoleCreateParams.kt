...
class RoleCreateParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    @NoAutoDetect
    class RoleCreateBody internal constructor(
      private val name: String?,
      private val description: String?,
      private val memberPermissions: List<MemberPermission>?,
      private val memberRoles: List<String>?,
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        override fun toString() = "RoleCreateBody{name=$name, description=$description, memberPermissions=$memberPermissions, memberRoles=$memberRoles, orgName=$orgName, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            fun build(): RoleCreateBody = RoleCreateBody(
                checkNotNull(name) {
    ...
    override fun toString() = "RoleCreateParams{name=$name, description=$description, memberPermissions=$memberPermissions, memberRoles=$memberRoles, orgName=$orgName, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        fun build(): RoleCreateParams = RoleCreateParams(
            checkNotNull(name) {
                "`name` is required but was not set"
            },
            description,
    ...
    @NoAutoDetect
    class MemberPermission private constructor(private val permission: Permission?, private val restrictObjectType: RestrictObjectType?, private val additionalProperties: Map<String, JsonValue>, ) {
