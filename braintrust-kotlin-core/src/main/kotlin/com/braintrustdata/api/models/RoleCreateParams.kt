 ...
 */
class RoleCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(roleCreateParams: RoleCreateParams) =
            apply {
    ...
    override fun toString() = "RoleCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
