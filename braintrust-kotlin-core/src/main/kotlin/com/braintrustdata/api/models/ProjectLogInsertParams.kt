...
class ProjectLogInsertParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        @JsonProperty("events") @ExcludeMissing private val events: JsonField<List<InsertProjectLogsEvent>> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
            ...
            /** A list of project logs events to insert */
            fun events(events: JsonField<List<InsertProjectLogsEvent>>) =
                apply {
                    this.events = events.map { it.toMutableList() }
                }

            /** A list of project logs events to insert */
            fun addEvent(event: InsertProjectLogsEvent) =
                apply {
    ...
    class Builder internal constructor() {
        ...
        internal fun from(projectLogInsertParams: ProjectLogInsertParams) =
            apply {
        ...
        /** A list of project logs events to insert */
        fun events(events: List<InsertProjectLogsEvent>) =
            apply {
                body.events(events)
            }
    ...
    override fun toString() = "ProjectLogInsertParams{projectId=$projectId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
