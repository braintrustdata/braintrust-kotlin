...
private constructor(
    ...
    private constructor(
        ...
        private constructor(
            private val type: JsonField<Type>,
            private val messages: JsonField<List<ChatCompletionMessage>>,
            ...
            fun messages(): List<ChatCompletionMessage> = messages.getRequired("messages")
            ...
            class Builder {
                ...
                private var type: JsonField<Type> = JsonMissing.of()
                private var messages: JsonField<List<ChatCompletionMessage>> = JsonMissing.of()
                ...
                fun messages(messages: List<ChatCompletionMessage>) =
                    messages(JsonField.of(messages))

                @JsonProperty("messages")
                @ExcludeMissing
                fun messages(messages: JsonField<List<ChatCompletionMessage>>) = apply {
