...
class PromptData private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "PromptData{prompt=$prompt, options=$options, parser=$parser, origin=$origin, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        @JsonProperty("parser")
        @ExcludeMissing
        fun parser(parser: JsonField<Parser>) = apply {
            this.parser = parser
        }
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        class Params private constructor(
          ...
          private val _json: JsonValue? = null,
            ...
            fun asOpenAIModelParams(): OpenAIModelParams = openaiModelParams.getOrThrow("openaiModelParams")
            fun asAnthropicModelParams(): AnthropicModelParams = anthropicModelParams.getOrThrow("anthropicModelParams")
            fun asGoogleModelParams(): GoogleModelParams = googleModelParams.getOrThrow("googleModelParams")
            fun asWindowAiModelParams(): WindowAiModelParams = windowAiModelParams.getOrThrow("windowAiModelParams")
            fun asJsCompletionParams(): JsCompletionParams = jsCompletionParams.getOrThrow("jsCompletionParams")
            ...
            fun <T> accept(visitor: Visitor<T>): T {
              return when {
                  ...
                  anthropicModelParams != null -> visitor.visitAnthropicModelParams(anthropicModelParams)
            ...
            companion object {
                ...
                fun ofOpenAIModelParams(openaiModelParams: OpenAIModelParams) = Params(openaiModelParams = openaiModelParams)

                fun ofAnthropicModelParams(anthropicModelParams: AnthropicModelParams) = Params(anthropicModelParams = anthropicModelParams)

                fun ofGoogleModelParams(googleModelParams: GoogleModelParams) = Params(googleModelParams = googleModelParams)

                fun ofWindowAiModelParams(windowAiModelParams: WindowAiModelParams) = Params(windowAiModelParams = windowAiModelParams)

                fun ofJsCompletionParams(jsCompletionParams: JsCompletionParams) = Params(jsCompletionParams = jsCompletionParams)
            }
            ...
            class Serializer : BaseSerializer<Params>(Params::class) {
                ...
                override fun serialize(value: Params, generator: JsonGenerator, provider: SerializerProvider) {
                  when {
                      value.openaiModelParams != null -> generator.writeObject(value.openaiModelParams)
                      value.anthropicModelParams != null -> generator.writeObject(value.anthropicModelParams)
                      value.googleModelParams != null -> generator.writeObject(value.googleModelParams)
                      value.windowAiModelParams != null -> generator.writeObject(value.windowAiModelParams)
                      value.jsCompletionParams != null -> generator.writeObject(value.jsCompletionParams)
            ...
            @NoAutoDetect
            class OpenAIModelParams private constructor(
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                class Builder {
                    ...
                    fun build(): OpenAIModelParams = OpenAIModelParams(
                        useCache,
                        temperature,
                        topP,
                        maxTokens,
                ...
                class FunctionCall private constructor(
                  ...
                  private val _json: JsonValue? = null,
                    ...
                    class None @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                ...
                class ToolChoice private constructor(
                  ...
                  private val _json: JsonValue? = null,
                    ...
                    @JsonDeserialize(builder = Function.Builder::class)
                    @NoAutoDetect
                    class Function private constructor(private val type: JsonField<Type>, private val function: JsonField<Function>, private val additionalProperties: Map<String, JsonValue>, ) {
                        ...
                        override fun toString() = "Function{type=$type, function=$function, additionalProperties=$additionalProperties}"
            ...
            @NoAutoDetect
            class AnthropicModelParams private constructor(
              private val useCache: JsonField<Boolean>,
              private val maxTokens: JsonField<Double>,
              private val temperature: JsonField<Double>,
              private val topP: JsonField<Double>,
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                fun maxTokensToSample(): Double? = maxTokensToSample.getNullable("max_tokens_to_sample")
                ...
                override fun toString() = "AnthropicModelParams{useCache=$useCache, maxTokens=$maxTokens, temperature=$temperature, topP=$topP, topK=$topK, stopSequences=$stopSequences, maxTokensToSample=$maxTokensToSample, additionalProperties=$additionalProperties}"
                ...
                class Builder {
                    ...
                    fun build(): AnthropicModelParams = AnthropicModelParams(
                        useCache,
                        maxTokens,
                        temperature,
                        topP,
            ...
            @NoAutoDetect
            class GoogleModelParams private constructor(
              private val useCache: JsonField<Boolean>,
              private val temperature: JsonField<Double>,
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                override fun toString() = "GoogleModelParams{useCache=$useCache, temperature=$temperature, maxOutputTokens=$maxOutputTokens, topP=$topP, topK=$topK, additionalProperties=$additionalProperties}"
                ...
                class Builder {
                    ...
                    fun build(): GoogleModelParams = GoogleModelParams(
                        useCache,
                        temperature,
                        maxOutputTokens,
                        topP,
            ...
            @NoAutoDetect
            class WindowAiModelParams private constructor(
              private val useCache: JsonField<Boolean>,
              private val temperature: JsonField<Double>,
              private val topK: JsonField<Double>,
              private val additionalProperties: Map<String, JsonValue>,
                ...
                override fun toString() = "WindowAiModelParams{useCache=$useCache, temperature=$temperature, topK=$topK, additionalProperties=$additionalProperties}"
                ...
                class Builder {
                    ...
                    fun build(): WindowAiModelParams = WindowAiModelParams(
                        useCache,
                        temperature,
                        topK,
                        additionalProperties.toUnmodifiable(),
            ...
            @NoAutoDetect
            class JsCompletionParams private constructor(private val useCache: JsonField<Boolean>, private val additionalProperties: Map<String, JsonValue>, ) {
    ...
    class Parser private constructor(
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        @ExcludeMissing
        fun _choiceScores() = choiceScores
        ...
        override fun toString() = "Parser{type=$type, useCot=$useCot, choiceScores=$choiceScores, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            @JsonProperty("use_cot")
            @ExcludeMissing
            fun useCot(useCot: JsonField<Boolean>) = apply {
                this.useCot = useCot
            }
        ...
        @NoAutoDetect
        class ChoiceScores private constructor(private val additionalProperties: Map<String, JsonValue>, ) {
    ...
    class Prompt private constructor(
      ...
      private val _json: JsonValue? = null,
        ...
        @NoAutoDetect
        class Completion private constructor(private val type: JsonField<Type>, private val content: JsonField<String>, private val additionalProperties: Map<String, JsonValue>, ) {
            ...
            override fun toString() = "Completion{type=$type, content=$content, additionalProperties=$additionalProperties}"
            ...
            class Builder {
                ...
                fun build(): Completion = Completion(
                    type,
                    content,
                    additionalProperties.toUnmodifiable(),
                )
        ...
        class Chat private constructor(
          ...
          private val additionalProperties: Map<String, JsonValue>,
            ...
            override fun toString() = "Chat{type=$type, messages=$messages, tools=$tools, additionalProperties=$additionalProperties}"
            ...
            class Message private constructor(
              ...
              private val _json: JsonValue? = null,
                ...
                fun validate(): Message = apply {
                    if (!validated) {
                      if (system == null && user == null && assistant == null && tool == null && function == null && fallback == null) {
                ...
                class System private constructor(
                  ...
                  private val additionalProperties: Map<String, JsonValue>,
                    ...
                    override fun toString() = "System{content=$content, role=$role, name=$name, additionalProperties=$additionalProperties}"
                ...
                class User private constructor(
                  ...
                  private val additionalProperties: Map<String, JsonValue>,
                    ...
                    override fun toString() = "User{content=$content, role=$role, name=$name, additionalProperties=$additionalProperties}"
                    ...
                    class Content private constructor(private val string: String? = null, private val unnamedSchemaWithArrayParent2s: List<UnnamedSchemaWithArrayParent2>? = null, private val _json: JsonValue? = null, ) {

                        private var validated: Boolean = false

                        fun string(): String? = string
                        fun unnamedSchemaWithArrayParent2s(): List<UnnamedSchemaWithArrayParent2>? = unnamedSchemaWithArrayParent2s

                        fun isString(): Boolean = string != null
                        fun isUnnamedSchemaWithArrayParent2s(): Boolean = unnamedSchemaWithArrayParent2s != null

                        fun asString(): String = string.getOrThrow("string")
                        fun asUnnamedSchemaWithArrayParent2s(): List<UnnamedSchemaWithArrayParent2> = unnamedSchemaWithArrayParent2s.getOrThrow("unnamedSchemaWithArrayParent2s")
                        ...
                        fun <T> accept(visitor: Visitor<T>): T {
                          return when {
                              ...
                              unnamedSchemaWithArrayParent2s != null -> visitor.visitUnnamedSchemaWithArrayParent2s(unnamedSchemaWithArrayParent2s)
                              else -> visitor.unknown(_json)
                          }
                        }
                        ...
                        override fun equals(other: Any?): Boolean {
                          ...
                          return other is Content &&
                              ...
                              this.unnamedSchemaWithArrayParent2s == other.unnamedSchemaWithArrayParent2s
                        }
                        ...
                        override fun toString(): String {
                          return when {
                              ...
                              unnamedSchemaWithArrayParent2s != null -> "Content{unnamedSchemaWithArrayParent2s=$unnamedSchemaWithArrayParent2s}"
                        ...
                        companion object {
                            ...
                            fun ofUnnamedSchemaWithArrayParent2s(unnamedSchemaWithArrayParent2s: List<UnnamedSchemaWithArrayParent2>) = Content(unnamedSchemaWithArrayParent2s = unnamedSchemaWithArrayParent2s)
                        }
                        ...
                        interface Visitor<out T> {
                            ...
                            fun visitUnnamedSchemaWithArrayParent2s(unnamedSchemaWithArrayParent2s: List<UnnamedSchemaWithArrayParent2>): T
                        ...
                        class Deserializer : BaseDeserializer<Content>(Content::class) {
                            ...
                            override fun ObjectCodec.deserialize(node: JsonNode): Content {
                              ...
                              tryDeserialize(node, jacksonTypeRef<List<UnnamedSchemaWithArrayParent2>>())?.let {
                                  return Content(unnamedSchemaWithArrayParent2s = it, _json = json)
                              }
                        ...
                        class Serializer : BaseSerializer<Content>(Content::class) {
                            ...
                            override fun serialize(value: Content, generator: JsonGenerator, provider: SerializerProvider) {
                              when {
                                  ...
                                  value.unnamedSchemaWithArrayParent2s != null -> generator.writeObject(value.unnamedSchemaWithArrayParent2s)
                                  value._json != null -> generator.writeObject(value._json)
                                  else -> throw IllegalStateException("Invalid Content")
                              }
                            }
                        ...
                        class UnnamedSchemaWithArrayParent2 private constructor(private val text: Text? = null, private val imageUrl: ImageUrl? = null, private val _json: JsonValue? = null, ) {
                            ...
                            fun validate(): UnnamedSchemaWithArrayParent2 = apply {
                                if (!validated) {
                                  if (text == null && imageUrl == null) {
                                    throw BraintrustInvalidDataException("Unknown UnnamedSchemaWithArrayParent2: $_json")
                                  }
                                  text?.validate()
                                  imageUrl?.validate()
                                  validated = true
                            ...
                            companion object {
                                ...
                                fun ofImageUrl(imageUrl: ImageUrl) = UnnamedSchemaWithArrayParent2(imageUrl = imageUrl)
                            }
                            ...
                            interface Visitor<out T> {
                                ...
                                fun unknown(json: JsonValue?): T {
                                  throw BraintrustInvalidDataException("Unknown UnnamedSchemaWithArrayParent2: $json")
                                }
                            }

                            class Deserializer : BaseDeserializer<UnnamedSchemaWithArrayParent2>(UnnamedSchemaWithArrayParent2::class) {

                                override fun ObjectCodec.deserialize(node: JsonNode): UnnamedSchemaWithArrayParent2 {
                                  val json = JsonValue.fromJsonNode(node)
                                  tryDeserialize(node, jacksonTypeRef<Text>()){ it.validate() }?.let {
                                      return UnnamedSchemaWithArrayParent2(text = it, _json = json)
                                  }
                                  tryDeserialize(node, jacksonTypeRef<ImageUrl>()){ it.validate() }?.let {
                                      return UnnamedSchemaWithArrayParent2(imageUrl = it, _json = json)
                                  }
                            ...
                            class Serializer : BaseSerializer<UnnamedSchemaWithArrayParent2>(UnnamedSchemaWithArrayParent2::class) {

                                override fun serialize(value: UnnamedSchemaWithArrayParent2, generator: JsonGenerator, provider: SerializerProvider) {
                                  when {
                            ...
                            @NoAutoDetect
                            class Text private constructor(private val text: JsonField<String>, private val type: JsonField<Type>, private val additionalProperties: Map<String, JsonValue>, ) {
                                ...
                                override fun toString() = "Text{text=$text, type=$type, additionalProperties=$additionalProperties}"
                            ...
                            @NoAutoDetect
                            class ImageUrl private constructor(private val imageUrl: JsonField<ImageUrl>, private val type: JsonField<Type>, private val additionalProperties: Map<String, JsonValue>, ) {
                                ...
                                override fun toString() = "ImageUrl{imageUrl=$imageUrl, type=$type, additionalProperties=$additionalProperties}"
                ...
                class Tool private constructor(
                  ...
                  private val additionalProperties: Map<String, JsonValue>,
                    ...
                    override fun toString() = "Tool{content=$content, role=$role, toolCallId=$toolCallId, additionalProperties=$additionalProperties}"
                ...
                class Function private constructor(
                  ...
                  private val additionalProperties: Map<String, JsonValue>,
                    ...
                    override fun toString() = "Function{content=$content, name=$name, role=$role, additionalProperties=$additionalProperties}"
                ...
                @NoAutoDetect
                class Fallback private constructor(private val role: JsonField<Role>, private val content: JsonField<String>, private val additionalProperties: Map<String, JsonValue>, ) {
