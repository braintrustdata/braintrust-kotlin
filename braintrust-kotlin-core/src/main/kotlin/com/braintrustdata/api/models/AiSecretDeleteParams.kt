...
class AiSecretDeleteParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(aiSecretDeleteParams: AiSecretDeleteParams) =
            apply {
                aiSecretId = aiSecretDeleteParams.aiSecretId
                additionalHeaders = aiSecretDeleteParams.additionalHeaders.toBuilder()
                additionalQueryParams = aiSecretDeleteParams.additionalQueryParams.toBuilder()
                additionalBodyProperties = aiSecretDeleteParams.additionalBodyProperties.toMutableMap()
            }

        /** AiSecret id */
        fun aiSecretId(aiSecretId: String) =
            apply {
                this.aiSecretId = aiSecretId
            }
    ...
    override fun toString() = "AiSecretDeleteParams{aiSecretId=$aiSecretId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
