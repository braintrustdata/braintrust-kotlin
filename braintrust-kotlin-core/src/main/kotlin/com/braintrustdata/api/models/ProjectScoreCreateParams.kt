 ...
 */
class ProjectScoreCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(projectScoreCreateParams: ProjectScoreCreateParams) =
            apply {
    ...
    override fun toString() = "ProjectScoreCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
