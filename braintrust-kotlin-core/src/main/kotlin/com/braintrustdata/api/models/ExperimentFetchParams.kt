 ...
 */
class ExperimentFetchParams private constructor(
    ...
    override fun _queryParams(): QueryParams {
      ...
      this.maxRootSpanId?.let {
          queryParams.put(
            "max_root_span_id", listOf(it.toString())
          )
      }
      this.maxXactId?.let {
          queryParams.put(
            "max_xact_id", listOf(it.toString())
          )
      }
      this.version?.let {
          queryParams.put(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(experimentFetchParams: ExperimentFetchParams) =
            apply {
    ...
    override fun toString() = "ExperimentFetchParams{experimentId=$experimentId, limit=$limit, maxRootSpanId=$maxRootSpanId, maxXactId=$maxXactId, version=$version, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
