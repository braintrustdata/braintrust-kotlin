...
constructor(
    ...
    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(experimentId, limit, maxRootSpanId, maxXactId, version, additionalQueryParams, additionalHeaders) /* spotless:on */
    }

    override fun toString() =
        "ExperimentFetchParams{experimentId=$experimentId, limit=$limit, maxRootSpanId=$maxRootSpanId, maxXactId=$maxXactId, version=$version, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
