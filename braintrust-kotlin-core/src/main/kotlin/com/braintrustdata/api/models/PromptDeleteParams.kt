...
class PromptDeleteParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(promptDeleteParams: PromptDeleteParams) =
            apply {
                promptId = promptDeleteParams.promptId
                additionalHeaders = promptDeleteParams.additionalHeaders.toBuilder()
                additionalQueryParams = promptDeleteParams.additionalQueryParams.toBuilder()
                additionalBodyProperties = promptDeleteParams.additionalBodyProperties.toMutableMap()
            }

        /** Prompt id */
        fun promptId(promptId: String) =
            apply {
    ...
    override fun toString() = "PromptDeleteParams{promptId=$promptId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
