 ...
 */
class SpanIframeListParams private constructor(
    private val endingBefore: String?,
    private val ids: Ids?,
    private val limit: Long?,
    private val orgName: String?,
    private val spanIframeName: String?,
    ...
    fun spanIframeName(): String? = spanIframeName
    ...
    override fun _queryParams(): QueryParams {
      ...
      this.spanIframeName?.let {
          queryParams.put(
            "span_iframe_name", listOf(it.toString())
          )
      }
    ...
    /** A builder for [SpanIframeListParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        private var spanIframeName: String? = null
        private var startingAfter: String? = null
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        internal fun from(spanIframeListParams: SpanIframeListParams) =
            apply {
        ...
        /** Name of the span_iframe to search for */
        fun spanIframeName(spanIframeName: String?) =
            apply {
                this.spanIframeName = spanIframeName
            }
    ...
    override fun toString() = "SpanIframeListParams{endingBefore=$endingBefore, ids=$ids, limit=$limit, orgName=$orgName, spanIframeName=$spanIframeName, startingAfter=$startingAfter, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
