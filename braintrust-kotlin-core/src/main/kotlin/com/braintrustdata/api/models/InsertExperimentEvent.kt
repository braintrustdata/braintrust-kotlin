...
/** An experiment event */
@NoAutoDetect
class InsertExperimentEvent @JsonCreator private constructor(
     ...
     * If the row is being merged into an existing row, this field will be ignored.
     */
    fun rootSpanId(): String? = rootSpanId.getNullable("root_span_id")
    ...
    fun validate(): InsertExperimentEvent =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(insertExperimentEvent: InsertExperimentEvent) =
            apply {
                ...
                datasetRecordId = insertExperimentEvent.datasetRecordId
