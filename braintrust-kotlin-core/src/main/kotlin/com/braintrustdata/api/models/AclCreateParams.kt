 ...
 */
class AclCreateParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        override fun toString() = "Body{objectId=$objectId, objectType=$objectType, groupId=$groupId, permission=$permission, restrictObjectType=$restrictObjectType, roleId=$roleId, userId=$userId, additionalProperties=$additionalProperties}"
    }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AclCreateParams].
         *
         * The following fields are required:
         *
         * ```kotlin
    ...
    class Builder internal constructor() {
        ...
        internal fun from(aclCreateParams: AclCreateParams) =
            apply {
    ...
    override fun toString() = "AclCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
