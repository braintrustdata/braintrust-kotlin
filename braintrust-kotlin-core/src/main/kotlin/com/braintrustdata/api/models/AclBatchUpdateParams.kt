...
private constructor(
    ...
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            addAcls: JsonField<List<AddAcl>> = JsonMissing.of(),
            @JsonProperty("remove_acls")
            @ExcludeMissing
            removeAcls: JsonField<List<RemoveAcl>> = JsonMissing.of(),
        ) : this(addAcls, removeAcls, mutableMapOf())
        ...
        internal fun validity(): Int =
            (addAcls.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
                (removeAcls.asKnown()?.sumOf { it.validity().toInt() } ?: 0)
