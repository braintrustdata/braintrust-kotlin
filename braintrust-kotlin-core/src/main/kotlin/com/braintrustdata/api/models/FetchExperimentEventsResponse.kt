...
@NoAutoDetect
class FetchExperimentEventsResponse private constructor(private val events: JsonField<List<ExperimentEvent>>, private val cursor: JsonField<String>, private val additionalProperties: Map<String, JsonValue>, ) {
    ...
    class Builder {
        ...
        fun build(): FetchExperimentEventsResponse = FetchExperimentEventsResponse(
