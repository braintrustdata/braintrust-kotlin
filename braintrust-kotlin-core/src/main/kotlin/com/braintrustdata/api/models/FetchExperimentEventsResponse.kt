...
@NoAutoDetect
class FetchExperimentEventsResponse @JsonCreator private constructor(
    @JsonProperty("events") @ExcludeMissing private val events: JsonField<List<ExperimentEvent>> = JsonMissing.of(),
    ...
    @JsonProperty("events")
    @ExcludeMissing
    fun _events(): JsonField<List<ExperimentEvent>> = events
    ...
    fun validate(): FetchExperimentEventsResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(fetchExperimentEventsResponse: FetchExperimentEventsResponse) =
            apply {
        ...
        /** A list of fetched events */
        fun events(events: JsonField<List<ExperimentEvent>>) =
            apply {
                this.events = events.map { it.toMutableList() }
            }

        /** A list of fetched events */
        fun addEvent(event: ExperimentEvent) =
            apply {
    ...
    override fun toString() = "FetchExperimentEventsResponse{events=$events, cursor=$cursor, additionalProperties=$additionalProperties}"
}
