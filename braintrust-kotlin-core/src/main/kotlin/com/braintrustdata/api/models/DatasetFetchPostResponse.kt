...
@NoAutoDetect
class DatasetFetchPostResponse private constructor(private val events: JsonField<List<Event>>, private val cursor: JsonField<String>, private val additionalProperties: Map<String, JsonValue>, ) {
    ...
    override fun toString() = "DatasetFetchPostResponse{events=$events, cursor=$cursor, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        fun build(): DatasetFetchPostResponse = DatasetFetchPostResponse(
    ...
    class Event private constructor(
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        override fun toString() = "Event{id=$id, _xactId=$_xactId, created=$created, projectId=$projectId, datasetId=$datasetId, input=$input, expected=$expected, metadata=$metadata, tags=$tags, spanId=$spanId, rootSpanId=$rootSpanId, additionalProperties=$additionalProperties}"
