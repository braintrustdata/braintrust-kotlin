...
@NoAutoDetect
class FeedbackResponseSchema @JsonCreator private constructor(
    ...
    fun validate(): FeedbackResponseSchema =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(feedbackResponseSchema: FeedbackResponseSchema) =
            apply {
