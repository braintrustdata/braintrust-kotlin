...
private constructor(
    ...
    private constructor(
        ...
        @ExcludeMissing
        objects: JsonField<List<AISecret>> = JsonMissing.of()
     ...
     */
    fun objects(): List<AISecret> = objects.getRequired("objects")
     ...
     */
    @JsonProperty("objects") @ExcludeMissing fun _objects(): JsonField<List<AISecret>> = objects
    ...
    /** A builder for [AiSecretListPageResponse]. */
    class Builder internal constructor() {

        private var objects: JsonField<MutableList<AISecret>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(aiSecretListPageResponse: AiSecretListPageResponse) = apply {
            objects = aiSecretListPageResponse.objects.map { it.toMutableList() }
            additionalProperties = aiSecretListPageResponse.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.objects] with a well-typed `List<AISecret>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun objects(objects: JsonField<List<AISecret>>) = apply {
            this.objects = objects.map { it.toMutableList() }
        }

        /**
         * Adds a single [AISecret] to [objects].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addObject(object_: AISecret) = apply {
            objects =
         ...
         */
        fun build(): AiSecretListPageResponse =
    ...
    fun validate(): AiSecretListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "AiSecretListPageResponse{objects=$objects, additionalProperties=$additionalProperties}"
}
