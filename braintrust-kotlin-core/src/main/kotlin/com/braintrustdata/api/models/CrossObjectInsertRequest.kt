...
@JsonDeserialize(builder = CrossObjectInsertRequest.Builder::class)
@NoAutoDetect
class CrossObjectInsertRequest
private constructor(
    ...
    fun validate(): CrossObjectInsertRequest = apply {
        if (!validated) {
            experiment()?.validate()
            dataset()?.validate()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CrossObjectInsertRequest &&
    ...
    override fun toString() =
        "CrossObjectInsertRequest{experiment=$experiment, dataset=$dataset, projectLogs=$projectLogs, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(crossObjectInsertRequest: CrossObjectInsertRequest) = apply {
            this.experiment = crossObjectInsertRequest.experiment
            this.dataset = crossObjectInsertRequest.dataset
            this.projectLogs = crossObjectInsertRequest.projectLogs
            additionalProperties(crossObjectInsertRequest.additionalProperties)
        }
        ...
        fun build(): CrossObjectInsertRequest =
