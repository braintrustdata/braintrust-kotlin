...
@JsonDeserialize(builder = ProjectLogFetchPostResponse.Builder::class)
@NoAutoDetect
class ProjectLogFetchPostResponse private constructor(private val events: JsonField<List<Event>>, private val cursor: JsonField<String>, private val additionalProperties: Map<String, JsonValue>, ) {
    ...
    override fun toString() = "ProjectLogFetchPostResponse{events=$events, cursor=$cursor, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        fun build(): ProjectLogFetchPostResponse = ProjectLogFetchPostResponse(
