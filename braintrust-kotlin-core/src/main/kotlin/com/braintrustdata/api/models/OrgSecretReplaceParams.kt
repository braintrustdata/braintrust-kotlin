...
class OrgSecretReplaceParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    @NoAutoDetect
    class OrgSecretReplaceBody internal constructor(
      private val name: String?,
      private val metadata: Metadata?,
      private val orgName: String?,
      private val secret: String?,
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        override fun toString() = "OrgSecretReplaceBody{name=$name, metadata=$metadata, orgName=$orgName, secret=$secret, type=$type, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            fun build(): OrgSecretReplaceBody = OrgSecretReplaceBody(
                checkNotNull(name) {
    ...
    override fun toString() = "OrgSecretReplaceParams{name=$name, metadata=$metadata, orgName=$orgName, secret=$secret, type=$type, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        fun build(): OrgSecretReplaceParams = OrgSecretReplaceParams(
            checkNotNull(name) {
                "`name` is required but was not set"
            },
            metadata,
