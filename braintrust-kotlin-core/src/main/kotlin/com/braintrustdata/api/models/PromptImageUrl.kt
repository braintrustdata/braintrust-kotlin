...
@JsonDeserialize(builder = PromptImageUrl.Builder::class)
@NoAutoDetect
class PromptImageUrl
private constructor(
    ...
    fun validate(): PromptImageUrl = apply {
        if (!validated) {
            url()
            detail()
            validated = true
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PromptImageUrl &&
            this.url == other.url &&
    ...
    override fun toString() =
        "PromptImageUrl{url=$url, detail=$detail, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(promptImageUrl: PromptImageUrl) = apply {
            this.url = promptImageUrl.url
            this.detail = promptImageUrl.detail
            additionalProperties(promptImageUrl.additionalProperties)
        }
