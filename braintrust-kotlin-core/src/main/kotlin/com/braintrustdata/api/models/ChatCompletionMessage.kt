...
private constructor(
    ...
    companion object {
        ...
        fun ofSystem(system: System) = ChatCompletionMessage(system = system)

        fun ofUser(user: User) = ChatCompletionMessage(user = user)

        fun ofAssistant(assistant: Assistant) = ChatCompletionMessage(assistant = assistant)

        fun ofTool(tool: Tool) = ChatCompletionMessage(tool = tool)

        fun ofFunction(function: Function) = ChatCompletionMessage(function = function)

        fun ofFallback(fallback: Fallback) = ChatCompletionMessage(fallback = fallback)
    }
    ...
    private constructor(
        ...
        fun content(): ChatCompletionContent? = content.getNullable("content")
