 ...
 */
class GroupListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(groupListParams: GroupListParams) =
            apply {
    ...
    override fun toString() = "GroupListParams{endingBefore=$endingBefore, groupName=$groupName, ids=$ids, limit=$limit, orgName=$orgName, startingAfter=$startingAfter, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
