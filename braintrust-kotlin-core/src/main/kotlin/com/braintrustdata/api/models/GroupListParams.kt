...
class GroupListParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    internal fun getQueryParams(): Map<String, List<String>> {
      ...
      this.groupName?.let {
          params.put("group_name", listOf(it.toString()))
      }
      this.ids?.let {
    ...
    override fun toString() = "GroupListParams{endingBefore=$endingBefore, groupName=$groupName, ids=$ids, limit=$limit, orgName=$orgName, startingAfter=$startingAfter, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(groupListParams: GroupListParams) = apply {
            ...
            additionalBodyProperties(groupListParams.additionalBodyProperties)
        }
        ...
        fun build(): GroupListParams = GroupListParams(
            endingBefore,
            groupName,
            ids,
            limit,
