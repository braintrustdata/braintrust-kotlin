...
class ExperimentSummarizeParams private constructor(
    ...
    override fun _queryParams(): QueryParams {
      ...
      this.comparisonExperimentId?.let {
          queryParams.put(
            "comparison_experiment_id", listOf(it.toString())
          )
      }
      this.summarizeScores?.let {
          queryParams.put(
            "summarize_scores", listOf(it.toString())
          )
      }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(experimentSummarizeParams: ExperimentSummarizeParams) =
            apply {
         ...
         * `summarize_scores=true` for this id to be used
         */
        fun comparisonExperimentId(comparisonExperimentId: String?) =
            apply {
         ...
         * metadata will be returned.
         */
        fun summarizeScores(summarizeScores: Boolean?) =
            apply {
    ...
    override fun toString() = "ExperimentSummarizeParams{experimentId=$experimentId, comparisonExperimentId=$comparisonExperimentId, summarizeScores=$summarizeScores, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
