...
class GroupListPage private constructor(private val groupService: GroupService, private val params: GroupListParams, private val response: Response, ) {
    ...
    class Response constructor(private val objects: JsonField<List<Group>>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "GroupListPage.Response{objects=$objects, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: GroupListPage, ) : Sequence<Group> {
