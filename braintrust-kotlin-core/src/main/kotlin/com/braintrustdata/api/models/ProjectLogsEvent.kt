...
@NoAutoDetect
class ProjectLogsEvent @JsonCreator private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(projectLogsEvent: ProjectLogsEvent) =
            apply {
