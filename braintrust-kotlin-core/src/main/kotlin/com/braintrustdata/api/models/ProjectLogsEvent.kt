...
@NoAutoDetect
class ProjectLogsEvent private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    class Builder {
        ...
        fun build(): ProjectLogsEvent = ProjectLogsEvent(
            id,
            _xactId,
            created,
            orgId,
