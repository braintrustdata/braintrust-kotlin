...
class ExperimentFeedbackParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        @JsonProperty("feedback") @ExcludeMissing private val feedback: JsonField<List<FeedbackExperimentItem>> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
            ...
            /** A list of experiment feedback items */
            fun feedback(feedback: JsonField<List<FeedbackExperimentItem>>) =
                apply {
                    this.feedback = feedback.map { it.toMutableList() }
                }

            /** A list of experiment feedback items */
            fun addFeedback(feedback: FeedbackExperimentItem) =
                apply {
                    this.feedback = (this.feedback ?: JsonField.of(mutableListOf())).also {
        ...
        override fun toString() = "Body{feedback=$feedback, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(experimentFeedbackParams: ExperimentFeedbackParams) =
            apply {
        ...
        /** A list of experiment feedback items */
        fun feedback(feedback: List<FeedbackExperimentItem>) =
            apply {
    ...
    override fun toString() = "ExperimentFeedbackParams{experimentId=$experimentId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
