...
@NoAutoDetect
class FetchDatasetEventsResponse @JsonCreator private constructor(
    @JsonProperty("events") @ExcludeMissing private val events: JsonField<List<DatasetEvent>> = JsonMissing.of(),
    ...
    @JsonProperty("events")
    @ExcludeMissing
    fun _events(): JsonField<List<DatasetEvent>> = events
    ...
    class Builder internal constructor() {
        ...
        internal fun from(fetchDatasetEventsResponse: FetchDatasetEventsResponse) =
            apply {
        ...
        /** A list of fetched events */
        fun events(events: JsonField<List<DatasetEvent>>) =
            apply {
                this.events = events.map { it.toMutableList() }
            }

        /** A list of fetched events */
        fun addEvent(event: DatasetEvent) =
            apply {
