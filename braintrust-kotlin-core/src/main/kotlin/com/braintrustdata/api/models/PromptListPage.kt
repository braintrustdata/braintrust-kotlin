...
class PromptListPage private constructor(private val promptsService: PromptService, private val params: PromptListParams, private val response: Response, ) {
    ...
    class Response constructor(private val objects: JsonField<List<Prompt>>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        fun _objects(): JsonField<List<Prompt>>? = objects
        ...
        override fun toString() = "PromptListPage.Response{objects=$objects, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: PromptListPage, ) : Sequence<Prompt> {
