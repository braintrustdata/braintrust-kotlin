...
constructor(
    ...
    private val messages: List<ChatCompletionMessage>?,
    ...
    fun messages(): List<ChatCompletionMessage>? = messages
    ...
    internal constructor(
        ...
        @JsonProperty("messages") fun messages(): List<ChatCompletionMessage>? = messages
        ...
        class Builder {
            ...
            private var messages: List<ChatCompletionMessage>? = null
            ...
            fun messages(messages: List<ChatCompletionMessage>) = apply { this.messages = messages }
    ...
    class Builder {
        ...
        private var input: JsonValue? = null
        private var messages: MutableList<ChatCompletionMessage> = mutableListOf()
        private var mode: Mode? = null
        private var parent: Parent? = null
        private var stream: Boolean? = null
        private var version: String? = null
        ...
        /** If the function is an LLM, additional messages to pass along to it */
        fun messages(messages: List<ChatCompletionMessage>) = apply {
            this.messages.clear()
            this.messages.addAll(messages)
        }

        /** If the function is an LLM, additional messages to pass along to it */
        fun addMessage(message: ChatCompletionMessage) = apply { this.messages.add(message) }
