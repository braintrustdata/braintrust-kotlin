...
/** Invoke a function. */
class FunctionInvokeParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        class Builder internal constructor() {
            ...
            fun parent(spanParentStruct: Parent.SpanParentStruct) = parent(Parent.ofSpanParentStruct(spanParentStruct))
        ...
        override fun toString() = "Body{input=$input, messages=$messages, mode=$mode, parent=$parent, stream=$stream, version=$version, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(functionInvokeParams: FunctionInvokeParams) =
            apply {
        ...
        /** If the function is an LLM, additional messages to pass along to it */
        fun addMessage(system: Message.System) =
            apply {
                body.addMessage(system)
            }

        /** If the function is an LLM, additional messages to pass along to it */
        fun addMessage(user: Message.User) =
            apply {
                body.addMessage(user)
            }
        ...
        /** If the function is an LLM, additional messages to pass along to it */
        fun addMessage(tool: Message.Tool) =
            apply {
                body.addMessage(tool)
            }
    ...
    class Message private constructor(
        ...
        class User @JsonCreator private constructor(
            ...
            class Content private constructor(
                ...
                class ChatCompletionContentPart private constructor(
                    ...
                    fun text(): ChatCompletionContentPartText? = text

                    fun image(): ChatCompletionContentPartImage? = image
        ...
        class Assistant @JsonCreator private constructor(
            ...
            fun toolCalls(): List<ChatCompletionMessageToolCall>? = toolCalls.getNullable("tool_calls")
    ...
    class Parent private constructor(
        ...
        companion object {
            ...
            /** Span parent properties */
            fun ofSpanParentStruct(spanParentStruct: SpanParentStruct) = Parent(spanParentStruct = spanParentStruct)
        ...
        /**
         * An interface that defines how to map each variant of [Parent] to a value of type
         * [T].
         */
        interface Visitor<out T> {
             ...
             *
             * An instance of [Parent] can contain an unknown variant if it was deserialized
             * from data that doesn't match any known variant. For example, if the SDK is on an
             * older version than the API, then the API may respond with new variants that the
             * SDK is unaware of.
             *
        ...
        internal class Deserializer : BaseDeserializer<Parent>(Parent::class) {
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): Parent {
              ...
              tryDeserialize(node, jacksonTypeRef<SpanParentStruct>()){ it.validate() }?.let {
        ...
        internal class Serializer : BaseSerializer<Parent>(Parent::class) {
            ...
            override fun serialize(value: Parent, generator: JsonGenerator, provider: SerializerProvider) {
              when {
        ...
        /** Span parent properties */
        @NoAutoDetect
        class SpanParentStruct @JsonCreator private constructor(
            ...
            @JsonProperty("propagated_event") @ExcludeMissing private val propagatedEvent: JsonField<PropagatedEvent> = JsonMissing.of(),
            @JsonProperty("row_ids") @ExcludeMissing private val rowIds: JsonField<RowIds> = JsonMissing.of(),
            @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
            ...
            fun propagatedEvent(): PropagatedEvent? = propagatedEvent.getNullable("propagated_event")
            ...
            @ExcludeMissing
            fun _rowIds(): JsonField<RowIds> = rowIds
            ...
            class Builder internal constructor() {
                ...
                internal fun from(spanParentStruct: SpanParentStruct) =
                    apply {
                ...
                /** Include these properties in every span created under this parent */
                fun propagatedEvent(propagatedEvent: PropagatedEvent?) = propagatedEvent(JsonField.ofNullable(propagatedEvent))

                /** Include these properties in every span created under this parent */
                fun propagatedEvent(propagatedEvent: JsonField<PropagatedEvent>) =
                    apply {
                ...
                /** Identifiers for the row to to log a subspan under */
                fun rowIds(rowIds: JsonField<RowIds>) =
                    apply {
                        this.rowIds = rowIds
                    }
            ...
            /** Include these properties in every span created under this parent */
            @NoAutoDetect
            class PropagatedEvent @JsonCreator private constructor(
                @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(propagatedEvent: PropagatedEvent) =
                        apply {
                    ...
                    fun build(): PropagatedEvent = PropagatedEvent(additionalProperties.toImmutable())
                }
                ...
                override fun toString() = "PropagatedEvent{additionalProperties=$additionalProperties}"
            }

            /** Identifiers for the row to to log a subspan under */
            @NoAutoDetect
            class RowIds @JsonCreator private constructor(
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(rowIds: RowIds) =
                        apply {
                            id = rowIds.id
                ...
                override fun toString() = "RowIds{id=$id, rootSpanId=$rootSpanId, spanId=$spanId, additionalProperties=$additionalProperties}"
            }
            ...
            override fun toString() = "SpanParentStruct{objectId=$objectId, objectType=$objectType, propagatedEvent=$propagatedEvent, rowIds=$rowIds, additionalProperties=$additionalProperties}"
        }
    }
    ...
    override fun toString() = "FunctionInvokeParams{functionId=$functionId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
