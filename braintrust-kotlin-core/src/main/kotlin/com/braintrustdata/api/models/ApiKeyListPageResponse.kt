...
private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("objects") @ExcludeMissing objects: JsonField<List<ApiKey>> = JsonMissing.of()
     ...
     */
    fun objects(): List<ApiKey> = objects.getRequired("objects")
     ...
     */
    @JsonProperty("objects") @ExcludeMissing fun _objects(): JsonField<List<ApiKey>> = objects
    ...
    class Builder internal constructor() {
        ...
        private var objects: JsonField<MutableList<ApiKey>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(apiKeyListPageResponse: ApiKeyListPageResponse) = apply {
            objects = apiKeyListPageResponse.objects.map { it.toMutableList() }
         ...
         *
         * You should usually call [Builder.objects] with a well-typed `List<ApiKey>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun objects(objects: JsonField<List<ApiKey>>) = apply {
            this.objects = objects.map { it.toMutableList() }
        }

        /**
         * Adds a single [ApiKey] to [objects].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addObject(object_: ApiKey) = apply {
            objects =
    ...
    override fun toString() =
        "ApiKeyListPageResponse{objects=$objects, additionalProperties=$additionalProperties}"
}
