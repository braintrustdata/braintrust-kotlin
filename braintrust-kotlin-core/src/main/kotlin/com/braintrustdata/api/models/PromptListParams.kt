...
class PromptListParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    fun promptName(): String? = promptName
    ...
    internal fun getQueryParams(): Map<String, List<String>> {
      ...
      this.promptName?.let {
          params.put("prompt_name", listOf(it.toString()))
      }
      this.slug?.let {
          params.put("slug", listOf(it.toString()))
      }
    ...
    override fun toString() = "PromptListParams{endingBefore=$endingBefore, ids=$ids, limit=$limit, orgName=$orgName, projectName=$projectName, promptName=$promptName, slug=$slug, startingAfter=$startingAfter, version=$version, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        fun promptName(promptName: String) = apply {
        ...
        fun build(): PromptListParams = PromptListParams(
            endingBefore,
            ids,
            limit,
            orgName,
