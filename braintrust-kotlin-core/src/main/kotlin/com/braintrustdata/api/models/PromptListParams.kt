 ...
 */
class PromptListParams private constructor(
    ...
    override fun _queryParams(): QueryParams {
      ...
      this.promptName?.let {
          queryParams.put(
            "prompt_name", listOf(it.toString())
          )
      }
      this.slug?.let {
          queryParams.put(
            "slug", listOf(it.toString())
          )
      }
    ...
    /** A builder for [PromptListParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        internal fun from(promptListParams: PromptListParams) =
            apply {
        ...
        /** Name of the prompt to search for */
        fun promptName(promptName: String?) =
            apply {
    ...
    override fun toString() = "PromptListParams{endingBefore=$endingBefore, ids=$ids, limit=$limit, orgName=$orgName, projectId=$projectId, projectName=$projectName, promptName=$promptName, slug=$slug, startingAfter=$startingAfter, version=$version, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
