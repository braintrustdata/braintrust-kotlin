...
@NoAutoDetect
class CreateApiKeyOutput private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "CreateApiKeyOutput{id=$id, created=$created, name=$name, previewName=$previewName, userId=$userId, orgId=$orgId, key=$key, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        fun build(): CreateApiKeyOutput = CreateApiKeyOutput(
            id,
            created,
            name,
            previewName,
