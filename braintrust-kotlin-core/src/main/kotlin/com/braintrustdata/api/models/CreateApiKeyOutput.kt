...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CreateApiKeyOutput && id == other.id && created == other.created && name == other.name && previewName == other.previewName && userId == other.userId && orgId == other.orgId && key == other.key && additionalProperties == other.additionalProperties /* spotless:on */
    }

    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(id, created, name, previewName, userId, orgId, key, additionalProperties) }
    /* spotless:on */
