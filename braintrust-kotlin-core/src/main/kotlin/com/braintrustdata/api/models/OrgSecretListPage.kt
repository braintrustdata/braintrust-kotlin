...
class OrgSecretListPage private constructor(private val orgSecretService: OrgSecretService, private val params: OrgSecretListParams, private val response: Response, ) {
    ...
    fun getNextPage(): OrgSecretListPage? {
    ...
    companion object {
        ...
        fun of(orgSecretService: OrgSecretService, params: OrgSecretListParams, response: Response) = OrgSecretListPage(
            orgSecretService,
            params,
            response,
        )
    ...
    class Response constructor(private val objects: JsonField<List<OrgSecret>>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "OrgSecretListPage.Response{objects=$objects, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: OrgSecretListPage, ) : Sequence<OrgSecret> {
