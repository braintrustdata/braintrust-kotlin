...
class ExperimentInsertParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        @JsonProperty("events") @ExcludeMissing private val events: JsonField<List<InsertExperimentEvent>> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
            ...
            /** A list of experiment events to insert */
            fun events(events: JsonField<List<InsertExperimentEvent>>) =
                apply {
                    this.events = events.map { it.toMutableList() }
                }

            /** A list of experiment events to insert */
            fun addEvent(event: InsertExperimentEvent) =
                apply {
    ...
    class Builder internal constructor() {
        ...
        internal fun from(experimentInsertParams: ExperimentInsertParams) =
            apply {
        ...
        /** A list of experiment events to insert */
        fun events(events: List<InsertExperimentEvent>) =
            apply {
                body.events(events)
            }
    ...
    override fun toString() = "ExperimentInsertParams{experimentId=$experimentId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
