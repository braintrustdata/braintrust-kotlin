...
@NoAutoDetect
class Organization @JsonCreator private constructor(
    ...
    override fun toString() = "Organization{id=$id, name=$name, apiUrl=$apiUrl, created=$created, isUniversalApi=$isUniversalApi, proxyUrl=$proxyUrl, realtimeUrl=$realtimeUrl, additionalProperties=$additionalProperties}"
}
