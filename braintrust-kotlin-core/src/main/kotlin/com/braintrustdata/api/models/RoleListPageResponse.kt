...
private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("objects") @ExcludeMissing objects: JsonField<List<Role>> = JsonMissing.of()
     ...
     */
    fun objects(): List<Role> = objects.getRequired("objects")
     ...
     */
    @JsonProperty("objects") @ExcludeMissing fun _objects(): JsonField<List<Role>> = objects
    ...
    class Builder internal constructor() {
        ...
        private var objects: JsonField<MutableList<Role>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(roleListPageResponse: RoleListPageResponse) = apply {
            objects = roleListPageResponse.objects.map { it.toMutableList() }
         ...
         *
         * You should usually call [Builder.objects] with a well-typed `List<Role>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun objects(objects: JsonField<List<Role>>) = apply {
            this.objects = objects.map { it.toMutableList() }
        }

        /**
         * Adds a single [Role] to [objects].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addObject(object_: Role) = apply {
            objects =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is RoleListPageResponse && objects == other.objects && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "RoleListPageResponse{objects=$objects, additionalProperties=$additionalProperties}"
}
