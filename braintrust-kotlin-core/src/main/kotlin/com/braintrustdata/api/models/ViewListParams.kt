 ...
 */
class ViewListParams private constructor(
    ...
    override fun _queryParams(): QueryParams {
      ...
      this.viewName?.let {
          queryParams.put(
            "view_name", listOf(it.toString())
          )
      }
      this.viewType?.let {
          queryParams.put(
            "view_type", listOf(it.toString())
          )
      }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(viewListParams: ViewListParams) =
            apply {
    ...
    override fun toString() = "ViewListParams{objectId=$objectId, objectType=$objectType, endingBefore=$endingBefore, ids=$ids, limit=$limit, startingAfter=$startingAfter, viewName=$viewName, viewType=$viewType, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
