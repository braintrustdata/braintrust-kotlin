...
@NoAutoDetect
class FeedbackExperimentItem private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "FeedbackExperimentItem{id=$id, scores=$scores, expected=$expected, comment=$comment, metadata=$metadata, source=$source, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        fun build(): FeedbackExperimentItem = FeedbackExperimentItem(
            id,
            scores,
            expected,
            comment,
