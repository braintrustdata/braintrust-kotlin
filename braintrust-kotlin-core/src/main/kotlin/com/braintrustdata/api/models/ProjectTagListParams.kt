 ...
 */
class ProjectTagListParams private constructor(
    ...
    override fun _queryParams(): QueryParams {
      ...
      this.projectTagName?.let {
          queryParams.put(
            "project_tag_name", listOf(it.toString())
          )
      }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(projectTagListParams: ProjectTagListParams) =
            apply {
        ...
        /** Name of the project_tag to search for */
        fun projectTagName(projectTagName: String?) =
            apply {
    ...
    override fun toString() = "ProjectTagListParams{endingBefore=$endingBefore, ids=$ids, limit=$limit, orgName=$orgName, projectId=$projectId, projectName=$projectName, projectTagName=$projectTagName, startingAfter=$startingAfter, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
