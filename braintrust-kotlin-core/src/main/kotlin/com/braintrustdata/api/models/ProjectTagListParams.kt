...
constructor(
    ...
    internal fun getQueryParams(): QueryParams {
        ...
        this.projectTagName?.let { queryParams.put("project_tag_name", listOf(it.toString())) }
    ...
    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(endingBefore, ids, limit, orgName, projectId, projectName, projectTagName, startingAfter, additionalHeaders, additionalQueryParams) /* spotless:on */
    }
