...
class ProjectTagListParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    internal fun getQueryParams(): Map<String, List<String>> {
      ...
      this.projectTagName?.let {
          params.put("project_tag_name", listOf(it.toString()))
      }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ProjectTagListParams &&
          this.endingBefore == other.endingBefore &&
          this.ids == other.ids &&
          this.limit == other.limit &&
          this.orgName == other.orgName &&
          this.projectName == other.projectName &&
          this.projectTagName == other.projectTagName &&
    ...
    override fun toString() = "ProjectTagListParams{endingBefore=$endingBefore, ids=$ids, limit=$limit, orgName=$orgName, projectName=$projectName, projectTagName=$projectTagName, startingAfter=$startingAfter, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(projectTagListParams: ProjectTagListParams) = apply {
            ...
            additionalBodyProperties(projectTagListParams.additionalBodyProperties)
        }
        ...
        fun projectTagName(projectTagName: String) = apply {
        ...
        fun build(): ProjectTagListParams = ProjectTagListParams(
            endingBefore,
            ids,
            limit,
            orgName,
