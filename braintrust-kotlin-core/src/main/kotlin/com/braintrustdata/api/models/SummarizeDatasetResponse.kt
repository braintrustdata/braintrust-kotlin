...
@NoAutoDetect
class SummarizeDatasetResponse @JsonCreator private constructor(
    @JsonProperty("dataset_name") @ExcludeMissing private val datasetName: JsonField<String> = JsonMissing.of(),
    @JsonProperty("dataset_url") @ExcludeMissing private val datasetUrl: JsonField<String> = JsonMissing.of(),
    ...
    @JsonProperty("data_summary") @ExcludeMissing private val dataSummary: JsonField<DataSummary> = JsonMissing.of(),
    ...
    @ExcludeMissing
    fun _datasetUrl(): JsonField<String> = datasetUrl
    ...
    fun validate(): SummarizeDatasetResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(summarizeDatasetResponse: SummarizeDatasetResponse) =
            apply {
        ...
        /** URL to the dataset's page in the Braintrust app */
        fun datasetUrl(datasetUrl: JsonField<String>) =
            apply {
        ...
        /** Summary of a dataset's data */
        fun dataSummary(dataSummary: JsonField<DataSummary>) =
            apply {
    ...
    override fun toString() = "SummarizeDatasetResponse{datasetName=$datasetName, datasetUrl=$datasetUrl, projectName=$projectName, projectUrl=$projectUrl, dataSummary=$dataSummary, additionalProperties=$additionalProperties}"
}
