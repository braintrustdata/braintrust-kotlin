...
@NoAutoDetect
class Project @JsonCreator private constructor(
    ...
    override fun toString() = "Project{id=$id, name=$name, orgId=$orgId, created=$created, deletedAt=$deletedAt, settings=$settings, userId=$userId, additionalProperties=$additionalProperties}"
}
