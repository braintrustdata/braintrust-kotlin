...
class UserListParams constructor(
  ...
  private val additionalHeaders: Map<String, List<String>>,
    ...
    internal fun getQueryParams(): Map<String, List<String>> {
      ...
      this.email?.let {
          params.put("email", listOf(it.toString()))
      }
      this.endingBefore?.let {
          params.put("ending_before", listOf(it.toString()))
      }
      this.familyName?.let {
          params.put("family_name", listOf(it.toString()))
      }
      this.givenName?.let {
          params.put("given_name", listOf(it.toString()))
      }
      this.ids?.let {
    ...
    override fun toString() = "UserListParams{email=$email, endingBefore=$endingBefore, familyName=$familyName, givenName=$givenName, ids=$ids, limit=$limit, orgName=$orgName, startingAfter=$startingAfter, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
         ...
         * for more than one email
         */
        fun email(string: String) = apply {
            this.email = Email.ofString(string)
        }
         ...
         * for more than one email
         */
        fun email(strings: List<String>) = apply {
            this.email = Email.ofStrings(strings)
        }
         ...
         */
        fun familyName(familyName: FamilyName) = apply {
         ...
         * filter for more than one family name
         */
        fun familyName(string: String) = apply {
            this.familyName = FamilyName.ofString(string)
        }
         ...
         */
        fun givenName(givenName: GivenName) = apply {
         ...
         * filter for more than one given name
         */
        fun givenName(string: String) = apply {
            this.givenName = GivenName.ofString(string)
        }
        ...
        fun build(): UserListParams = UserListParams(
            email,
            endingBefore,
            familyName,
            givenName,
    ...
    class Email private constructor(private val string: String? = null, private val strings: List<String>? = null, private val _json: JsonValue? = null, ) {
    ...
    class FamilyName private constructor(private val string: String? = null, private val strings: List<String>? = null, private val _json: JsonValue? = null, ) {
        ...
        class Serializer : BaseSerializer<FamilyName>(FamilyName::class) {
            ...
            override fun serialize(value: FamilyName, generator: JsonGenerator, provider: SerializerProvider) {
              when {
                  value.string != null -> generator.writeObject(value.string)
                  value.strings != null -> generator.writeObject(value.strings)
                  value._json != null -> generator.writeObject(value._json)
    ...
    class GivenName private constructor(private val string: String? = null, private val strings: List<String>? = null, private val _json: JsonValue? = null, ) {
        ...
        class Serializer : BaseSerializer<GivenName>(GivenName::class) {
            ...
            override fun serialize(value: GivenName, generator: JsonGenerator, provider: SerializerProvider) {
              when {
                  value.string != null -> generator.writeObject(value.string)
                  value.strings != null -> generator.writeObject(value.strings)
                  value._json != null -> generator.writeObject(value._json)
