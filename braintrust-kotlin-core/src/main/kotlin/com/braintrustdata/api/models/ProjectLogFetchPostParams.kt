...
constructor(
    ...
    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(projectId, cursor, filters, limit, maxRootSpanId, maxXactId, version, additionalQueryParams, additionalHeaders, additionalBodyProperties) /* spotless:on */
    }
