 ...
 */
class ProjectLogFetchPostParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(projectLogFetchPostParams: ProjectLogFetchPostParams) =
            apply {
    ...
    override fun toString() = "ProjectLogFetchPostParams{projectId=$projectId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
