  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    class Categories private constructor(
      ...
      private val _json: JsonValue? = null,
        ...
        fun validate(): Categories = apply {
            if (!validated) {
              if (projectScoreCategories == null && weighted == null && strings == null && nullableVariant == null) {
        ...
        @NoAutoDetect
        class Weighted private constructor(private val additionalProperties: Map<String, JsonValue>, ) {
    ...
    class Config private constructor(
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        override fun toString() = "Config{multiSelect=$multiSelect, destination=$destination, online=$online, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            @JsonProperty("online")
            @ExcludeMissing
            fun online(online: JsonField<Online>) = apply {
                this.online = online
            }
        ...
        @NoAutoDetect
        class Online private constructor(
          ...
          private val additionalProperties: Map<String, JsonValue>,
            ...
            @ExcludeMissing
            fun _samplingRate() = samplingRate

            /** The list of scorers to use for online scoring */
            @JsonProperty("scorers")
            @ExcludeMissing
            fun _scorers() = scorers
            ...
            override fun toString() = "Online{samplingRate=$samplingRate, scorers=$scorers, applyToRootSpan=$applyToRootSpan, applyToSpanNames=$applyToSpanNames, additionalProperties=$additionalProperties}"
            ...
            class Builder {
                ...
                /** Whether to trigger online scoring on the root span of each trace */
                fun applyToRootSpan(applyToRootSpan: Boolean) = applyToRootSpan(JsonField.of(applyToRootSpan))
                ...
                /** Trigger online scoring on any spans with a name in this list */
                fun applyToSpanNames(applyToSpanNames: List<String>) = applyToSpanNames(JsonField.of(applyToSpanNames))
            ...
            class Scorer private constructor(private val function: Function? = null, private val global: Global? = null, private val _json: JsonValue? = null, ) {
                ...
                @NoAutoDetect
                class Function private constructor(private val type: JsonField<Type>, private val id: JsonField<String>, private val additionalProperties: Map<String, JsonValue>, ) {
                    ...
                    override fun toString() = "Function{type=$type, id=$id, additionalProperties=$additionalProperties}"
