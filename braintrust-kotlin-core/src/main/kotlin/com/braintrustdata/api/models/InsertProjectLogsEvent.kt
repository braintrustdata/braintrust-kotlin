...
@NoAutoDetect
class InsertProjectLogsEvent @JsonCreator private constructor(
    ...
    fun validate(): InsertProjectLogsEvent =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(insertProjectLogsEvent: InsertProjectLogsEvent) =
            apply {
