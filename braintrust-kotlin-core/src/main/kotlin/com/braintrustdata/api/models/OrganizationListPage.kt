...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is OrganizationListPage && this.organizationsService == other.organizationsService && this.params == other.params && this.response == other.response /* spotless:on */
    }
    ...
    constructor(
        ...
        override fun toString() =
            "OrganizationListPage.Response{objects=$objects, additionalProperties=$additionalProperties}"
