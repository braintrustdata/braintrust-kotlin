...
@NoAutoDetect
class FetchProjectLogsEventsResponse @JsonCreator private constructor(
    @JsonProperty("events") @ExcludeMissing private val events: JsonField<List<ProjectLogsEvent>> = JsonMissing.of(),
    ...
    class Builder internal constructor() {
        ...
        internal fun from(fetchProjectLogsEventsResponse: FetchProjectLogsEventsResponse) =
            apply {
                events = fetchProjectLogsEventsResponse.events.map { it.toMutableList() }
                cursor = fetchProjectLogsEventsResponse.cursor
                additionalProperties = fetchProjectLogsEventsResponse.additionalProperties.toMutableMap()
            }
        ...
        /** A list of fetched events */
        fun events(events: JsonField<List<ProjectLogsEvent>>) =
            apply {
                this.events = events.map { it.toMutableList() }
            }

        /** A list of fetched events */
        fun addEvent(event: ProjectLogsEvent) =
            apply {
