...
class DatasetSummarizeParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    internal fun getQueryParams(): Map<String, List<String>> {
      ...
      this.summarizeData?.let {
          params.put("summarize_data", listOf(it.toString()))
      }
    ...
    override fun toString() = "DatasetSummarizeParams{datasetId=$datasetId, summarizeData=$summarizeData, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(datasetSummarizeParams: DatasetSummarizeParams) = apply {
            ...
            additionalBodyProperties(datasetSummarizeParams.additionalBodyProperties)
        }
         ...
         * returned.
         */
        fun summarizeData(summarizeData: Boolean) = apply {
        ...
        fun build(): DatasetSummarizeParams = DatasetSummarizeParams(
