...
/** Summarize dataset */
class DatasetSummarizeParams private constructor(
    ...
    override fun _queryParams(): QueryParams {
      ...
      this.summarizeData?.let {
          queryParams.put(
            "summarize_data", listOf(it.toString())
          )
      }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(datasetSummarizeParams: DatasetSummarizeParams) =
            apply {
         ...
         * returned.
         */
        fun summarizeData(summarizeData: Boolean?) =
            apply {
    ...
    override fun toString() = "DatasetSummarizeParams{datasetId=$datasetId, summarizeData=$summarizeData, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
