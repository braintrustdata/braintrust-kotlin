...
constructor(
    ...
    internal fun getQueryParams(): Map<String, List<String>> {
        ...
        this.aiSecretName?.let { params.put("ai_secret_name", listOf(it.toString())) }
    ...
    override fun toString() =
        "AiSecretListParams{aiSecretName=$aiSecretName, aiSecretType=$aiSecretType, endingBefore=$endingBefore, ids=$ids, limit=$limit, orgName=$orgName, startingAfter=$startingAfter, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
