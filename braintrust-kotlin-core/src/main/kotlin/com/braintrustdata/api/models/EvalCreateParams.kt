...
private constructor(
     ...
     */
    fun baseExperimentId(): String? = body.baseExperimentId()
     ...
     *   server responded with an unexpected value).
     */
    fun baseExperimentName(): String? = body.baseExperimentName()
     ...
     *   server responded with an unexpected value).
     */
    fun gitMetadataSettings(): GitMetadataSettings? = body.gitMetadataSettings()
     ...
     *   server responded with an unexpected value).
     */
    fun maxConcurrency(): Double? = body.maxConcurrency()
     ...
     *   server responded with an unexpected value).
     */
    fun timeout(): Double? = body.timeout()
     ...
     *   server responded with an unexpected value).
     */
    fun trialCount(): Double? = body.trialCount()
    ...
    private constructor(
         ...
         */
        fun baseExperimentId(): String? = baseExperimentId.getNullable("base_experiment_id")
         ...
         *   the server responded with an unexpected value).
         */
        fun baseExperimentName(): String? = baseExperimentName.getNullable("base_experiment_name")
         ...
         *   the server responded with an unexpected value).
         */
        fun gitMetadataSettings(): GitMetadataSettings? =
            gitMetadataSettings.getNullable("git_metadata_settings")
         ...
         *   the server responded with an unexpected value).
         */
        fun isPublic(): Boolean? = isPublic.getNullable("is_public")
         ...
         *   the server responded with an unexpected value).
         */
        fun maxConcurrency(): Double? = maxConcurrency.getNullable("max_concurrency")
         ...
         *   the server responded with an unexpected value).
         */
        fun trialCount(): Double? = trialCount.getNullable("trial_count")
        ...
        internal fun validity(): Int =
            (data.asKnown()?.validity() ?: 0) +
                ...
                (scores.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
                (task.asKnown()?.validity() ?: 0) +
                (if (baseExperimentId.asKnown() == null) 0 else 1) +
                (if (baseExperimentName.asKnown() == null) 0 else 1) +
                (if (experimentName.asKnown() == null) 0 else 1) +
                (gitMetadataSettings.asKnown()?.validity() ?: 0) +
                (if (isPublic.asKnown() == null) 0 else 1) +
                (if (maxConcurrency.asKnown() == null) 0 else 1) +
                (metadata.asKnown()?.validity() ?: 0) +
                (parent.asKnown()?.validity() ?: 0) +
                (repoInfo.asKnown()?.validity() ?: 0) +
                (if (stream.asKnown() == null) 0 else 1) +
                (if (timeout.asKnown() == null) 0 else 1) +
                (if (trialCount.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is Body &&
                ...
                scores == other.scores &&
                task == other.task &&
                baseExperimentId == other.baseExperimentId &&
                baseExperimentName == other.baseExperimentName &&
                experimentName == other.experimentName &&
                gitMetadataSettings == other.gitMetadataSettings &&
    ...
    private constructor(
        ...
        /** Dataset id */
        fun datasetId(): DatasetId? = datasetId

        /** Project and dataset name */
        fun projectDatasetName(): ProjectDatasetName? = projectDatasetName

        /** Dataset rows */
        fun datasetRows(): DatasetRows? = datasetRows
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is Data &&
                ...
                projectDatasetName == other.projectDatasetName &&
                datasetRows == other.datasetRows
        }

        override fun hashCode(): Int = Objects.hash(datasetId, projectDatasetName, datasetRows)
        ...
        companion object {
            ...
            /** Dataset rows */
            fun ofDatasetRows(datasetRows: DatasetRows) = Data(datasetRows = datasetRows)
        }
        ...
        private constructor(
             ...
             */
            fun _internalBtql(): _InternalBtql? = _internalBtql.getNullable("_internal_btql")
            ...
            internal fun validity(): Int =
                (if (datasetId.asKnown() == null) 0 else 1) +
                    (_internalBtql.asKnown()?.validity() ?: 0)
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is DatasetId &&
                    datasetId == other.datasetId &&
                    _internalBtql == other._internalBtql &&
                    additionalProperties == other.additionalProperties
            }

            private val hashCode: Int by lazy {
                Objects.hash(datasetId, _internalBtql, additionalProperties)
            }
        ...
        private constructor(
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is ProjectDatasetName &&
            ...
            private val hashCode: Int by lazy {
                Objects.hash(datasetName, projectName, _internalBtql, additionalProperties)
            }
    ...
    private constructor(
        ...
        /** Function id */
        fun functionId(): FunctionId? = functionId

        /** Project name and slug */
        fun projectSlug(): ProjectSlug? = projectSlug

        /** Global function name */
        fun globalFunction(): GlobalFunction? = globalFunction

        /** Prompt session id */
        fun promptSessionId(): PromptSessionId? = promptSessionId

        /** Inline code function */
        fun inlineCode(): InlineCode? = inlineCode

        /** Inline prompt definition */
        fun inlinePrompt(): InlinePrompt? = inlinePrompt
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is Score &&
                ...
                globalFunction == other.globalFunction &&
                promptSessionId == other.promptSessionId &&
                inlineCode == other.inlineCode &&
                inlinePrompt == other.inlinePrompt
        }
        ...
        private constructor(
            ...
            private val hashCode: Int by lazy {
                Objects.hash(functionId, version, additionalProperties)
            }
        ...
        private constructor(
            ...
            private val hashCode: Int by lazy {
                Objects.hash(projectName, slug, version, additionalProperties)
            }
        ...
        private constructor(
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (if (globalFunction.asKnown() == null) 0 else 1)
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is GlobalFunction &&
                    globalFunction == other.globalFunction &&
                    additionalProperties == other.additionalProperties
            }
        ...
        private constructor(
             ...
             */
            internal fun validity(): Int =
                (if (promptSessionFunctionId.asKnown() == null) 0 else 1) +
                    (if (promptSessionId.asKnown() == null) 0 else 1) +
                    (if (version.asKnown() == null) 0 else 1)
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is PromptSessionId &&
                    promptSessionFunctionId == other.promptSessionFunctionId &&
                    promptSessionId == other.promptSessionId &&
                    version == other.version &&
                    additionalProperties == other.additionalProperties
            }
        ...
        private constructor(
            ...
            internal fun validity(): Int =
                (if (code.asKnown() == null) 0 else 1) +
                    (inlineContext.asKnown()?.validity() ?: 0) +
            ...
            private constructor(
                 ...
                 */
                internal fun validity(): Int =
                    (runtime.asKnown()?.validity() ?: 0) + (if (version.asKnown() == null) 0 else 1)
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is InlineCode &&
                    code == other.code &&
                    inlineContext == other.inlineContext &&
                    name == other.name &&
                    additionalProperties == other.additionalProperties
            }

            private val hashCode: Int by lazy {
                Objects.hash(code, inlineContext, name, additionalProperties)
            }
        ...
        private constructor(
             ...
             *   if the server responded with an unexpected value).
             */
            fun inlinePrompt(): PromptData? = inlinePrompt.getNullable("inline_prompt")
             ...
             */
            internal fun validity(): Int =
                (inlinePrompt.asKnown()?.validity() ?: 0) + (if (name.asKnown() == null) 0 else 1)
            ...
            private val hashCode: Int by lazy {
                Objects.hash(inlinePrompt, name, additionalProperties)
            }
    ...
    private constructor(
        ...
        class Collect @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            companion object {
                ...
                fun of(value: String) = Collect(JsonField.of(value))
            }
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is Collect && value == other.value
            }
        ...
        class Field @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                val COMMIT = of("commit")

                val BRANCH = of("branch")

                val TAG = of("tag")

                val DIRTY = of("dirty")

                val AUTHOR_NAME = of("author_name")

                val AUTHOR_EMAIL = of("author_email")

                val COMMIT_MESSAGE = of("commit_message")

                val COMMIT_TIME = of("commit_time")

                val GIT_DIFF = of("git_diff")
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is GitMetadataSettings &&
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is Parent &&
                spanParentStruct == other.spanParentStruct &&
                string == other.string
        }

        override fun hashCode(): Int = Objects.hash(spanParentStruct, string)
        ...
        private constructor(
            ...
            internal fun validity(): Int =
                (if (objectId.asKnown() == null) 0 else 1) +
                    ...
                    (propagatedEvent.asKnown()?.validity() ?: 0) +
                    (rowIds.asKnown()?.validity() ?: 0)
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                ...
                companion object {
                    ...
                    val PLAYGROUND_LOGS = of("playground_logs")
            ...
            private constructor(
                ...
                private val hashCode: Int by lazy {
                    Objects.hash(id, rootSpanId, spanId, additionalProperties)
                }
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is SpanParentStruct &&
                    ...
                    propagatedEvent == other.propagatedEvent &&
                    rowIds == other.rowIds &&
                    additionalProperties == other.additionalProperties
            }

            private val hashCode: Int by lazy {
                Objects.hash(objectId, objectType, propagatedEvent, rowIds, additionalProperties)
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EvalCreateParams &&
            body == other.body &&
