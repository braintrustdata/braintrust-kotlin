...
constructor(
    ...
    fun baseExperimentId(): String? = baseExperimentId

    fun baseExperimentName(): String? = baseExperimentName

    fun experimentName(): String? = experimentName

    fun gitMetadataSettings(): GitMetadataSettings? = gitMetadataSettings

    fun isPublic(): Boolean? = isPublic

    fun maxConcurrency(): Double? = maxConcurrency
    ...
    fun timeout(): Double? = timeout

    fun trialCount(): Double? = trialCount
    ...
    private constructor(
        ...
        private constructor(
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return /* spotless:off */ other is ProjectDatasetName && projectName == other.projectName && datasetName == other.datasetName && additionalProperties == other.additionalProperties /* spotless:on */
            }

            /* spotless:off */
            private val hashCode: Int by lazy { Objects.hash(projectName, datasetName, additionalProperties) }
            /* spotless:on */
    ...
    private constructor(
        ...
        private constructor(
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return /* spotless:off */ other is PromptSessionId && promptSessionId == other.promptSessionId && promptSessionFunctionId == other.promptSessionFunctionId && version == other.version && additionalProperties == other.additionalProperties /* spotless:on */
            }

            /* spotless:off */
            private val hashCode: Int by lazy { Objects.hash(promptSessionId, promptSessionFunctionId, version, additionalProperties) }
            /* spotless:on */
        ...
        private constructor(
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return /* spotless:off */ other is InlineCode && inlineContext == other.inlineContext && code == other.code && name == other.name && additionalProperties == other.additionalProperties /* spotless:on */
            }

            /* spotless:off */
            private val hashCode: Int by lazy { Objects.hash(inlineContext, code, name, additionalProperties) }
            /* spotless:on */
    ...
    private constructor(
        ...
        private constructor(
            ...
            companion object {
                ...
                val ALL = Collect(JsonField.of("all"))

                val NONE = Collect(JsonField.of("none"))

                val SOME = Collect(JsonField.of("some"))
        ...
        private constructor(
            ...
            companion object {
                ...
                val COMMIT = Field(JsonField.of("commit"))

                val BRANCH = Field(JsonField.of("branch"))

                val TAG = Field(JsonField.of("tag"))

                val DIRTY = Field(JsonField.of("dirty"))

                val AUTHOR_NAME = Field(JsonField.of("author_name"))

                val AUTHOR_EMAIL = Field(JsonField.of("author_email"))

                val COMMIT_MESSAGE = Field(JsonField.of("commit_message"))

                val COMMIT_TIME = Field(JsonField.of("commit_time"))

                val GIT_DIFF = Field(JsonField.of("git_diff"))
