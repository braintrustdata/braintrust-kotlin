...
@NoAutoDetect
class EnvVarListResponse @JsonCreator private constructor(
    @JsonProperty("objects") @ExcludeMissing private val objects: JsonField<List<EnvVar>> = JsonMissing.of(),
    ...
    @ExcludeMissing
    fun _objects(): JsonField<List<EnvVar>> = objects
    ...
    fun validate(): EnvVarListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(envVarListResponse: EnvVarListResponse) =
            apply {
        ...
        /** A list of env_var objects */
        fun objects(objects: JsonField<List<EnvVar>>) =
            apply {
                this.objects = objects.map { it.toMutableList() }
            }

        /** A list of env_var objects */
        fun addObject(object_: EnvVar) =
            apply {
    ...
    override fun toString() = "EnvVarListResponse{objects=$objects, additionalProperties=$additionalProperties}"
}
