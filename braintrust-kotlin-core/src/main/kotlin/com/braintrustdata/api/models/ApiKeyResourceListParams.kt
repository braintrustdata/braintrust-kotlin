...
class ApiKeyResourceListParams constructor(
  ...
  private val additionalHeaders: Map<String, List<String>>,
    ...
    internal fun getQueryParams(): Map<String, List<String>> {
      ...
      this.apiKeyName?.let {
          params.put("api_key_name", listOf(it.toString()))
      }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ApiKeyResourceListParams &&
    ...
    override fun toString() = "ApiKeyResourceListParams{apiKeyName=$apiKeyName, endingBefore=$endingBefore, ids=$ids, limit=$limit, orgName=$orgName, startingAfter=$startingAfter, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        internal fun from(apiKeyResourceListParams: ApiKeyResourceListParams) = apply {
            this.apiKeyName = apiKeyResourceListParams.apiKeyName
            this.endingBefore = apiKeyResourceListParams.endingBefore
            this.ids = apiKeyResourceListParams.ids
            this.limit = apiKeyResourceListParams.limit
            this.orgName = apiKeyResourceListParams.orgName
            this.startingAfter = apiKeyResourceListParams.startingAfter
            additionalQueryParams(apiKeyResourceListParams.additionalQueryParams)
            additionalHeaders(apiKeyResourceListParams.additionalHeaders)
        }

        /** Name of the api_key to search for */
        fun apiKeyName(apiKeyName: String) = apply {
        ...
        fun build(): ApiKeyResourceListParams = ApiKeyResourceListParams(
            apiKeyName,
            endingBefore,
            ids,
            limit,
