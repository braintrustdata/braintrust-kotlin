...
class ApiKeyResourceListParams
constructor(
    ...
    override fun toString() =
        "ApiKeyResourceListParams{apiKeyName=$apiKeyName, endingBefore=$endingBefore, ids=$ids, limit=$limit, orgName=$orgName, startingAfter=$startingAfter, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(apiKeyResourceListParams: ApiKeyResourceListParams) = apply {
            ...
            additionalBodyProperties(apiKeyResourceListParams.additionalBodyProperties)
        }
        ...
        fun build(): ApiKeyResourceListParams =
