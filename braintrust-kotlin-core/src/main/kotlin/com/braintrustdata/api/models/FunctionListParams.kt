...
class FunctionListParams constructor(
  ...
  private val additionalHeaders: Map<String, List<String>>,
    ...
    internal fun getQueryParams(): Map<String, List<String>> {
      ...
      this.functionName?.let {
          params.put("function_name", listOf(it.toString()))
      }
      this.ids?.let {
    ...
    class Builder {
        ...
        fun functionName(functionName: String) = apply {
        ...
        fun build(): FunctionListParams = FunctionListParams(
            endingBefore,
            functionName,
            ids,
            limit,
