...
class ExperimentFetchPostParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    @NoAutoDetect
    class ExperimentFetchPostBody internal constructor(
      private val cursor: String?,
      private val filters: List<PathLookupFilter>?,
      private val limit: Long?,
      private val maxRootSpanId: String?,
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        override fun toString() = "ExperimentFetchPostBody{cursor=$cursor, filters=$filters, limit=$limit, maxRootSpanId=$maxRootSpanId, maxXactId=$maxXactId, version=$version, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            fun build(): ExperimentFetchPostBody = ExperimentFetchPostBody(
                cursor,
    ...
    class Builder {
        ...
        fun build(): ExperimentFetchPostParams = ExperimentFetchPostParams(
