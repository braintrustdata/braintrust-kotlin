 ...
 */
class ExperimentFetchPostParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(experimentFetchPostParams: ExperimentFetchPostParams) =
            apply {
    ...
    override fun toString() = "ExperimentFetchPostParams{experimentId=$experimentId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
