...
class DatasetInsertParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        @JsonProperty("events") @ExcludeMissing private val events: JsonField<List<InsertDatasetEvent>> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
            ...
            /** A list of dataset events to insert */
            fun events(events: JsonField<List<InsertDatasetEvent>>) =
                apply {
                    this.events = events.map { it.toMutableList() }
                }

            /** A list of dataset events to insert */
            fun addEvent(event: InsertDatasetEvent) =
                apply {
    ...
    class Builder internal constructor() {
        ...
        internal fun from(datasetInsertParams: DatasetInsertParams) =
            apply {
        ...
        /** A list of dataset events to insert */
        fun events(events: List<InsertDatasetEvent>) =
            apply {
                body.events(events)
            }
    ...
    override fun toString() = "DatasetInsertParams{datasetId=$datasetId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
