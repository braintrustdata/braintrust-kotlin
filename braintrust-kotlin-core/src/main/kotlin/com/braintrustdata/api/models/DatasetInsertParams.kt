...
constructor(
    ...
    private constructor(
        ...
        private constructor(
            ...
            override fun toString() =
                "InsertDatasetEventReplace{input=$input, output=$output, metadata=$metadata, id=$id, _objectDelete=$_objectDelete, _isMerge=$_isMerge, _parentId=$_parentId, additionalProperties=$additionalProperties}"
            ...
            class Builder {
                ...
                internal fun from(insertDatasetEventReplace: InsertDatasetEventReplace) = apply {
                    ...
                    this.output = insertDatasetEventReplace.output
        ...
        private constructor(
            ...
            override fun toString() =
                "InsertDatasetEventMerge{input=$input, output=$output, metadata=$metadata, id=$id, _objectDelete=$_objectDelete, _isMerge=$_isMerge, _mergePaths=$_mergePaths, additionalProperties=$additionalProperties}"
            ...
            class Builder {
                ...
                internal fun from(insertDatasetEventMerge: InsertDatasetEventMerge) = apply {
                    ...
                    this.output = insertDatasetEventMerge.output
