 ...
 */
class ProjectScoreListPage private constructor(
    ...
    companion object {
        ...
        fun of(projectScoresService: ProjectScoreService, params: ProjectScoreListParams, response: Response) =
    ...
    class Response @JsonCreator constructor(
        @JsonProperty("objects") private val objects: JsonField<List<ProjectScore>> = JsonMissing.of(),
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<ProjectScore> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {
