...
class ProjectScoreListPage private constructor(private val projectScoresService: ProjectScoreService, private val params: ProjectScoreListParams, private val response: Response, ) {
    ...
    class Response constructor(private val objects: JsonField<List<ProjectScore>>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "ProjectScoreListPage.Response{objects=$objects, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: ProjectScoreListPage, ) : Sequence<ProjectScore> {
