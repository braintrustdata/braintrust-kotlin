...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(experimentInsertResponse: ExperimentInsertResponse) = apply {
            ...
            this.serializedSpanSlugs = experimentInsertResponse.serializedSpanSlugs
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ExperimentInsertResponse && this.rowIds == other.rowIds && this.serializedSpanSlugs == other.serializedSpanSlugs && this.additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ExperimentInsertResponse{rowIds=$rowIds, serializedSpanSlugs=$serializedSpanSlugs, additionalProperties=$additionalProperties}"
}
