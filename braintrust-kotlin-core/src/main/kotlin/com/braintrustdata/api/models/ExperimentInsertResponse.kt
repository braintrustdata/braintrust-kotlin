...
@NoAutoDetect
class ExperimentInsertResponse private constructor(private val rowIds: JsonField<List<String>>, private val additionalProperties: Map<String, JsonValue>, ) {
    ...
    override fun toString() = "ExperimentInsertResponse{rowIds=$rowIds, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        fun build(): ExperimentInsertResponse = ExperimentInsertResponse(rowIds.map { it.toUnmodifiable() }, additionalProperties.toUnmodifiable())
    }
}
