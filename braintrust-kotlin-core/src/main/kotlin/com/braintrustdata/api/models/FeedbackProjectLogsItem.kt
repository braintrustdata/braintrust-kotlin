...
@NoAutoDetect
class FeedbackProjectLogsItem @JsonCreator private constructor(
    ...
    fun validate(): FeedbackProjectLogsItem =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(feedbackProjectLogsItem: FeedbackProjectLogsItem) =
            apply {
    ...
    override fun toString() = "FeedbackProjectLogsItem{id=$id, comment=$comment, expected=$expected, metadata=$metadata, scores=$scores, source=$source, tags=$tags, additionalProperties=$additionalProperties}"
}
