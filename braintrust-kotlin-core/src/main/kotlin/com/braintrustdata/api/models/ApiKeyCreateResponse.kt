...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(apiKeyCreateResponse: ApiKeyCreateResponse) = apply {
            ...
            this.created = apiKeyCreateResponse.created
            this.name = apiKeyCreateResponse.name
            this.previewName = apiKeyCreateResponse.previewName
            this.userId = apiKeyCreateResponse.userId
            this.orgId = apiKeyCreateResponse.orgId
