...
class Function private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    @ExcludeMissing
    fun _functionData() = functionData
    ...
    override fun toString() = "Function{id=$id, _xactId=$_xactId, projectId=$projectId, logId=$logId, orgId=$orgId, name=$name, slug=$slug, description=$description, created=$created, promptData=$promptData, tags=$tags, metadata=$metadata, functionData=$functionData, additionalProperties=$additionalProperties}"
                  ...
                  private val _json: JsonValue? = null,
                    ...
                    class UnionMember1 private constructor(
                      ...
                      private val additionalProperties: Map<String, JsonValue>,
                        ...
                        class Content private constructor(private val string: String? = null, private val unnamedSchemaWithArrayParent7s: List<UnnamedSchemaWithArrayParent7>? = null, private val _json: JsonValue? = null, ) {

                            private var validated: Boolean = false

                            fun string(): String? = string
                            fun unnamedSchemaWithArrayParent7s(): List<UnnamedSchemaWithArrayParent7>? = unnamedSchemaWithArrayParent7s

                            fun isString(): Boolean = string != null
                            fun isUnnamedSchemaWithArrayParent7s(): Boolean = unnamedSchemaWithArrayParent7s != null

                            fun asString(): String = string.getOrThrow("string")
                            fun asUnnamedSchemaWithArrayParent7s(): List<UnnamedSchemaWithArrayParent7> = unnamedSchemaWithArrayParent7s.getOrThrow("unnamedSchemaWithArrayParent7s")
                            ...
                            fun <T> accept(visitor: Visitor<T>): T {
                              return when {
                                  ...
                                  unnamedSchemaWithArrayParent7s != null -> visitor.visitUnnamedSchemaWithArrayParent7s(unnamedSchemaWithArrayParent7s)
                                  else -> visitor.unknown(_json)
                              }
                            }
                            ...
                            override fun equals(other: Any?): Boolean {
                              ...
                              return other is Content &&
                                  ...
                                  this.unnamedSchemaWithArrayParent7s == other.unnamedSchemaWithArrayParent7s
                            }
                            ...
                            override fun toString(): String {
                              return when {
                                  ...
                                  unnamedSchemaWithArrayParent7s != null -> "Content{unnamedSchemaWithArrayParent7s=$unnamedSchemaWithArrayParent7s}"
                            ...
                            companion object {
                                ...
                                fun ofUnnamedSchemaWithArrayParent7s(unnamedSchemaWithArrayParent7s: List<UnnamedSchemaWithArrayParent7>) = Content(unnamedSchemaWithArrayParent7s = unnamedSchemaWithArrayParent7s)
                            }
                            ...
                            interface Visitor<out T> {
                                ...
                                fun visitUnnamedSchemaWithArrayParent7s(unnamedSchemaWithArrayParent7s: List<UnnamedSchemaWithArrayParent7>): T
                            ...
                            class Deserializer : BaseDeserializer<Content>(Content::class) {
                                ...
                                override fun ObjectCodec.deserialize(node: JsonNode): Content {
                                  ...
                                  tryDeserialize(node, jacksonTypeRef<List<UnnamedSchemaWithArrayParent7>>())?.let {
                                      return Content(unnamedSchemaWithArrayParent7s = it, _json = json)
                                  }
                            ...
                            class Serializer : BaseSerializer<Content>(Content::class) {
                                ...
                                override fun serialize(value: Content, generator: JsonGenerator, provider: SerializerProvider) {
                                  when {
                                      ...
                                      value.unnamedSchemaWithArrayParent7s != null -> generator.writeObject(value.unnamedSchemaWithArrayParent7s)
                                      value._json != null -> generator.writeObject(value._json)
                                      else -> throw IllegalStateException("Invalid Content")
                                  }
                                }
                            ...
                            class UnnamedSchemaWithArrayParent7 private constructor(private val unionMember0: UnionMember0? = null, private val unionMember1: UnionMember1? = null, private val _json: JsonValue? = null, ) {
                                ...
                                fun validate(): UnnamedSchemaWithArrayParent7 = apply {
                                    if (!validated) {
                                      if (unionMember0 == null && unionMember1 == null) {
                                        throw BraintrustInvalidDataException("Unknown UnnamedSchemaWithArrayParent7: $_json")
                                      }
                                      unionMember0?.validate()
                                      unionMember1?.validate()
                                      validated = true
                                ...
                                override fun toString(): String {
                                  return when {
                                      unionMember0 != null -> "UnnamedSchemaWithArrayParent7{unionMember0=$unionMember0}"
                                      unionMember1 != null -> "UnnamedSchemaWithArrayParent7{unionMember1=$unionMember1}"
                                      _json != null -> "UnnamedSchemaWithArrayParent7{_unknown=$_json}"
                                      else -> throw IllegalStateException("Invalid UnnamedSchemaWithArrayParent7")
                                  }
                                }

                                companion object {

                                    fun ofUnionMember0(unionMember0: UnionMember0) = UnnamedSchemaWithArrayParent7(unionMember0 = unionMember0)

                                    fun ofUnionMember1(unionMember1: UnionMember1) = UnnamedSchemaWithArrayParent7(unionMember1 = unionMember1)
                                }
                                ...
                                interface Visitor<out T> {
                                    ...
                                    fun unknown(json: JsonValue?): T {
                                      throw BraintrustInvalidDataException("Unknown UnnamedSchemaWithArrayParent7: $json")
                                    }
                                }

                                class Deserializer : BaseDeserializer<UnnamedSchemaWithArrayParent7>(UnnamedSchemaWithArrayParent7::class) {

                                    override fun ObjectCodec.deserialize(node: JsonNode): UnnamedSchemaWithArrayParent7 {
                                      val json = JsonValue.fromJsonNode(node)
                                      tryDeserialize(node, jacksonTypeRef<UnionMember0>()){ it.validate() }?.let {
                                          return UnnamedSchemaWithArrayParent7(unionMember0 = it, _json = json)
                                      }
                                      tryDeserialize(node, jacksonTypeRef<UnionMember1>()){ it.validate() }?.let {
                                          return UnnamedSchemaWithArrayParent7(unionMember1 = it, _json = json)
                                      }
                                ...
                                class Serializer : BaseSerializer<UnnamedSchemaWithArrayParent7>(UnnamedSchemaWithArrayParent7::class) {

                                    override fun serialize(value: UnnamedSchemaWithArrayParent7, generator: JsonGenerator, provider: SerializerProvider) {
                                      when {
                                          value.unionMember0 != null -> generator.writeObject(value.unionMember0)
                                          value.unionMember1 != null -> generator.writeObject(value.unionMember1)
                                          value._json != null -> generator.writeObject(value._json)
