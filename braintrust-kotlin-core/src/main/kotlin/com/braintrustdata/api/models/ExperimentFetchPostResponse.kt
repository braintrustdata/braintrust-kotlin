...
@NoAutoDetect
class ExperimentFetchPostResponse private constructor(private val events: JsonField<List<Event>>, private val cursor: JsonField<String>, private val additionalProperties: Map<String, JsonValue>, ) {
    ...
    override fun toString() = "ExperimentFetchPostResponse{events=$events, cursor=$cursor, additionalProperties=$additionalProperties}"
