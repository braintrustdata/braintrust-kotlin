...
private constructor(
    ...
    fun removeMemberUsers(): List<String>? = removeMemberUsers.getNullable("remove_member_users")

    /** A list of group IDs to add to the group's inheriting-from set */
    fun addMemberGroups(): List<String>? = addMemberGroups.getNullable("add_member_groups")

    /** A list of group IDs to remove from the group's inheriting-from set */
    fun removeMemberGroups(): List<String>? = removeMemberGroups.getNullable("remove_member_groups")
