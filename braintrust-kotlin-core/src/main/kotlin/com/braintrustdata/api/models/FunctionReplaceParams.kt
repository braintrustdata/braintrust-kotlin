  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    class FunctionReplaceBody internal constructor(
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        override fun toString() = "FunctionReplaceBody{functionData=$functionData, name=$name, projectId=$projectId, slug=$slug, description=$description, functionType=$functionType, origin=$origin, promptData=$promptData, tags=$tags, additionalProperties=$additionalProperties}"
                        ...
                        class Position private constructor(private val type: Type? = null, private val scorer: Scorer? = null, private val _json: JsonValue? = null, ) {
                            ...
                            class Scorer private constructor(private val type: JsonField<Type>, private val index: JsonField<Double>, private val additionalProperties: Map<String, JsonValue>, ) {
                                ...
                                class Builder {
                                    ...
                                    @JsonProperty("index")
                                    @ExcludeMissing
                                    fun index(index: JsonField<Double>) = apply {
                                        this.index = index
                                    }
    ...
    class Origin private constructor(
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        fun internal_(): Boolean? = internal_
        ...
        override fun toString() = "Origin{objectType=$objectType, objectId=$objectId, internal_=$internal_, additionalProperties=$additionalProperties}"
        ...
        class Builder {
             ...
             */
            @JsonProperty("internal")
            fun internal_(internal_: Boolean) = apply {
