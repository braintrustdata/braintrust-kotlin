...
class FunctionReplaceParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    @JsonDeserialize(builder = FunctionReplaceBody.Builder::class)
    @NoAutoDetect
    class FunctionReplaceBody internal constructor(
      private val functionData: FunctionData?,
      private val name: String?,
      private val projectId: String?,
      private val slug: String?,
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is FunctionReplaceBody &&
        ...
        override fun toString() = "FunctionReplaceBody{functionData=$functionData, name=$name, projectId=$projectId, slug=$slug, description=$description, promptData=$promptData, tags=$tags, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            internal fun from(functionReplaceBody: FunctionReplaceBody) = apply {
                this.functionData = functionReplaceBody.functionData
                this.name = functionReplaceBody.name
                this.projectId = functionReplaceBody.projectId
                this.slug = functionReplaceBody.slug
                this.description = functionReplaceBody.description
                this.promptData = functionReplaceBody.promptData
                this.tags = functionReplaceBody.tags
                additionalProperties(functionReplaceBody.additionalProperties)
            }
            ...
            fun build(): FunctionReplaceBody = FunctionReplaceBody(
                checkNotNull(functionData) {
                    "`functionData` is required but was not set"
                },
                checkNotNull(name) {
    ...
    override fun toString() = "FunctionReplaceParams{functionData=$functionData, name=$name, projectId=$projectId, slug=$slug, description=$description, promptData=$promptData, tags=$tags, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        fun build(): FunctionReplaceParams = FunctionReplaceParams(
            checkNotNull(functionData) {
                "`functionData` is required but was not set"
            },
            checkNotNull(name) {
    ...
    class FunctionData private constructor(
      ...
      private val _json: JsonValue? = null,
        ...
        fun validate(): FunctionData = apply {
            if (!validated) {
              if (type == null && unionMember1 == null && unionMember2 == null) {
                    ...
                    class Position private constructor(private val unionMember0: UnionMember0? = null, private val score: Score? = null, private val _json: JsonValue? = null, ) {
                        ...
                        class UnionMember0 @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                            ...
                            companion object {
                                ...
                                val TASK = UnionMember0(JsonField.of("task"))
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                class Message private constructor(
                  ...
                  private val _json: JsonValue? = null,
                    ...
                    fun unionMember5(): UnionMember5? = unionMember5
                    ...
                    class UnionMember1 private constructor(
                      ...
                      private val additionalProperties: Map<String, JsonValue>,
                        ...
                        class Content private constructor(private val string: String? = null, private val unnamedSchemaWithArrayParent5s: List<UnnamedSchemaWithArrayParent5>? = null, private val _json: JsonValue? = null, ) {

                            private var validated: Boolean = false

                            fun string(): String? = string
                            fun unnamedSchemaWithArrayParent5s(): List<UnnamedSchemaWithArrayParent5>? = unnamedSchemaWithArrayParent5s

                            fun isString(): Boolean = string != null
                            fun isUnnamedSchemaWithArrayParent5s(): Boolean = unnamedSchemaWithArrayParent5s != null

                            fun asString(): String = string.getOrThrow("string")
                            fun asUnnamedSchemaWithArrayParent5s(): List<UnnamedSchemaWithArrayParent5> = unnamedSchemaWithArrayParent5s.getOrThrow("unnamedSchemaWithArrayParent5s")
                            ...
                            fun <T> accept(visitor: Visitor<T>): T {
                              return when {
                                  ...
                                  unnamedSchemaWithArrayParent5s != null -> visitor.visitUnnamedSchemaWithArrayParent5s(unnamedSchemaWithArrayParent5s)
                                  else -> visitor.unknown(_json)
                              }
                            }
                            ...
                            fun validate(): Content = apply {
                                if (!validated) {
                                  if (string == null && unnamedSchemaWithArrayParent5s == null) {
                            ...
                            override fun equals(other: Any?): Boolean {
                              ...
                              return other is Content &&
                                  ...
                                  this.unnamedSchemaWithArrayParent5s == other.unnamedSchemaWithArrayParent5s
                            }
                            ...
                            override fun toString(): String {
                              return when {
                                  ...
                                  unnamedSchemaWithArrayParent5s != null -> "Content{unnamedSchemaWithArrayParent5s=$unnamedSchemaWithArrayParent5s}"
                            ...
                            companion object {
                                ...
                                fun ofUnnamedSchemaWithArrayParent5s(unnamedSchemaWithArrayParent5s: List<UnnamedSchemaWithArrayParent5>) = Content(unnamedSchemaWithArrayParent5s = unnamedSchemaWithArrayParent5s)
                            }
                            ...
                            interface Visitor<out T> {
                                ...
                                fun visitUnnamedSchemaWithArrayParent5s(unnamedSchemaWithArrayParent5s: List<UnnamedSchemaWithArrayParent5>): T
                            ...
                            class Deserializer : BaseDeserializer<Content>(Content::class) {
                                ...
                                override fun ObjectCodec.deserialize(node: JsonNode): Content {
                                  ...
                                  tryDeserialize(node, jacksonTypeRef<List<UnnamedSchemaWithArrayParent5>>())?.let {
                                      return Content(unnamedSchemaWithArrayParent5s = it, _json = json)
                                  }
                            ...
                            class Serializer : BaseSerializer<Content>(Content::class) {
                                ...
                                override fun serialize(value: Content, generator: JsonGenerator, provider: SerializerProvider) {
                                  when {
                                      ...
                                      value.unnamedSchemaWithArrayParent5s != null -> generator.writeObject(value.unnamedSchemaWithArrayParent5s)
                                      value._json != null -> generator.writeObject(value._json)
                                      else -> throw IllegalStateException("Invalid Content")
                                  }
                                }
                            ...
                            class UnnamedSchemaWithArrayParent5 private constructor(private val unionMember0: UnionMember0? = null, private val unionMember1: UnionMember1? = null, private val _json: JsonValue? = null, ) {
                                ...
                                fun validate(): UnnamedSchemaWithArrayParent5 = apply {
                                    if (!validated) {
                                      if (unionMember0 == null && unionMember1 == null) {
                                        throw BraintrustInvalidDataException("Unknown UnnamedSchemaWithArrayParent5: $_json")
                                      }
                                      unionMember0?.validate()
                                      unionMember1?.validate()
                                      validated = true
                                ...
                                override fun toString(): String {
                                  return when {
                                      unionMember0 != null -> "UnnamedSchemaWithArrayParent5{unionMember0=$unionMember0}"
                                      unionMember1 != null -> "UnnamedSchemaWithArrayParent5{unionMember1=$unionMember1}"
                                      _json != null -> "UnnamedSchemaWithArrayParent5{_unknown=$_json}"
                                      else -> throw IllegalStateException("Invalid UnnamedSchemaWithArrayParent5")
                                  }
                                }

                                companion object {

                                    fun ofUnionMember0(unionMember0: UnionMember0) = UnnamedSchemaWithArrayParent5(unionMember0 = unionMember0)

                                    fun ofUnionMember1(unionMember1: UnionMember1) = UnnamedSchemaWithArrayParent5(unionMember1 = unionMember1)
                                }
                                ...
                                interface Visitor<out T> {
                                    ...
                                    fun unknown(json: JsonValue?): T {
                                      throw BraintrustInvalidDataException("Unknown UnnamedSchemaWithArrayParent5: $json")
                                    }
                                }

                                class Deserializer : BaseDeserializer<UnnamedSchemaWithArrayParent5>(UnnamedSchemaWithArrayParent5::class) {

                                    override fun ObjectCodec.deserialize(node: JsonNode): UnnamedSchemaWithArrayParent5 {
                                      val json = JsonValue.fromJsonNode(node)
                                      tryDeserialize(node, jacksonTypeRef<UnionMember0>()){ it.validate() }?.let {
                                          return UnnamedSchemaWithArrayParent5(unionMember0 = it, _json = json)
                                      }
                                      tryDeserialize(node, jacksonTypeRef<UnionMember1>()){ it.validate() }?.let {
                                          return UnnamedSchemaWithArrayParent5(unionMember1 = it, _json = json)
                                      }

                                      return UnnamedSchemaWithArrayParent5(_json = json)
                                    }
                                }

                                class Serializer : BaseSerializer<UnnamedSchemaWithArrayParent5>(UnnamedSchemaWithArrayParent5::class) {

                                    override fun serialize(value: UnnamedSchemaWithArrayParent5, generator: JsonGenerator, provider: SerializerProvider) {
                                      when {
                                          value.unionMember0 != null -> generator.writeObject(value.unionMember0)
                                          value.unionMember1 != null -> generator.writeObject(value.unionMember1)
                                          value._json != null -> generator.writeObject(value._json)
