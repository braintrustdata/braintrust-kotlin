...
@NoAutoDetect
class ExperimentEvent private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "ExperimentEvent{id=$id, datasetRecordId=$datasetRecordId, _xactId=$_xactId, created=$created, projectId=$projectId, experimentId=$experimentId, input=$input, output=$output, expected=$expected, error=$error, scores=$scores, metadata=$metadata, tags=$tags, metrics=$metrics, context=$context, spanId=$spanId, spanParents=$spanParents, rootSpanId=$rootSpanId, spanAttributes=$spanAttributes, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        @JsonProperty("error")
        @ExcludeMissing
        fun error(error: JsonValue) = apply {
            this.error = error
        }
        ...
        fun build(): ExperimentEvent = ExperimentEvent(
            id,
            datasetRecordId,
            _xactId,
            created,
