  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    class PromptCreateBody internal constructor(
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        override fun toString() = "PromptCreateBody{name=$name, projectId=$projectId, slug=$slug, description=$description, promptData=$promptData, tags=$tags, additionalProperties=$additionalProperties}"
    ...
    override fun toString() = "PromptCreateParams{name=$name, projectId=$projectId, slug=$slug, description=$description, promptData=$promptData, tags=$tags, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
                  ...
                  private val _json: JsonValue? = null,
                    ...
                    class UnionMember1 private constructor(
                      ...
                      private val additionalProperties: Map<String, JsonValue>,
                        ...
                        class Content private constructor(private val string: String? = null, private val unnamedSchemaWithArrayParent0s: List<UnnamedSchemaWithArrayParent0>? = null, private val _json: JsonValue? = null, ) {
                            ...
                            override fun equals(other: Any?): Boolean {
                              ...
                              return other is Content &&
                                  ...
                                  this.unnamedSchemaWithArrayParent0s == other.unnamedSchemaWithArrayParent0s
                            }
                            ...
                            override fun toString(): String {
                              return when {
                                  ...
                                  unnamedSchemaWithArrayParent0s != null -> "Content{unnamedSchemaWithArrayParent0s=$unnamedSchemaWithArrayParent0s}"
                            ...
                            companion object {
                                ...
                                fun ofUnnamedSchemaWithArrayParent0s(unnamedSchemaWithArrayParent0s: List<UnnamedSchemaWithArrayParent0>) = Content(unnamedSchemaWithArrayParent0s = unnamedSchemaWithArrayParent0s)
                            }
                            ...
                            class Deserializer : BaseDeserializer<Content>(Content::class) {
                                ...
                                override fun ObjectCodec.deserialize(node: JsonNode): Content {
                                  ...
                                  tryDeserialize(node, jacksonTypeRef<List<UnnamedSchemaWithArrayParent0>>())?.let {
                                      return Content(unnamedSchemaWithArrayParent0s = it, _json = json)
                                  }
                            ...
                            class Serializer : BaseSerializer<Content>(Content::class) {
                                ...
                                override fun serialize(value: Content, generator: JsonGenerator, provider: SerializerProvider) {
                                  when {
                                      ...
                                      value.unnamedSchemaWithArrayParent0s != null -> generator.writeObject(value.unnamedSchemaWithArrayParent0s)
                                      value._json != null -> generator.writeObject(value._json)
                                      else -> throw IllegalStateException("Invalid Content")
                                  }
                                }
                            ...
                            class UnnamedSchemaWithArrayParent0 private constructor(private val unionMember0: UnionMember0? = null, private val unionMember1: UnionMember1? = null, private val _json: JsonValue? = null, ) {
                                ...
                                fun validate(): UnnamedSchemaWithArrayParent0 = apply {
                                    if (!validated) {
                                      if (unionMember0 == null && unionMember1 == null) {
                                        throw BraintrustInvalidDataException("Unknown UnnamedSchemaWithArrayParent0: $_json")
                                      }
                                      unionMember0?.validate()
                                      unionMember1?.validate()
                                      validated = true
                                ...
                                override fun toString(): String {
                                  return when {
                                      unionMember0 != null -> "UnnamedSchemaWithArrayParent0{unionMember0=$unionMember0}"
                                      unionMember1 != null -> "UnnamedSchemaWithArrayParent0{unionMember1=$unionMember1}"
                                ...
                                companion object {
                                    ...
                                    fun ofUnionMember0(unionMember0: UnionMember0) = UnnamedSchemaWithArrayParent0(unionMember0 = unionMember0)

                                    fun ofUnionMember1(unionMember1: UnionMember1) = UnnamedSchemaWithArrayParent0(unionMember1 = unionMember1)
                                }
                                ...
                                interface Visitor<out T> {
                                    ...
                                    fun unknown(json: JsonValue?): T {
                                      throw BraintrustInvalidDataException("Unknown UnnamedSchemaWithArrayParent0: $json")
                                    }
                                }

                                class Deserializer : BaseDeserializer<UnnamedSchemaWithArrayParent0>(UnnamedSchemaWithArrayParent0::class) {

                                    override fun ObjectCodec.deserialize(node: JsonNode): UnnamedSchemaWithArrayParent0 {
                                      val json = JsonValue.fromJsonNode(node)
                                      tryDeserialize(node, jacksonTypeRef<UnionMember0>()){ it.validate() }?.let {
                                          return UnnamedSchemaWithArrayParent0(unionMember0 = it, _json = json)
                                      }
                                      tryDeserialize(node, jacksonTypeRef<UnionMember1>()){ it.validate() }?.let {
                                          return UnnamedSchemaWithArrayParent0(unionMember1 = it, _json = json)
                                      }
                                ...
                                class Serializer : BaseSerializer<UnnamedSchemaWithArrayParent0>(UnnamedSchemaWithArrayParent0::class) {

                                    override fun serialize(value: UnnamedSchemaWithArrayParent0, generator: JsonGenerator, provider: SerializerProvider) {
                                      when {
                                          value.unionMember0 != null -> generator.writeObject(value.unionMember0)
                                          value.unionMember1 != null -> generator.writeObject(value.unionMember1)
                                          value._json != null -> generator.writeObject(value._json)
