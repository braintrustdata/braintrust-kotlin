 ...
 * unmodified
 */
class PromptCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(promptCreateParams: PromptCreateParams) =
            apply {
    ...
    override fun toString() = "PromptCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
