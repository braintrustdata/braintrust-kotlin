 ...
 * fields
 */
class GroupReplaceParams private constructor(
     ...
     */
    fun memberGroups(): List<String>? = body.memberGroups()

    /** Ids of users which belong to this group */
    fun memberUsers(): List<String>? = body.memberUsers()
    ...
    class Body @JsonCreator private constructor(
         ...
         * all of their inherited users
         */
        fun memberGroups(): List<String>? = memberGroups.getNullable("member_groups")

        /** Ids of users which belong to this group */
        fun memberUsers(): List<String>? = memberUsers.getNullable("member_users")
    ...
    class Builder internal constructor() {
        ...
        internal fun from(groupReplaceParams: GroupReplaceParams) =
            apply {
    ...
    override fun toString() = "GroupReplaceParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
