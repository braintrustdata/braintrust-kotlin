...
constructor(
    ...
    internal constructor(
        ...
        override fun toString() =
            "ExperimentReplaceBody{projectId=$projectId, baseExpId=$baseExpId, datasetId=$datasetId, datasetVersion=$datasetVersion, description=$description, ensureNew=$ensureNew, metadata=$metadata, name=$name, public_=$public_, repoInfo=$repoInfo, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            internal fun from(experimentReplaceBody: ExperimentReplaceBody) = apply {
                ...
                this.ensureNew = experimentReplaceBody.ensureNew
    ...
    override fun toString() =
        "ExperimentReplaceParams{projectId=$projectId, baseExpId=$baseExpId, datasetId=$datasetId, datasetVersion=$datasetVersion, description=$description, ensureNew=$ensureNew, metadata=$metadata, name=$name, public_=$public_, repoInfo=$repoInfo, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(experimentReplaceParams: ExperimentReplaceParams) = apply {
            ...
            this.ensureNew = experimentReplaceParams.ensureNew
