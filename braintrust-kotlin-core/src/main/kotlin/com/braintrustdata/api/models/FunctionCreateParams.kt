...
class FunctionCreateParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    @NoAutoDetect
    class FunctionCreateBody internal constructor(
      private val functionData: FunctionData?,
      private val name: String?,
      private val projectId: String?,
      private val slug: String?,
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        override fun toString() = "FunctionCreateBody{functionData=$functionData, name=$name, projectId=$projectId, slug=$slug, description=$description, promptData=$promptData, tags=$tags, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            fun build(): FunctionCreateBody = FunctionCreateBody(
    ...
    override fun toString() = "FunctionCreateParams{functionData=$functionData, name=$name, projectId=$projectId, slug=$slug, description=$description, promptData=$promptData, tags=$tags, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        fun build(): FunctionCreateParams = FunctionCreateParams(
            checkNotNull(functionData) {
                "`functionData` is required but was not set"
            },
            checkNotNull(name) {
                  ...
                  private val _json: JsonValue? = null,
                    ...
                    class UnionMember1 private constructor(
                      ...
                      private val additionalProperties: Map<String, JsonValue>,
                        ...
                        class Content private constructor(private val string: String? = null, private val unnamedSchemaWithArrayParent3s: List<UnnamedSchemaWithArrayParent3>? = null, private val _json: JsonValue? = null, ) {

                            private var validated: Boolean = false

                            fun string(): String? = string
                            fun unnamedSchemaWithArrayParent3s(): List<UnnamedSchemaWithArrayParent3>? = unnamedSchemaWithArrayParent3s

                            fun isString(): Boolean = string != null
                            fun isUnnamedSchemaWithArrayParent3s(): Boolean = unnamedSchemaWithArrayParent3s != null

                            fun asString(): String = string.getOrThrow("string")
                            fun asUnnamedSchemaWithArrayParent3s(): List<UnnamedSchemaWithArrayParent3> = unnamedSchemaWithArrayParent3s.getOrThrow("unnamedSchemaWithArrayParent3s")
                            ...
                            fun <T> accept(visitor: Visitor<T>): T {
                              return when {
                                  ...
                                  unnamedSchemaWithArrayParent3s != null -> visitor.visitUnnamedSchemaWithArrayParent3s(unnamedSchemaWithArrayParent3s)
                                  else -> visitor.unknown(_json)
                              }
                            }
                            ...
                            override fun equals(other: Any?): Boolean {
                              ...
                              return other is Content &&
                                  ...
                                  this.unnamedSchemaWithArrayParent3s == other.unnamedSchemaWithArrayParent3s
                            }
                            ...
                            override fun toString(): String {
                              return when {
                                  ...
                                  unnamedSchemaWithArrayParent3s != null -> "Content{unnamedSchemaWithArrayParent3s=$unnamedSchemaWithArrayParent3s}"
                            ...
                            companion object {
                                ...
                                fun ofUnnamedSchemaWithArrayParent3s(unnamedSchemaWithArrayParent3s: List<UnnamedSchemaWithArrayParent3>) = Content(unnamedSchemaWithArrayParent3s = unnamedSchemaWithArrayParent3s)
                            }
                            ...
                            interface Visitor<out T> {
                                ...
                                fun visitUnnamedSchemaWithArrayParent3s(unnamedSchemaWithArrayParent3s: List<UnnamedSchemaWithArrayParent3>): T
                            ...
                            class Deserializer : BaseDeserializer<Content>(Content::class) {
                                ...
                                override fun ObjectCodec.deserialize(node: JsonNode): Content {
                                  ...
                                  tryDeserialize(node, jacksonTypeRef<List<UnnamedSchemaWithArrayParent3>>())?.let {
                                      return Content(unnamedSchemaWithArrayParent3s = it, _json = json)
                                  }
                            ...
                            class Serializer : BaseSerializer<Content>(Content::class) {
                                ...
                                override fun serialize(value: Content, generator: JsonGenerator, provider: SerializerProvider) {
                                  when {
                                      ...
                                      value.unnamedSchemaWithArrayParent3s != null -> generator.writeObject(value.unnamedSchemaWithArrayParent3s)
                                      value._json != null -> generator.writeObject(value._json)
                                      else -> throw IllegalStateException("Invalid Content")
                                  }
                                }
                            ...
                            class UnnamedSchemaWithArrayParent3 private constructor(private val unionMember0: UnionMember0? = null, private val unionMember1: UnionMember1? = null, private val _json: JsonValue? = null, ) {
                                ...
                                fun validate(): UnnamedSchemaWithArrayParent3 = apply {
                                    if (!validated) {
                                      if (unionMember0 == null && unionMember1 == null) {
                                        throw BraintrustInvalidDataException("Unknown UnnamedSchemaWithArrayParent3: $_json")
                                      }
                                      unionMember0?.validate()
                                      unionMember1?.validate()
                                      validated = true
                                ...
                                override fun toString(): String {
                                  return when {
                                      unionMember0 != null -> "UnnamedSchemaWithArrayParent3{unionMember0=$unionMember0}"
                                      unionMember1 != null -> "UnnamedSchemaWithArrayParent3{unionMember1=$unionMember1}"
                                ...
                                companion object {
                                    ...
                                    fun ofUnionMember0(unionMember0: UnionMember0) = UnnamedSchemaWithArrayParent3(unionMember0 = unionMember0)

                                    fun ofUnionMember1(unionMember1: UnionMember1) = UnnamedSchemaWithArrayParent3(unionMember1 = unionMember1)
                                }
                                ...
                                interface Visitor<out T> {
                                    ...
                                    fun unknown(json: JsonValue?): T {
                                      throw BraintrustInvalidDataException("Unknown UnnamedSchemaWithArrayParent3: $json")
                                    }
                                }

                                class Deserializer : BaseDeserializer<UnnamedSchemaWithArrayParent3>(UnnamedSchemaWithArrayParent3::class) {

                                    override fun ObjectCodec.deserialize(node: JsonNode): UnnamedSchemaWithArrayParent3 {
                                      val json = JsonValue.fromJsonNode(node)
                                      tryDeserialize(node, jacksonTypeRef<UnionMember0>()){ it.validate() }?.let {
                                          return UnnamedSchemaWithArrayParent3(unionMember0 = it, _json = json)
                                      }
                                      tryDeserialize(node, jacksonTypeRef<UnionMember1>()){ it.validate() }?.let {
                                          return UnnamedSchemaWithArrayParent3(unionMember1 = it, _json = json)
                                      }
                                ...
                                class Serializer : BaseSerializer<UnnamedSchemaWithArrayParent3>(UnnamedSchemaWithArrayParent3::class) {

                                    override fun serialize(value: UnnamedSchemaWithArrayParent3, generator: JsonGenerator, provider: SerializerProvider) {
                                      when {
                                          value.unionMember0 != null -> generator.writeObject(value.unionMember0)
                                          value.unionMember1 != null -> generator.writeObject(value.unionMember1)
                                          value._json != null -> generator.writeObject(value._json)
