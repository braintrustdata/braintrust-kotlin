...
constructor(
    ...
    class Builder {
        ...
        internal fun from(functionCreateParams: FunctionCreateParams) = apply {
            functionData = functionCreateParams.functionData
            name = functionCreateParams.name
            projectId = functionCreateParams.projectId
            slug = functionCreateParams.slug
            description = functionCreateParams.description
            functionSchema = functionCreateParams.functionSchema
            functionType = functionCreateParams.functionType
            origin = functionCreateParams.origin
            promptData = functionCreateParams.promptData
            tags = functionCreateParams.tags?.toMutableList() ?: mutableListOf()
            ...
            additionalBodyProperties = functionCreateParams.additionalBodyProperties.toMutableMap()
        }
    ...
    private constructor(
        ...
        private constructor(
            ...
            private constructor(
                ...
                private constructor(
                    ...
                    override fun equals(other: Any?): Boolean {
                        ...
                        return /* spotless:off */ other is Bundle && runtimeContext == other.runtimeContext && location == other.location && bundleId == other.bundleId && preview == other.preview && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
                    }

                    /* spotless:off */
                    private val hashCode: Int by lazy { Objects.hash(runtimeContext, location, bundleId, preview, type, additionalProperties) }
                    /* spotless:on */
                ...
                private constructor(
                    ...
                    override fun equals(other: Any?): Boolean {
                        ...
                        return /* spotless:off */ other is Inline && type == other.type && runtimeContext == other.runtimeContext && code == other.code && additionalProperties == other.additionalProperties /* spotless:on */
                    }

                    /* spotless:off */
                    private val hashCode: Int by lazy { Objects.hash(type, runtimeContext, code, additionalProperties) }
                    /* spotless:on */
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return /* spotless:off */ other is Code && type == other.type && data == other.data && additionalProperties == other.additionalProperties /* spotless:on */
            }

            /* spotless:off */
            private val hashCode: Int by lazy { Objects.hash(type, data, additionalProperties) }
            /* spotless:on */
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Origin && objectType == other.objectType && objectId == other.objectId && internal_ == other.internal_ && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(objectType, objectId, internal_, additionalProperties) }
        /* spotless:on */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is FunctionCreateParams && functionData == other.functionData && name == other.name && projectId == other.projectId && slug == other.slug && description == other.description && functionSchema == other.functionSchema && functionType == other.functionType && origin == other.origin && promptData == other.promptData && tags == other.tags && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams && additionalBodyProperties == other.additionalBodyProperties /* spotless:on */
    }
