...
private constructor(
    private val body: FunctionCreateBody,
    ...
    fun functionSchema(): FunctionSchema? = body.functionSchema()

    fun functionType(): FunctionType? = body.functionType()

    fun origin(): Origin? = body.origin()
    ...
    internal fun _body(): FunctionCreateBody = body
    ...
    internal constructor(
        ...
        fun validate(): FunctionCreateBody = apply {
            if (validated) {
                return@apply
            }
        ...
        /** A builder for [FunctionCreateBody]. */
        class Builder internal constructor() {
            ...
            internal fun from(functionCreateBody: FunctionCreateBody) = apply {
                functionData = functionCreateBody.functionData
                name = functionCreateBody.name
                projectId = functionCreateBody.projectId
                slug = functionCreateBody.slug
                description = functionCreateBody.description
                functionSchema = functionCreateBody.functionSchema
                functionType = functionCreateBody.functionType
                origin = functionCreateBody.origin
                promptData = functionCreateBody.promptData
                tags = functionCreateBody.tags.map { it.toMutableList() }
                additionalProperties = functionCreateBody.additionalProperties.toMutableMap()
            }
    ...
    class Builder internal constructor() {
        ...
        private var body: FunctionCreateBody.Builder = FunctionCreateBody.builder()
