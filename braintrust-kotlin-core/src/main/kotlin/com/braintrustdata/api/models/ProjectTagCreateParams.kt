...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ProjectTagCreateParams].
         *
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [ProjectTagCreateParams].
         *
    ...
    private constructor(
        ...
        private val hashCode: Int by lazy {
            Objects.hash(name, projectId, color, description, additionalProperties)
        }
