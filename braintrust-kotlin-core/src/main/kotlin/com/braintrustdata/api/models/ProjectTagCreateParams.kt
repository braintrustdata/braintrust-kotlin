...
class ProjectTagCreateParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    @NoAutoDetect
    class ProjectTagCreateBody internal constructor(
      private val name: String?,
      private val projectId: String?,
      private val color: String?,
      private val description: String?,
      private val additionalProperties: Map<String, JsonValue>,
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is ProjectTagCreateBody &&
        ...
        override fun toString() = "ProjectTagCreateBody{name=$name, projectId=$projectId, color=$color, description=$description, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            fun build(): ProjectTagCreateBody = ProjectTagCreateBody(
                checkNotNull(name) {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ProjectTagCreateParams &&
          this.name == other.name &&
          this.projectId == other.projectId &&
          this.color == other.color &&
          this.description == other.description &&
    ...
    override fun toString() = "ProjectTagCreateParams{name=$name, projectId=$projectId, color=$color, description=$description, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        fun build(): ProjectTagCreateParams = ProjectTagCreateParams(
            checkNotNull(name) {
                "`name` is required but was not set"
            },
            checkNotNull(projectId) {
