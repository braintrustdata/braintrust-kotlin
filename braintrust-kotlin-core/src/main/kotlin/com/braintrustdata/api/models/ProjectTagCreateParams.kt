 ...
 */
class ProjectTagCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(projectTagCreateParams: ProjectTagCreateParams) =
            apply {
    ...
    override fun toString() = "ProjectTagCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
