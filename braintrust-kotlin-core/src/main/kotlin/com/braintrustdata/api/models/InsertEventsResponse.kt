...
@NoAutoDetect
class InsertEventsResponse private constructor(private val rowIds: JsonField<List<String>>, private val additionalProperties: Map<String, JsonValue>, ) {
    ...
    class Builder {
        ...
        fun build(): InsertEventsResponse = InsertEventsResponse(rowIds.map { it.toUnmodifiable() }, additionalProperties.toUnmodifiable())
    }
}
