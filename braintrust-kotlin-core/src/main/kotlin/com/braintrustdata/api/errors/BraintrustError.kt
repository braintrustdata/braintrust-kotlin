...
@NoAutoDetect
class BraintrustError @JsonCreator private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BraintrustError]. */
        fun builder() = Builder()
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(braintrustError: BraintrustError) =
            apply {
