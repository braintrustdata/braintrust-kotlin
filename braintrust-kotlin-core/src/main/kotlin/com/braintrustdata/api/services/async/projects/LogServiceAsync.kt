...
interface LogServiceAsync {
    ...
    suspend fun feedback(params: ProjectLogFeedbackParams, requestOptions: RequestOptions = RequestOptions.none())
     ...
     */
    suspend fun fetch(params: ProjectLogFetchParams, requestOptions: RequestOptions = RequestOptions.none()): ProjectLogFetchResponse
     ...
     */
    suspend fun fetchPost(params: ProjectLogFetchPostParams, requestOptions: RequestOptions = RequestOptions.none()): ProjectLogFetchPostResponse

    /** Insert a set of events into the project logs */
    suspend fun insert(params: ProjectLogInsertParams, requestOptions: RequestOptions = RequestOptions.none()): ProjectLogInsertResponse
}
