...
class LogServiceImpl constructor(private val clientOptions: ClientOptions, ) : LogService {
    ...
    override fun feedback(params: ProjectLogFeedbackParams, requestOptions: RequestOptions): FeedbackResponseSchema {
     ...
     */
    override fun fetch(params: ProjectLogFetchParams, requestOptions: RequestOptions): FetchProjectLogsEventsResponse {
      val request = HttpRequest.builder()
     ...
     */
    override fun fetchPost(params: ProjectLogFetchPostParams, requestOptions: RequestOptions): FetchProjectLogsEventsResponse {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
        .addPathSegments("v1", "project_logs", params.getPathParam(0), "fetch")
        .putAllQueryParams(clientOptions.queryParams)
    ...
    override fun insert(params: ProjectLogInsertParams, requestOptions: RequestOptions): InsertEventsResponse {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
