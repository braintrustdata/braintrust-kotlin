...
class RoleServiceImpl internal constructor(
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: RoleCreateParams, requestOptions: RequestOptions): HttpResponseFor<Role> {
        ...
        override fun retrieve(params: RoleRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<Role> {
          val request = HttpRequest.builder()
        ...
        override fun update(params: RoleUpdateParams, requestOptions: RequestOptions): HttpResponseFor<Role> {
          val request = HttpRequest.builder()
        ...
        private val listHandler: Handler<RoleListPage.Response> = jsonHandler<RoleListPage.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override fun list(params: RoleListParams, requestOptions: RequestOptions): HttpResponseFor<RoleListPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("v1", "role")
            .build()
          ...
          return response.parseable {
              ...
              .let {
                  RoleListPage.of(RoleServiceImpl(clientOptions), params, it)
              }
          }
        }
        ...
        override fun delete(params: RoleDeleteParams, requestOptions: RequestOptions): HttpResponseFor<Role> {
          val request = HttpRequest.builder()
        ...
        override fun replace(params: RoleReplaceParams, requestOptions: RequestOptions): HttpResponseFor<Role> {
          val request = HttpRequest.builder()
