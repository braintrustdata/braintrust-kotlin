...
interface ApiKeyResourceServiceAsync {
     ...
     */
    suspend fun create(params: ApiKeyResourceCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CreateApiKeyOutput

    /** Get an api_key object by its id */
    suspend fun retrieve(params: ApiKeyResourceRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): ApiKey

    /**
     * List out all api_keys. The api_keys are sorted by creation date, with the most
     * recently-created api_keys coming first
     */
    suspend fun list(params: ApiKeyResourceListParams, requestOptions: RequestOptions = RequestOptions.none()): ApiKeyResourceListPageAsync

    /** Delete an api_key object by its id */
    suspend fun delete(params: ApiKeyResourceDeleteParams, requestOptions: RequestOptions = RequestOptions.none()): ApiKey
}
