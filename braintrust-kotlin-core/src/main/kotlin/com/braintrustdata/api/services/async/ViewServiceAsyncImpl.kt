...
class ViewServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : ViewServiceAsync {

    private val errorHandler: Handler<BraintrustError> = errorHandler(clientOptions.jsonMapper)

    private val createHandler: Handler<View> =
    jsonHandler<View>(clientOptions.jsonMapper)
    ...
    override suspend fun list(params: ViewListParams, requestOptions: RequestOptions): ViewListPageAsync {
      ...
      .let { response -> 
          ...
          .let {
              ViewListPageAsync.of(this, params, it)
          }
      }
    }
