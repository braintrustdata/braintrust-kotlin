...
class ApiKeyServiceImpl constructor(private val clientOptions: ClientOptions, ) : ApiKeyService {
     ...
     */
    override fun create(params: ApiKeyCreateParams, requestOptions: RequestOptions): ApiKeyCreateResponse {
    ...
    override fun list(params: ApiKeyListParams, requestOptions: RequestOptions): ApiKeyListPage {
      ...
      .let { response -> 
          ...
          .let {
              ApiKeyListPage.of(this, params, it)
          }
      }
    }
