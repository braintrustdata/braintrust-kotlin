...
class ProjectScoreServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : ProjectScoreServiceAsync {
    ...
    override suspend fun list(params: ProjectScoreListParams, requestOptions: RequestOptions): ProjectScoreListPageAsync {
      ...
      .let { response -> 
          ...
          .let {
              ProjectScoreListPageAsync.of(this, params, it)
          }
      }
    }
