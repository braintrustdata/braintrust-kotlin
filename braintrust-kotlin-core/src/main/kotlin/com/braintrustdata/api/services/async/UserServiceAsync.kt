...
interface UserServiceAsync {
     ...
     */
    suspend fun list(params: UserListParams = UserListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): UserListPageAsync

    /** @see [list] */
    suspend fun list(requestOptions: RequestOptions): UserListPageAsync = list(UserListParams.none(), requestOptions)
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        suspend fun retrieve(params: UserRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<User>
         ...
         */
        @MustBeClosed
        suspend fun list(params: UserListParams = UserListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<UserListPageAsync>

        /** @see [list] */
        @MustBeClosed
        suspend fun list(requestOptions: RequestOptions): HttpResponseFor<UserListPageAsync> = list(UserListParams.none(), requestOptions)
    }
}
