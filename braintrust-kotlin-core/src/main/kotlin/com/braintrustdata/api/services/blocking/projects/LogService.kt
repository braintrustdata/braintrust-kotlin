...
interface LogService {
    ...
    fun feedback(params: ProjectLogFeedbackParams, requestOptions: RequestOptions = RequestOptions.none()): FeedbackResponseSchema
     ...
     */
    fun fetch(params: ProjectLogFetchParams, requestOptions: RequestOptions = RequestOptions.none()): FetchProjectLogsEventsResponse
     ...
     */
    fun fetchPost(params: ProjectLogFetchPostParams, requestOptions: RequestOptions = RequestOptions.none()): FetchProjectLogsEventsResponse

    /** Insert a set of events into the project logs */
    fun insert(params: ProjectLogInsertParams, requestOptions: RequestOptions = RequestOptions.none()): InsertEventsResponse

    /**
     * A view of [LogService] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * but is otherwise the same as [LogService.feedback].
         */
        @MustBeClosed
        fun feedback(params: ProjectLogFeedbackParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<FeedbackResponseSchema>

        /**
         * Returns a raw HTTP response for `get /v1/project_logs/{project_id}/fetch`, but
         * is otherwise the same as [LogService.fetch].
         */
        @MustBeClosed
        fun fetch(params: ProjectLogFetchParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<FetchProjectLogsEventsResponse>

        /**
         * Returns a raw HTTP response for `post /v1/project_logs/{project_id}/fetch`, but
         * is otherwise the same as [LogService.fetchPost].
         */
        @MustBeClosed
        fun fetchPost(params: ProjectLogFetchPostParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<FetchProjectLogsEventsResponse>

        /**
         * Returns a raw HTTP response for `post /v1/project_logs/{project_id}/insert`, but
         * is otherwise the same as [LogService.insert].
         */
        @MustBeClosed
        fun insert(params: ProjectLogInsertParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<InsertEventsResponse>
    }
}
