...
class TopLevelServiceAsyncImpl internal constructor(
    ...
    override suspend fun helloWorld(params: TopLevelHelloWorldParams, requestOptions: RequestOptions): String =
        // get /v1
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun helloWorld(params: TopLevelHelloWorldParams, requestOptions: RequestOptions): HttpResponseFor<String> {
