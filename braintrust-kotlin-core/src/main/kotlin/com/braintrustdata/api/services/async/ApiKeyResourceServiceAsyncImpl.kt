...
class ApiKeyResourceServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : ApiKeyResourceServiceAsync {
     ...
     */
    override suspend fun create(params: ApiKeyResourceCreateParams, requestOptions: RequestOptions): CreateApiKeyOutput {
    ...
    override suspend fun retrieve(params: ApiKeyResourceRetrieveParams, requestOptions: RequestOptions): ApiKey {
      val request = HttpRequest.builder()
     ...
     */
    override suspend fun list(params: ApiKeyResourceListParams, requestOptions: RequestOptions): ApiKeyResourceListPageAsync {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
        .addPathSegments("v1", "api_key")
        .putAllQueryParams(clientOptions.queryParams)
      ...
      .let { response -> 
          ...
          .let {
              ApiKeyResourceListPageAsync.of(this, params, it)
          }
      }
    }
    ...
    override suspend fun delete(params: ApiKeyResourceDeleteParams, requestOptions: RequestOptions): ApiKey {
      val request = HttpRequest.builder()
