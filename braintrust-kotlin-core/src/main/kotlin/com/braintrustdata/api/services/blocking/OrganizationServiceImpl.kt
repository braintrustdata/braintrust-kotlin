...
class OrganizationServiceImpl internal constructor(
    ...
    override fun retrieve(params: OrganizationRetrieveParams, requestOptions: RequestOptions): Organization =
    ...
    override fun delete(params: OrganizationDeleteParams, requestOptions: RequestOptions): Organization =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val members: MemberService.WithRawResponse by lazy { MemberServiceImpl.WithRawResponseImpl(clientOptions) }
        ...
        override fun retrieve(params: OrganizationRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<Organization> {
        ...
        private val listHandler: Handler<OrganizationListPage.Response> = jsonHandler<OrganizationListPage.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)
        ...
        override fun delete(params: OrganizationDeleteParams, requestOptions: RequestOptions): HttpResponseFor<Organization> {
          val request = HttpRequest.builder()
