...
interface SpanIframeServiceAsync {
     ...
     * unmodified
     */
    suspend fun create(params: SpanIframeCreateParams, requestOptions: RequestOptions = RequestOptions.none()): SpanIFrame

    /** Get a span_iframe object by its id */
    suspend fun retrieve(params: SpanIframeRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): SpanIFrame
     ...
     */
    suspend fun update(params: SpanIframeUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): SpanIFrame
     ...
     */
    suspend fun list(params: SpanIframeListParams = SpanIframeListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): SpanIframeListPageAsync

    /** @see [list] */
    suspend fun list(requestOptions: RequestOptions): SpanIframeListPageAsync = list(SpanIframeListParams.none(), requestOptions)

    /** Delete a span_iframe object by its id */
    suspend fun delete(params: SpanIframeDeleteParams, requestOptions: RequestOptions = RequestOptions.none()): SpanIFrame
     ...
     */
    suspend fun replace(params: SpanIframeReplaceParams, requestOptions: RequestOptions = RequestOptions.none()): SpanIFrame
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        suspend fun create(params: SpanIframeCreateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SpanIFrame>
         ...
         */
        @MustBeClosed
        suspend fun retrieve(params: SpanIframeRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SpanIFrame>
         ...
         */
        @MustBeClosed
        suspend fun update(params: SpanIframeUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SpanIFrame>
         ...
         */
        @MustBeClosed
        suspend fun list(params: SpanIframeListParams = SpanIframeListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SpanIframeListPageAsync>

        /** @see [list] */
        @MustBeClosed
        suspend fun list(requestOptions: RequestOptions): HttpResponseFor<SpanIframeListPageAsync> = list(SpanIframeListParams.none(), requestOptions)
         ...
         */
        @MustBeClosed
        suspend fun delete(params: SpanIframeDeleteParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SpanIFrame>
         ...
         */
        @MustBeClosed
        suspend fun replace(params: SpanIframeReplaceParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SpanIFrame>
    }
}
