...
class ApiKeyServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : ApiKeyServiceAsync {
     ...
     */
    override suspend fun create(params: ApiKeyCreateParams, requestOptions: RequestOptions): ApiKeyCreateResponse {
    ...
    override suspend fun list(params: ApiKeyListParams, requestOptions: RequestOptions): ApiKeyListPageAsync {
      ...
      .let { response -> 
          ...
          .let {
              ApiKeyListPageAsync.of(this, params, it)
          }
      }
    }
