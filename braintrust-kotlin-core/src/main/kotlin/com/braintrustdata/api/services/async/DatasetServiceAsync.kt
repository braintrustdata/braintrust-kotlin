...
interface DatasetServiceAsync {
     ...
     */
    suspend fun list(params: DatasetListParams = DatasetListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): DatasetListPageAsync

    /** @see [list] */
    suspend fun list(requestOptions: RequestOptions): DatasetListPageAsync = list(DatasetListParams.none(), requestOptions)
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        suspend fun create(params: DatasetCreateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Dataset>
         ...
         */
        @MustBeClosed
        suspend fun retrieve(params: DatasetRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Dataset>
         ...
         */
        @MustBeClosed
        suspend fun update(params: DatasetUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Dataset>
         ...
         */
        @MustBeClosed
        suspend fun list(params: DatasetListParams = DatasetListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<DatasetListPageAsync>

        /** @see [list] */
        @MustBeClosed
        suspend fun list(requestOptions: RequestOptions): HttpResponseFor<DatasetListPageAsync> = list(DatasetListParams.none(), requestOptions)
         ...
         */
        @MustBeClosed
        suspend fun delete(params: DatasetDeleteParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Dataset>
         ...
         */
        @MustBeClosed
        suspend fun feedback(params: DatasetFeedbackParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<FeedbackResponseSchema>
         ...
         */
        @MustBeClosed
        suspend fun fetch(params: DatasetFetchParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<FetchDatasetEventsResponse>
         ...
         */
        @MustBeClosed
        suspend fun fetchPost(params: DatasetFetchPostParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<FetchDatasetEventsResponse>
         ...
         */
        @MustBeClosed
        suspend fun insert(params: DatasetInsertParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<InsertEventsResponse>
         ...
         */
        @MustBeClosed
        suspend fun summarize(params: DatasetSummarizeParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SummarizeDatasetResponse>
    }
}
