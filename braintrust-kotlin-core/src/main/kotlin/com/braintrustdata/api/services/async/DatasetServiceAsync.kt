...
interface DatasetServiceAsync {
    ...
    suspend fun feedback(params: DatasetFeedbackParams, requestOptions: RequestOptions = RequestOptions.none())
     ...
     */
    suspend fun fetch(params: DatasetFetchParams, requestOptions: RequestOptions = RequestOptions.none()): DatasetFetchResponse
     ...
     */
    suspend fun fetchPost(params: DatasetFetchPostParams, requestOptions: RequestOptions = RequestOptions.none()): DatasetFetchPostResponse

    /** Insert a set of events into the dataset */
    suspend fun insert(params: DatasetInsertParams, requestOptions: RequestOptions = RequestOptions.none()): DatasetInsertResponse

    /** Summarize dataset */
    suspend fun summarize(params: DatasetSummarizeParams, requestOptions: RequestOptions = RequestOptions.none()): DatasetSummarizeResponse
}
