...
class DatasetServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : DatasetServiceAsync {
    ...
    override suspend fun list(params: DatasetListParams, requestOptions: RequestOptions): DatasetListPageAsync {
      ...
      .let { response -> 
          ...
          .let {
              DatasetListPageAsync.of(this, params, it)
          }
      }
    }
    ...
    override suspend fun feedback(params: DatasetFeedbackParams, requestOptions: RequestOptions) {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
    ...
    jsonHandler<DatasetFetchResponse>(clientOptions.jsonMapper)
    .withErrorHandler(errorHandler)
     ...
     */
    override suspend fun fetch(params: DatasetFetchParams, requestOptions: RequestOptions): DatasetFetchResponse {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
     ...
     */
    override suspend fun fetchPost(params: DatasetFetchPostParams, requestOptions: RequestOptions): DatasetFetchPostResponse {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
        .addPathSegments("v1", "dataset", params.getPathParam(0), "fetch")
        .putAllQueryParams(clientOptions.queryParams)
    ...
    jsonHandler<DatasetInsertResponse>(clientOptions.jsonMapper)
    .withErrorHandler(errorHandler)

    /** Insert a set of events into the dataset */
    override suspend fun insert(params: DatasetInsertParams, requestOptions: RequestOptions): DatasetInsertResponse {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
    ...
    /** Summarize dataset */
    override suspend fun summarize(params: DatasetSummarizeParams, requestOptions: RequestOptions): DatasetSummarizeResponse {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
