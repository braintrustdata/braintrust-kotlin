...
class OrgSecretServiceImpl constructor(private val clientOptions: ClientOptions, ) : OrgSecretService {
    ...
    override fun retrieve(params: OrgSecretRetrieveParams, requestOptions: RequestOptions): OrgSecret {
      val request = HttpRequest.builder()
     ...
     */
    override fun list(params: OrgSecretListParams, requestOptions: RequestOptions): OrgSecretListPage {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
        .addPathSegments("v1", "org_secret")
        .putAllQueryParams(clientOptions.queryParams)
      ...
      .let { response -> 
          ...
          .let {
              OrgSecretListPage.of(this, params, it)
          }
      }
    }
     ...
     */
    override fun replace(params: OrgSecretReplaceParams, requestOptions: RequestOptions): OrgSecret {
      val request = HttpRequest.builder()
