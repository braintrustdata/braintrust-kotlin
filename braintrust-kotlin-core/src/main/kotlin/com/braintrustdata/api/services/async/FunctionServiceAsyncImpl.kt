...
class FunctionServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : FunctionServiceAsync {

    private val withRawResponse: FunctionServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    override suspend fun invoke(params: FunctionInvokeParams, requestOptions: RequestOptions): FunctionInvokeResponse? =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun create(params: FunctionCreateParams, requestOptions: RequestOptions): HttpResponseFor<Function> {
        ...
        override suspend fun retrieve(params: FunctionRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<Function> {
          val request = HttpRequest.builder()
        ...
        override suspend fun update(params: FunctionUpdateParams, requestOptions: RequestOptions): HttpResponseFor<Function> {
          val request = HttpRequest.builder()
        ...
        private val listHandler: Handler<FunctionListPageAsync.Response> = jsonHandler<FunctionListPageAsync.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override suspend fun list(params: FunctionListParams, requestOptions: RequestOptions): HttpResponseFor<FunctionListPageAsync> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("v1", "function")
            .build()
          ...
          return response.parseable {
              ...
              .let {
                  FunctionListPageAsync.of(FunctionServiceAsyncImpl(clientOptions), params, it)
              }
          }
        }
        ...
        override suspend fun delete(params: FunctionDeleteParams, requestOptions: RequestOptions): HttpResponseFor<Function> {
          val request = HttpRequest.builder()
        ...
        private val invokeHandler: Handler<FunctionInvokeResponse?> = jsonHandler<FunctionInvokeResponse?>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override suspend fun invoke(params: FunctionInvokeParams, requestOptions: RequestOptions): HttpResponseFor<FunctionInvokeResponse?> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override suspend fun replace(params: FunctionReplaceParams, requestOptions: RequestOptions): HttpResponseFor<Function> {
          val request = HttpRequest.builder()
