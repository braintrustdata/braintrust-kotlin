...
class ApiKeyResourceServiceImpl constructor(private val clientOptions: ClientOptions, ) : ApiKeyResourceService {
     ...
     */
    override fun create(params: ApiKeyResourceCreateParams, requestOptions: RequestOptions): CreateApiKeyOutput {
    ...
    jsonHandler<ApiKey>(clientOptions.jsonMapper)
    .withErrorHandler(errorHandler)

    /** Get an api_key object by its id */
    override fun retrieve(params: ApiKeyResourceRetrieveParams, requestOptions: RequestOptions): ApiKey {
      val request = HttpRequest.builder()
    ...
    private val listHandler: Handler<ApiKeyResourceListPage.Response> =
    jsonHandler<ApiKeyResourceListPage.Response>(clientOptions.jsonMapper)
    .withErrorHandler(errorHandler)
     ...
     */
    override fun list(params: ApiKeyResourceListParams, requestOptions: RequestOptions): ApiKeyResourceListPage {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
        .addPathSegments("v1", "api_key")
        .putAllQueryParams(clientOptions.queryParams)
      ...
      .let { response -> 
          ...
          .let {
              ApiKeyResourceListPage.of(this, params, it)
          }
      }
    }
    ...
    override fun delete(params: ApiKeyResourceDeleteParams, requestOptions: RequestOptions): ApiKey {
      val request = HttpRequest.builder()
