...
class RoleServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : RoleServiceAsync {

    private val errorHandler: Handler<BraintrustError> = errorHandler(clientOptions.jsonMapper)

    private val createHandler: Handler<Role> =
    jsonHandler<Role>(clientOptions.jsonMapper)
    ...
    override suspend fun list(params: RoleListParams, requestOptions: RequestOptions): RoleListPageAsync {
      ...
      .let { response -> 
          ...
          .let {
              RoleListPageAsync.of(this, params, it)
          }
      }
    }
