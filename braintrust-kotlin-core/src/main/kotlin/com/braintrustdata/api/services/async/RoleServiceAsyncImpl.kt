...
class RoleServiceAsyncImpl internal constructor(
    ...
    override suspend fun retrieve(params: RoleRetrieveParams, requestOptions: RequestOptions): Role =
        // get /v1/role/{role_id}
    ...
    override suspend fun list(params: RoleListParams, requestOptions: RequestOptions): RoleListPageAsync =
        // get /v1/role
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun create(params: RoleCreateParams, requestOptions: RequestOptions): HttpResponseFor<Role> {
        ...
        override suspend fun retrieve(params: RoleRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<Role> {
          val request = HttpRequest.builder()
        ...
        override suspend fun update(params: RoleUpdateParams, requestOptions: RequestOptions): HttpResponseFor<Role> {
          val request = HttpRequest.builder()
        ...
        override suspend fun list(params: RoleListParams, requestOptions: RequestOptions): HttpResponseFor<RoleListPageAsync> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("v1", "role")
            .build()
        ...
        override suspend fun delete(params: RoleDeleteParams, requestOptions: RequestOptions): HttpResponseFor<Role> {
          val request = HttpRequest.builder()
        ...
        override suspend fun replace(params: RoleReplaceParams, requestOptions: RequestOptions): HttpResponseFor<Role> {
          val request = HttpRequest.builder()
