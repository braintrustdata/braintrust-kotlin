...
class ExperimentServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : ExperimentServiceAsync {

    private val withRawResponse: ExperimentServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): ExperimentServiceAsync.WithRawResponse = withRawResponse

    override suspend fun create(params: ExperimentCreateParams, requestOptions: RequestOptions): Experiment =
        // post /v1/experiment
        withRawResponse().create(params, requestOptions).parse()

    override suspend fun retrieve(params: ExperimentRetrieveParams, requestOptions: RequestOptions): Experiment =
        // get /v1/experiment/{experiment_id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override suspend fun update(params: ExperimentUpdateParams, requestOptions: RequestOptions): Experiment =
        // patch /v1/experiment/{experiment_id}
        withRawResponse().update(params, requestOptions).parse()

    override suspend fun list(params: ExperimentListParams, requestOptions: RequestOptions): ExperimentListPageAsync =
        // get /v1/experiment
        withRawResponse().list(params, requestOptions).parse()

    override suspend fun delete(params: ExperimentDeleteParams, requestOptions: RequestOptions): Experiment =
        // delete /v1/experiment/{experiment_id}
        withRawResponse().delete(params, requestOptions).parse()

    override suspend fun feedback(params: ExperimentFeedbackParams, requestOptions: RequestOptions): FeedbackResponseSchema =
        // post /v1/experiment/{experiment_id}/feedback
        withRawResponse().feedback(params, requestOptions).parse()

    override suspend fun fetch(params: ExperimentFetchParams, requestOptions: RequestOptions): FetchExperimentEventsResponse =
        // get /v1/experiment/{experiment_id}/fetch
        withRawResponse().fetch(params, requestOptions).parse()

    override suspend fun fetchPost(params: ExperimentFetchPostParams, requestOptions: RequestOptions): FetchExperimentEventsResponse =
        // post /v1/experiment/{experiment_id}/fetch
        withRawResponse().fetchPost(params, requestOptions).parse()

    override suspend fun insert(params: ExperimentInsertParams, requestOptions: RequestOptions): InsertEventsResponse =
        // post /v1/experiment/{experiment_id}/insert
        withRawResponse().insert(params, requestOptions).parse()

    override suspend fun summarize(params: ExperimentSummarizeParams, requestOptions: RequestOptions): SummarizeExperimentResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun create(params: ExperimentCreateParams, requestOptions: RequestOptions): HttpResponseFor<Experiment> {
        ...
        override suspend fun retrieve(params: ExperimentRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<Experiment> {
          val request = HttpRequest.builder()
        ...
        override suspend fun update(params: ExperimentUpdateParams, requestOptions: RequestOptions): HttpResponseFor<Experiment> {
          val request = HttpRequest.builder()
        ...
        private val listHandler: Handler<ExperimentListPageAsync.Response> = jsonHandler<ExperimentListPageAsync.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override suspend fun list(params: ExperimentListParams, requestOptions: RequestOptions): HttpResponseFor<ExperimentListPageAsync> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("v1", "experiment")
            .build()
          ...
          return response.parseable {
              ...
              .let {
                  ExperimentListPageAsync.of(ExperimentServiceAsyncImpl(clientOptions), params, it)
              }
          }
        }
        ...
        override suspend fun delete(params: ExperimentDeleteParams, requestOptions: RequestOptions): HttpResponseFor<Experiment> {
          val request = HttpRequest.builder()
        ...
        override suspend fun feedback(params: ExperimentFeedbackParams, requestOptions: RequestOptions): HttpResponseFor<FeedbackResponseSchema> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override suspend fun fetch(params: ExperimentFetchParams, requestOptions: RequestOptions): HttpResponseFor<FetchExperimentEventsResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override suspend fun fetchPost(params: ExperimentFetchPostParams, requestOptions: RequestOptions): HttpResponseFor<FetchExperimentEventsResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .addPathSegments("v1", "experiment", params.getPathParam(0), "fetch")
            .body(json(clientOptions.jsonMapper, params._body()))
        ...
        override suspend fun insert(params: ExperimentInsertParams, requestOptions: RequestOptions): HttpResponseFor<InsertEventsResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override suspend fun summarize(params: ExperimentSummarizeParams, requestOptions: RequestOptions): HttpResponseFor<SummarizeExperimentResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
