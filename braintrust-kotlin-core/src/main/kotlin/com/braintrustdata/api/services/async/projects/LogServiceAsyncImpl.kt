...
class LogServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : LogServiceAsync {

    private val withRawResponse: LogServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun feedback(params: ProjectLogFeedbackParams, requestOptions: RequestOptions): HttpResponseFor<FeedbackResponseSchema> {
        ...
        private val fetchHandler: Handler<FetchProjectLogsEventsResponse> = jsonHandler<FetchProjectLogsEventsResponse>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override suspend fun fetch(params: ProjectLogFetchParams, requestOptions: RequestOptions): HttpResponseFor<FetchProjectLogsEventsResponse> {
          val request = HttpRequest.builder()
        ...
        private val fetchPostHandler: Handler<FetchProjectLogsEventsResponse> = jsonHandler<FetchProjectLogsEventsResponse>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override suspend fun fetchPost(params: ProjectLogFetchPostParams, requestOptions: RequestOptions): HttpResponseFor<FetchProjectLogsEventsResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .addPathSegments("v1", "project_logs", params.getPathParam(0), "fetch")
            .body(json(clientOptions.jsonMapper, params._body()))
        ...
        override suspend fun insert(params: ProjectLogInsertParams, requestOptions: RequestOptions): HttpResponseFor<InsertEventsResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
