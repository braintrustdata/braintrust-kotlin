...
class LogServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : LogServiceAsync {
    ...
    override suspend fun feedback(params: ProjectLogFeedbackParams, requestOptions: RequestOptions) {
     ...
     */
    override suspend fun fetch(params: ProjectLogFetchParams, requestOptions: RequestOptions): ProjectLogFetchResponse {
      val request = HttpRequest.builder()
     ...
     */
    override suspend fun fetchPost(params: ProjectLogFetchPostParams, requestOptions: RequestOptions): ProjectLogFetchPostResponse {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
        .addPathSegments("v1", "project_logs", params.getPathParam(0), "fetch")
        .putAllQueryParams(clientOptions.queryParams)
    ...
    override suspend fun insert(params: ProjectLogInsertParams, requestOptions: RequestOptions): ProjectLogInsertResponse {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
