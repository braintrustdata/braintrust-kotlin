...
class ExperimentServiceImpl constructor(private val clientOptions: ClientOptions, ) : ExperimentService {
    ...
    override fun list(params: ExperimentListParams, requestOptions: RequestOptions): ExperimentListPage {
      ...
      .let { response -> 
          ...
          .let {
              ExperimentListPage.of(this, params, it)
          }
      }
    }
     ...
     */
    override fun fetch(params: ExperimentFetchParams, requestOptions: RequestOptions): ExperimentFetchResponse {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
     ...
     */
    override fun fetchPost(params: ExperimentFetchPostParams, requestOptions: RequestOptions): ExperimentFetchPostResponse {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
        .addPathSegments("v1", "experiment", params.getPathParam(0), "fetch")
        .putAllQueryParams(clientOptions.queryParams)
    ...
    override fun insert(params: ExperimentInsertParams, requestOptions: RequestOptions): ExperimentInsertResponse {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
    ...
    override fun summarize(params: ExperimentSummarizeParams, requestOptions: RequestOptions): ExperimentSummarizeResponse {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
