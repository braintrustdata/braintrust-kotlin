...
class DatasetServiceImpl constructor(private val clientOptions: ClientOptions, ) : DatasetService {
    ...
    override fun list(params: DatasetListParams, requestOptions: RequestOptions): DatasetListPage {
      ...
      .let { response -> 
          ...
          .let {
              DatasetListPage.of(this, params, it)
          }
      }
    }
     ...
     */
    override fun fetch(params: DatasetFetchParams, requestOptions: RequestOptions): DatasetFetchResponse {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
     ...
     */
    override fun fetchPost(params: DatasetFetchPostParams, requestOptions: RequestOptions): DatasetFetchPostResponse {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
        .addPathSegments("v1", "dataset", params.getPathParam(0), "fetch")
        .putAllQueryParams(clientOptions.queryParams)
    ...
    override fun insert(params: DatasetInsertParams, requestOptions: RequestOptions): DatasetInsertResponse {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
    ...
    /** Summarize dataset */
    override fun summarize(params: DatasetSummarizeParams, requestOptions: RequestOptions): DatasetSummarizeResponse {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
