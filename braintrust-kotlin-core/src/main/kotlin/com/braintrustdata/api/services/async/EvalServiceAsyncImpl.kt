...
class EvalServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : EvalServiceAsync {

    private val withRawResponse: EvalServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): EvalServiceAsync.WithRawResponse = withRawResponse

    override suspend fun create(params: EvalCreateParams, requestOptions: RequestOptions): SummarizeExperimentResponse =
        // post /v1/eval
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun create(params: EvalCreateParams, requestOptions: RequestOptions): HttpResponseFor<SummarizeExperimentResponse> {
