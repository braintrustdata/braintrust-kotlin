...
class FunctionServiceImpl internal constructor(
    ...
    override fun invoke(params: FunctionInvokeParams, requestOptions: RequestOptions): FunctionInvokeResponse? =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun invoke(params: FunctionInvokeParams, requestOptions: RequestOptions): HttpResponseFor<FunctionInvokeResponse?> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
