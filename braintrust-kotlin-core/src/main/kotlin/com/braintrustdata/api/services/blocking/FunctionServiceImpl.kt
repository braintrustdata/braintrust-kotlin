...
class FunctionServiceImpl constructor(private val clientOptions: ClientOptions, ) : FunctionService {
    ...
    override fun list(params: FunctionListParams, requestOptions: RequestOptions): FunctionListPage {
      ...
      .let { response -> 
          ...
          .let {
              FunctionListPage.of(this, params, it)
          }
      }
    }
    ...
    override fun feedback(params: FunctionFeedbackParams, requestOptions: RequestOptions) {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
