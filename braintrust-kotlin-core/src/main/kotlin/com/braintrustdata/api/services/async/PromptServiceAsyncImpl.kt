...
class PromptServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): PromptServiceAsync =
        PromptServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override suspend fun retrieve(
            ...
            checkRequired("promptId", params.promptId())
            val request =
                HttpRequest.builder()
