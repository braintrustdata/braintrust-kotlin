...
dependencies {
    testImplementation(project(":braintrust-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../braintrust-kotlin-core/src/main/resources/META-INF/proguard/braintrust-kotlin-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.braintrustdata.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../braintrust-kotlin-core/src/main/resources/META-INF/proguard/braintrust-kotlin-core.pro",
